!*==dlaror.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DLAROR
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL DGEMV('T',ixfrm,N,ONE,A(kbeg,1),Lda,X(kbeg),1,ZERO,    &
     &                 X(2*nxfrm+1),1)
            CALL DGER(ixfrm,N,-factor,X(kbeg),1,X(2*nxfrm+1),1,A(kbeg,1)&
     &                ,Lda)
!
         ENDIF
!
...
!
            CALL DGEMV('N',M,ixfrm,ONE,A(1,kbeg),Lda,X(kbeg),1,ZERO,    &
     &                 X(2*nxfrm+1),1)
            CALL DGER(M,ixfrm,-factor,X(2*nxfrm+1),1,X(kbeg),1,A(1,kbeg)&
     &                ,Lda)
!
         ENDIF
      ENDDO
