!*==clagsy.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CLAGSY
!
!  =========== DOCUMENTATION ===========
!
...
!     .. External Subroutines ..
      EXTERNAL CAXPY , CGEMV , CGERC , CLACGV , CLARNV , CSCAL , CSYMV ,&
     &         XERBLA
!     ..
!     .. External Functions ..
      REAL SCNRM2
...
!
         ...
         CALL CSYMV('Lower',N-i+1,tau,A(i,i),Lda,Work,1,ZERO,Work(N+1), &
     &              1)
         CALL CLACGV(N-i+1,Work,1)
!
...
!
         ...
         CALL CSYMV('Lower',N-K-i+1,tau,A(K+i,K+i),Lda,A(K+i,i),1,ZERO, &
     &              Work,1)
         CALL CLACGV(N-K-i+1,A(K+i,i),1)
!
!        compute  v := y - 1/2 * tau * ( u, y ) * u
