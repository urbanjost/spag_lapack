!*==dlatmr.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DLATMR
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DLATMR(M,N,Dist,Iseed,Sym,D,Mode,Cond,Dmax,Rsign,Grade,&
...
!     .. External Functions ..
      LOGICAL LSAME
      DOUBLE PRECISION DLANGB , DLANGE , DLANSB , DLANSP , DLANSY ,     &
     &                 DLATM2 , DLATM3
...
!
         IF ( ipack==0 ) THEN
            IF ( isym==0 ) THEN
               DO j = 1 , N
                  DO i = 1 , j
                     temp = DLATM3(M,N,i,j,isub,jsub,Kl,Ku,idist,Iseed, &
         ...
         DO j = 1 , N
            DO i = 1 , j
               ...
               IF ( isub>Lda ) THEN
                  ...
                  jsub = jsub + 1
               ENDIF
               A(isub,jsub) = DLATM2(M,N,i,j,Kl,Ku,idist,Iseed,D,igrade,&
...
!
                  ...
                  isub = k - Lda*(jsub-1)
!
                  A(isub,jsub) = DLATM2(M,N,i,j,Kl,Ku,idist,Iseed,D,    &
     &                           igrade,Dl,Dr,ipvtng,Iwork,Sparse)
               ENDDO
            ENDDO
         ELSE
