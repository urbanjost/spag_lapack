!*==clatm5.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CLATM5
!
!  =========== DOCUMENTATION ===========
!
...
!>
!  =====================================================================
      SUBROUTINE CLATM5(Prtype,M,N,A,Lda,B,Ldb,C,Ldc,D,Ldd,E,Lde,F,Ldf, &
...
!     .. Parameters ..
     ...
     &           ZERO=(0.0E+0,0.0E+0),HALF=(0.5E+0,0.0E+0),             &
