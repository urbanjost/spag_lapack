!*==slatm5.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SLATM5
!
!  =========== DOCUMENTATION ===========
!
...
!>
!  =====================================================================
      SUBROUTINE SLATM5(Prtype,M,N,A,Lda,B,Ldb,C,Ldc,D,Ldd,E,Lde,F,Ldf, &
...
!     .. Parameters ..
      ...
      PARAMETER (ONE=1.0E+0,ZERO=0.0E+0,TWENTY=2.0E+1,HALF=0.5E+0,      &
     &           TWO=2.0E+0)
!     ..
!     .. Local Scalars ..
      INTEGER i , j , k
