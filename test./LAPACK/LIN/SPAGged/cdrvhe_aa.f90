!*==cdrvhe_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVHE_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CDRVHE_AA(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,    &
...
!     .. External Subroutines ..
     ...
     &         CLACPY , CLARHS , CLATB4 , CLATMS , CHESV_AA ,           &
     &         CHET01_AA , CPOT02 , CHETRF_AA
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'CHESV_AA '
                           CALL CHESV_AA(uplo,n,Nrhs,Afac,lda,Iwork,X,  &
     &                        lda,Work,lwork,info)
!
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'CHESV_AA',info,k,uplo,n,&
