!*==zchkunhr_col.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE ZCHKUNHR_COL(Thresh,Tsterr,Nm,Mval,Nn,Nval,Nnb,Nbval,  &
     &                        Nout)
      IMPLICIT NONE
!*--ZCHKUNHR_COL112
!
...
!
99001 FORMAT ('ZUNGTSQR and ZUNHR_COL: M=',I5,', N=',I5,', MB1=',I5,    &
     &        ', NB1=',I5,', NB2=',I5,' test(',I2,')=',G12.5)
99002 FORMAT ('ZUNGTSQR_ROW and ZUNHR_COL: M=',I5,', N=',I5,', MB1=',I5,&
     &        ', NB1=',I5,', NB2=',I5,' test(',I2,')=',G12.5)
!
!     End of ZCHKUNHR_COL
!
      END SUBROUTINE ZCHKUNHR_COL
