!*==dchksy.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKSY
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKSY(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,      &
...
!     .. External Subroutines ..
     ...
     &         DSYCON , DSYRFS , DSYT01 , DSYTRF , DSYTRI2 , DSYTRS ,   &
     &         DSYTRS2 , XLAENV
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'DSYTRI2',info,-1,uplo,&
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'DSYTRS',info,0,    &
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'DSYTRS2',info,0,   &
     &                             uplo,n,n,-1,-1,nrhs,imat,nfail,nerrs,&
     &                             Nout)
!
                              CALL DLACPY('Full',n,nrhs,B,lda,Work,lda)
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'DSYRFS',info,0,    &
     &                             uplo,n,n,-1,-1,nrhs,imat,nfail,nerrs,&
     &                             Nout)
!
                              CALL DGET04(n,nrhs,X,lda,Xact,lda,rcondc, &
...
!
 2                         anorm = DLANSY('1',uplo,n,A,lda,Rwork)
                           SRNamt = 'DSYCON'
                           CALL DSYCON(uplo,n,Afac,lda,Iwork,anorm,     &
     &                                 rcond,Work,Iwork(n+1),info)
!
!                 Check error code from DSYCON and handle error.
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'DSYCON',info,0,uplo,n,&
