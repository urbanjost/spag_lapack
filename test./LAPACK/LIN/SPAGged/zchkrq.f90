!*==zchkrq.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKRQ
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKRQ(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!                       Test ZGERQF
!
                           CALL ZRQT01(m,n,A,Af,Aq,Ar,lda,Tau,Work,     &
...
!                       returned by ZRQT01
!
                           CALL ZRQT02(m,n,k,A,Af,Aq,Ar,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ENDIF
                        IF ( m>=k ) THEN
!
...
!                       by ZRQT01
!
                           CALL ZRQT03(m,n,k,Af,Ac,Ar,Aq,lda,Tau,Work,  &
...
!
                              CALL ZLACPY('Full',m,Nrhs,B,lda,X(n-m+1), &
     &                           lda)
                              SRNamt = 'ZGERQS'
                              CALL ZGERQS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
