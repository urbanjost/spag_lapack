!*==dchkqr.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKQR
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKQR(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!                       Test DGEQRF
!
                           CALL DQRT01(m,n,A,Af,Aq,Ar,lda,Tau,Work,     &
     &                                 lwork,Rwork,result(1))
 
!
!                       Test DGEQRFP
!
                           CALL DQRT01P(m,n,A,Af,Aq,Ar,lda,Tau,Work,    &
     &                                  lwork,Rwork,result(8))
 
                           IF ( .NOT.DGENND(m,n,Af,lda) ) result(9)     &
     &                          = 2*Thresh
                           nt = nt + 1
                        ELSEIF ( m>=n ) THEN
!
...
!                       returned by DQRT01
!
                           CALL DQRT02(m,n,k,A,Af,Aq,Ar,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ENDIF
                        IF ( m>=k ) THEN
!
...
!                       by DQRT01
!
                           CALL DQRT03(m,n,k,Af,Ac,Ar,Aq,lda,Tau,Work,  &
...
!
                              ...
                              SRNamt = 'DGEQRS'
                              CALL DGEQRS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
