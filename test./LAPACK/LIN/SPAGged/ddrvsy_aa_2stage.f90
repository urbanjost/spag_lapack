!*==ddrvsy_aa_2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE DDRVSY_AA_2STAGE(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,    &
...
!     .. Array Arguments ..
      ...
      INTEGER Iwork(*) , Nval(*)
      DOUBLE PRECISION Rwork(*)
      DOUBLE PRECISION A(*) , Afac(*) , Ainv(*) , B(*) , Work(*) ,      &
     &                 X(*) , Xact(*)
!     ..
!
!  =====================================================================
...
!     .. External Subroutines ..
      EXTERNAL ALADHD , ALAERH , ALASVM , XLAENV , DERRVX , DGET04 ,    &
     &         DLACPY , DLARHS , DLATB4 , DLATMS , DSYSV_AA_2STAGE ,    &
     &         DPOT02 , DSYTRF_AA_2STAGE
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'DSYSV_AA',info,k,uplo,n,&
...
!
      END SUBROUTINE DDRVSY_AA_2STAGE
