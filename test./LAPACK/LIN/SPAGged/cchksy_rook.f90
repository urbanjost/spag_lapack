!*==cchksy_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCHKSY_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKSY_ROOK(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh, &
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'CSYTRF_ROOK',info,k,uplo,&
...
!
                              SRNamt = 'CSYTRS_ROOK'
                              CALL CSYTRS_ROOK(uplo,n,nrhs,Afac,lda,    &
     &                           Iwork,X,lda,info)
!
!                    Check error code from CSYTRS_ROOK and handle error.
!
                              IF ( info/=0 )                            &
     &                              CALL ALAERH(path,'CSYTRS_ROOK',info,&
