!*==ddrvpb.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DDRVPB
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DDRVPB(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,Afac,  &
...
!                          residual.
!
                                 CALL DPBT01(uplo,n,kd,A,ldab,Afac,ldab,&
     &                              Rwork,result(1))
!
...
!
     ...
     &                              Work,lda)
                                 CALL DPBT02(uplo,n,kd,Nrhs,Asav,ldab,X,&
...
!                          refinement.
!
                                 CALL DPBT05(uplo,n,kd,Nrhs,Asav,ldab,B,&
...
!
     ...
     &                                 CALL ALADHD(Nout,path)
                                    IF ( prefac ) THEN
                                       WRITE (Nout,FMT=99003) 'DPBSVX' ,&
     &                                    fact , uplo , n , kd , equed ,&
     &                                    imat , k , result(k)
                                    ELSE
                                       WRITE (Nout,FMT=99002) 'DPBSVX' ,&
     &                                    fact , uplo , n , kd , imat , &
     &                                    k , result(k)
                                    ENDIF
                                    nfail = nfail + 1
