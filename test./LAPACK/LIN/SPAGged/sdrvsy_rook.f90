!*==sdrvsy_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SDRVSY_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVSY_ROOK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,  &
...
!     .. External Subroutines ..
     ...
     &         SSYSV_ROOK , SSYT01_ROOK , SSYTRF_ROOK , SSYTRI_ROOK ,   &
     &         XLAENV
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
...
!
                           SRNamt = 'SSYSV_ROOK'
                           CALL SSYSV_ROOK(uplo,n,Nrhs,Afac,lda,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
     ...
     &                                CALL ALADHD(Nout,path)
                                 WRITE (Nout,FMT=99001) 'SSYSV_ROOK' ,  &
