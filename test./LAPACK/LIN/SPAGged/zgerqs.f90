!*==zgerqs.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZGERQS
!
!  =========== DOCUMENTATION ===========
!
...
!     Solve R*X = B(n-m+1:n,:)
!
      CALL ZTRSM('Left','Upper','No transpose','Non-unit',M,Nrhs,CONE,  &
...
!     B := Q' * B
!
      CALL ZUNMRQ('Left','Conjugate transpose',N,Nrhs,M,A,Lda,Tau,B,Ldb,&
     &            Work,Lwork,Info)
!
!
!     End of ZGERQS
!
      END SUBROUTINE ZGERQS
