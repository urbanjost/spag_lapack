!*==cchkhe.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCHKHE
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKHE(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,      &
...
!     .. External Subroutines ..
     ...
     &         CHERFS , CHET01 , CHETRF , CHETRI2 , CHETRS , CLACPY ,   &
...
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'CHETRI2',info,-1,uplo,&
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'CHETRS',info,0,    &
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'CHETRS2',info,0,   &
     &                             uplo,n,n,-1,-1,nrhs,imat,nfail,nerrs,&
     &                             Nout)
!
                              CALL CLACPY('Full',n,nrhs,B,lda,Work,lda)
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'CHERFS',info,0,    &
     &                             uplo,n,n,-1,-1,nrhs,imat,nfail,nerrs,&
     &                             Nout)
!
                              CALL CGET04(n,nrhs,X,lda,Xact,lda,rcondc, &
...
!
 2                         anorm = CLANHE('1',uplo,n,A,lda,Rwork)
                           SRNamt = 'CHECON'
                           CALL CHECON(uplo,n,Afac,lda,Iwork,anorm,     &
     &                                 rcond,Work,info)
!
!                 Check error code from CHECON and handle error.
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'CHECON',info,0,uplo,n,&
