!*==dgtt01.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DGTT01
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DGTT01(N,Dl,D,Du,Dlf,Df,Duf,Du2,Ipiv,Work,Ldwork,Rwork,&
     &                  Resid)
      IMPLICIT NONE
!*--DGTT01138
!
...
!     .. Array Arguments ..
      INTEGER Ipiv(*)
      DOUBLE PRECISION D(*) , Df(*) , Dl(*) , Dlf(*) , Du(*) , Du2(*) , &
     &                 Duf(*) , Rwork(*) , Work(Ldwork,*)
!     ..
!
!  =====================================================================
!
