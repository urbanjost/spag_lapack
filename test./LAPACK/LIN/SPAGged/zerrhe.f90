!*==zerrhe.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZERRHE
!
!  =========== DOCUMENTATION ===========
!
...
!     .. External Subroutines ..
     ...
     &         ZHETRF_RK , ZHETRF_ROOK , ZHETRF_AA , ZHETRF_AA_2STAGE , &
     &         ZHETRI , ZHETRI_3 , ZHETRI_3X , ZHETRI_ROOK , ZHETRI2 ,  &
     &         ZHETRI2X , ZHETRS , ZHETRS_3 , ZHETRS_ROOK , ZHETRS_AA , &
     &         ZHETRS_AA_2STAGE , ZHPCON , ZHPRFS , ZHPTRF , ZHPTRI ,   &
     &         ZHPTRS
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
