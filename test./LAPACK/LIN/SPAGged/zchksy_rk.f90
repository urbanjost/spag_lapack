!*==zchksy_rk.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKSY_RK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKSY_RK(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,   &
...
!     .. External Subroutines ..
     ...
     &         ZSYT03 , ZSYCON_3 , ZSYT01_3 , ZSYTRF_RK , ZSYTRI_3 ,    &
     &         ZSYTRS_3 , XLAENV
!     ..
!     .. Intrinsic Functions ..
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'ZSYTRF_RK',info,k,uplo,n,&
...
!
                              SRNamt = 'ZSYTRS_3'
                              CALL ZSYTRS_3(uplo,n,nrhs,Afac,lda,E,     &
     &                           Iwork,X,lda,info)
!
...
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'ZSYCON_3',info,0,uplo,&
