!*==cchkhp.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCHKHP
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKHP(Dotype,Nn,Nval,Nns,Nsval,Thresh,Tsterr,Nmax,A,  &
...
!     .. External Subroutines ..
     ...
     &         CLACPY , CLAIPD , CLARHS , CLATB4 , CLATMS , CPPT02 ,    &
     &         CPPT03 , CPPT05
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
                        IF ( info/=0 )                                  &
     &                       CALL ALAERH(path,'CHPTRI',info,0,uplo,n,n, &
...
!
                        IF ( info/=0 )                                  &
     &                       CALL ALAERH(path,'CHPTRS',info,0,uplo,n,n, &
...
!
                        IF ( info/=0 )                                  &
     &                       CALL ALAERH(path,'CHPRFS',info,0,uplo,n,n, &
     &                       -1,-1,nrhs,imat,nfail,nerrs,Nout)
!
                        CALL CGET04(n,nrhs,X,lda,Xact,lda,rcondc,       &
     &                              result(5))
...
!
 2                   anorm = CLANHP('1',uplo,n,A,Rwork)
                     SRNamt = 'CHPCON'
