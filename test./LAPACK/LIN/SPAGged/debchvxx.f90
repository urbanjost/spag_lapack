!*==debchvxx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DEBCHVXX
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Arrays ..
     ...
     &                 afb(2*(NMAX-1)+(NMAX-1)+1,NMAX) , work(NMAX*3*5) &
     &                 , af(NMAX,NMAX) , b(NMAX,NMAX) , acopy(NMAX,NMAX)
...
!     .. External Subroutines ..
      EXTERNAL DLAHILB , DGESVXX , DPOSVXX , DSYSVXX , DGBSVXX ,        &
     &         DLACPY , LSAMEN
      LOGICAL LSAMEN
...
99008                FORMAT (3X,I2,': Raw componentwise error estimate')
     ...
     &                            tstrat(i)
99009             FORMAT (' D',A2,'SVXX: N =',I2,', RHS = ',I2,         &
...
99010    FORMAT (' D',A2,'SVXX: ',I6,' out of ',I6,                     &
     &           ' tests failed to pass the threshold')
      ELSE
         WRITE (*,99011) c2
99011    FORMAT (' D',A2,'SVXX passed the tests of error bounds')
      ENDIF
 
99012 FORMAT (' D',A2,'SVXX: N =',I2,', INFO = ',I3,', ORCOND = ',G12.5,&
     &        ', real RCOND = ',G12.5)
 
      END SUBROUTINE DEBCHVXX
