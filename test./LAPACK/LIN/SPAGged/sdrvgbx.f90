!*==sdrvgb.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SDRVGBX
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVGB(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,A,La,Afb,Lafb,&
...
!     .. Array Arguments ..
      LOGICAL Dotype(*)
      INTEGER Iwork(*) , Nval(*)
      REAL A(*) , Afb(*) , Asav(*) , B(*) , Bsav(*) , Rwork(*) , S(*) , &
     &     Work(*) , X(*) , Xact(*)
!     ..
!
!  =====================================================================
...
!     .. External Functions ..
      LOGICAL LSAME
      REAL SGET06 , SLAMCH , SLANGB , SLANGE , SLANTB , SLA_GBRPVGRW
...
!
     ...
     &                              Rwork(Nrhs+1),Work,Iwork(n+1),info)
!
!                          Check the error code from SGBSVX.
!
                                 IF ( info/=izero )                     &
     &                                 CALL ALAERH(path,'SGBSVX',info,  &
...
!
     ...
     &                                 lda,B,ldb,X,ldb,Xact,ldb,Rwork,  &
...
!
                                 CALL SLACPY('Full',kl+ku+1,n,Asav,lda, &
     &                              A,lda)
                                 CALL SLACPY('Full',n,Nrhs,Bsav,ldb,B,  &
     &                              ldb)
...
!
                                    ...
                                    IF ( info>0 .AND. info<n+1 ) THEN
                                       rpvgrw = SLA_GBRPVGRW(n,kl,ku,   &
     &                                    info,A,lda,Afb,ldafb)
                                    ELSE
                                       rpvgrw = SLA_GBRPVGRW(n,kl,ku,n, &
     &                                    A,lda,Afb,ldafb)
                                    ENDIF
...
99001 FORMAT (' *** In SDRVGB, LA=',I5,' is too small for N=',I5,       &
     &        ', KU=',I5,', KL=',I5,/' ==> Increase LA to at least ',I5)
99002 FORMAT (' *** In SDRVGB, LAFB=',I5,' is too small for N=',I5,     &
