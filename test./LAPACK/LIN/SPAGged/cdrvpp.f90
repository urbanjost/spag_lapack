!*==cdrvpp.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVPP
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CDRVPP(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,Afac,  &
...
!
                           SRNamt = 'CPPSVX'
                           CALL CPPSVX(fact,uplo,n,Nrhs,A,Afac,equed,S, &
...
!                       refinement.
!
                              CALL CPPT05(uplo,n,Nrhs,Asav,B,lda,X,lda, &
...
!
     ...
     &                                CALL ALADHD(Nout,path)
                                 IF ( prefac ) THEN
                                    WRITE (Nout,FMT=99003) 'CPPSVX' ,   &
     &                                 fact , uplo , n , equed , imat , &
     &                                 k , result(k)
                                 ELSE
                                    WRITE (Nout,FMT=99002) 'CPPSVX' ,   &
     &                                 fact , uplo , n , imat , k ,     &
     &                                 result(k)
                                 ENDIF
                                 nfail = nfail + 1
