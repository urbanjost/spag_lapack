!*==cgtt01.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CGTT01
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CGTT01(N,Dl,D,Du,Dlf,Df,Duf,Du2,Ipiv,Work,Ldwork,Rwork,&
     &                  Resid)
      IMPLICIT NONE
!*--CGTT01138
!
...
!     .. Array Arguments ..
      INTEGER Ipiv(*)
      REAL Rwork(*)
      COMPLEX D(*) , Df(*) , Dl(*) , Dlf(*) , Du(*) , Du2(*) , Duf(*) , &
     &        Work(Ldwork,*)
!     ..
!
!  =====================================================================
...
!
      ...
      DO i = N - 1 , 1 , -1
         li = Dlf(i)
         CALL CAXPY(lastj-i+1,li,Work(i,i),Ldwork,Work(i+1,i),Ldwork)
         ip = Ipiv(i)
         IF ( ip==i ) THEN
            lastj = MIN(i+2,N)
         ELSE
            CALL CSWAP(lastj-i+1,Work(i,i),Ldwork,Work(i+1,i),Ldwork)
         ENDIF
      ENDDO
!
