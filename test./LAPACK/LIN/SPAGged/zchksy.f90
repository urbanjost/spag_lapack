!*==zchksy.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKSY
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKSY(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,      &
...
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'ZSYTRI2',info,0,uplo, &
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'ZSYTRS',info,0,    &
...
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'ZSYRFS',info,0,    &
     &                             uplo,n,n,-1,-1,nrhs,imat,nfail,nerrs,&
     &                             Nout)
!
                              CALL ZGET04(n,nrhs,X,lda,Xact,lda,rcondc, &
...
!
 2                         anorm = ZLANSY('1',uplo,n,A,lda,Rwork)
                           SRNamt = 'ZSYCON'
                           CALL ZSYCON(uplo,n,Afac,lda,Iwork,anorm,     &
     &                                 rcond,Work,info)
!
!                 Check error code from ZSYCON and handle error.
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'ZSYCON',info,0,uplo,n,&
