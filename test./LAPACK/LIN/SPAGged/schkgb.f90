!*==schkgb.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCHKGB
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKGB(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nns,Nsval,     &
...
!
                                 anormo = SLANGB('O',n,kl,ku,A,lda,     &
     &                              Rwork)
                                 anormi = SLANGB('I',n,kl,ku,A,lda,     &
     &                              Rwork)
!
                                 IF ( info==0 ) THEN
!
...
!
                                    ldb = MAX(1,n)
                                    CALL SLASET('Full',n,n,ZERO,ONE,    &
     &                                 Work,ldb)
                                    SRNamt = 'SGBTRS'
                                    CALL SGBTRS('No transpose',n,kl,ku, &
...
!
                                         SRNamt = 'SLARHS'
                                         CALL SLARHS(path,xtype,' ',    &
     &                                      trans,n,n,kl,ku,nrhs,A,lda, &
     &                                      Xact,ldb,B,ldb,iseed,info)
                                         xtype = 'C'
                                         CALL SLACPY('Full',n,nrhs,B,   &
     &                                      ldb,X,ldb)
!
                                         SRNamt = 'SGBTRS'
                                         CALL SGBTRS(trans,n,kl,ku,nrhs,&
...
!
                                         IF ( info/=0 )                 &
     &                                      CALL ALAERH(path,'SGBTRS',  &
     &                                      info,0,trans,n,n,kl,ku,-1,  &
     &                                      imat,nfail,nerrs,Nout)
!
                                         CALL SLACPY('Full',n,nrhs,B,   &
     &                                      ldb,Work,ldb)
                                         CALL SGBT02(trans,m,n,kl,ku,   &
...
!
                                         SRNamt = 'SGBRFS'
                                         CALL SGBRFS(trans,n,kl,ku,nrhs,&
...
!
                                         IF ( info/=0 )                 &
     &                                      CALL ALAERH(path,'SGBRFS',  &
     &                                      info,0,trans,n,n,kl,ku,nrhs,&
     &                                      imat,nfail,nerrs,Nout)
!
                                         CALL SGET04(n,nrhs,X,ldb,Xact, &
     &                                      ldb,rcondc,result(4))
                                         CALL SGBT05(trans,n,kl,ku,nrhs,&
...
!
99001 FORMAT (' *** In SCHKGB, LA=',I5,' is too small for M=',I5,', N=',&
     &        I5,', KL=',I4,', KU=',I4,/' ==> Increase LA to at least ',&
     &        I5)
99002 FORMAT (' *** In SCHKGB, LAFAC=',I5,' is too small for M=',I5,    &
     &        ', N=',I5,', KL=',I4,', KU=',I4,                          &
