!*==cdrvsy_aa_2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE CDRVSY_AA_2STAGE(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,    &
...
!     .. External Subroutines ..
     ...
     &         CLACPY , CLARHS , CLATB4 , CLATMS , CSYSV_AA_2STAGE ,    &
     &         CSYT01_AA , CSYT02 , CSYTRF_AA_2STAGE
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'CSYSV_AA',info,k,uplo,n,&
...
!                    residual.
!
!                     CALL CSY01_AA( UPLO, N, A, LDA, AFAC, LDA,
...
!
      END SUBROUTINE CDRVSY_AA_2STAGE
