!*==dchkaa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKAA
!
!  =========== DOCUMENTATION ===========
!
...
!     .. External Subroutines ..
     ...
     &         DCHKSY , DCHKSY_ROOK , DCHKSY_RK , DCHKSY_AA , DCHKTB ,  &
     &         DCHKTP , DCHKTR , DCHKTZ , DDRVGB , DDRVGE , DDRVGT ,    &
     &         DDRVLS , DDRVPB , DDRVPO , DDRVPP , DDRVPT , DDRVSP ,    &
     &         DDRVSY , DDRVSY_ROOK , DDRVSY_RK , DDRVSY_AA , ILAVER ,  &
     &         DCHKLQTP , DCHKQRT , DCHKQRTP , DCHKLQT , DCHKTSQR
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
