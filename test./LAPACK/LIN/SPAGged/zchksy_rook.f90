!*==zchksy_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKSY_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKSY_ROOK(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh, &
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'ZSYTRF_ROOK',info,k,uplo,&
...
!
                              SRNamt = 'ZSYTRS_ROOK'
                              CALL ZSYTRS_ROOK(uplo,n,nrhs,Afac,lda,    &
     &                           Iwork,X,lda,info)
!
!                    Check error code from ZSYTRS_ROOK and handle error.
!
                              IF ( info/=0 )                            &
     &                              CALL ALAERH(path,'ZSYTRS_ROOK',info,&
