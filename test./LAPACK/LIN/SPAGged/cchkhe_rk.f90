!*==cchkhe_rk.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCHKHE_RK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKHE_RK(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,   &
...
!     .. External Subroutines ..
     ...
     &         CHECON_3 , CHET01_3 , CHETRF_RK , CHETRI_3 , CHETRS_3 ,  &
     &         XLAENV
!     ..
!     .. Intrinsic Functions ..
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'CHETRF_RK',info,k,uplo,n,&
...
!
                              SRNamt = 'CHETRS_3'
                              CALL CHETRS_3(uplo,n,nrhs,Afac,lda,E,     &
     &                           Iwork,X,lda,info)
!
...
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'CHECON_3',info,0,uplo,&
