!*==cdrvsy_rk.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVSY_RK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CDRVSY_RK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,    &
...
!     .. External Subroutines ..
     ...
     &         CLACPY , CLARHS , CLATB4 , CLATMS , CLATSY , CSYSV_RK ,  &
     &         CSYT01_3 , CSYT02 , CSYTRF_RK , CSYTRI_3
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'CSYSV_RK'
                           CALL CSYSV_RK(uplo,n,Nrhs,Afac,lda,E,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'CSYSV_RK',info,k,uplo,n,&
