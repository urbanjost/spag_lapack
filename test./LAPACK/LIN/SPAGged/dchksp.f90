!*==dchksp.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKSP
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKSP(Dotype,Nn,Nval,Nns,Nsval,Thresh,Tsterr,Nmax,A,  &
...
!
                        SRNamt = 'DSPTRS'
                        CALL DSPTRS(uplo,n,nrhs,Afac,Iwork,X,lda,info)
!
...
!
                        ...
                        CALL DPPT02(uplo,n,nrhs,A,X,lda,Work,lda,Rwork, &
     &                              result(3))
!
!+    TEST 4
...
!
                        CALL DGET04(n,nrhs,X,lda,Xact,lda,rcondc,       &
     &                              result(5))
                        CALL DPPT05(uplo,n,nrhs,A,B,lda,X,lda,Xact,lda, &
...
!
 2                   anorm = DLANSP('1',uplo,n,A,Rwork)
                     SRNamt = 'DSPCON'
