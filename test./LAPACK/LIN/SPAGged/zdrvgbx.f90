...
!                     write(*,*) 'begin zgbsvxx testing'
                                 ...
                                 CALL ZLACPY('Full',kl+ku+1,n,Asav,lda, &
     &                              A,lda)
                                 CALL ZLACPY('Full',n,Nrhs,Bsav,ldb,B,  &
     &                              ldb)
...
!
                                 SRNamt = 'ZGBSVXX'
                                 n_err_bnds = 3
                                 CALL ZGBSVXX(fact,trans,n,kl,ku,Nrhs,A,&
...
!
                                    ...
                                    IF ( info>0 .AND. info<n+1 ) THEN
                                       rpvgrw = ZLA_GBRPVGRW(n,kl,ku,   &
     &                                    info,A,lda,Afb,ldafb)
                                    ELSE
                                       rpvgrw = ZLA_GBRPVGRW(n,kl,ku,n, &
     &                                    A,lda,Afb,ldafb)
                                    ENDIF
