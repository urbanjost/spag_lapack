!*==zdrvsy_rk.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZDRVSY_RK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZDRVSY_RK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,    &
...
!     .. External Subroutines ..
     ...
     &         ZLACPY , ZLARHS , ZLATB4 , ZLATMS , ZLATSY , ZSYSV_RK ,  &
     &         ZSYT01_3 , ZSYT02 , ZSYTRF_RK , ZSYTRI_3
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'ZSYSV_RK'
                           CALL ZSYSV_RK(uplo,n,Nrhs,Afac,lda,E,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'ZSYSV_RK',info,k,uplo,n,&
