!*==zdrvac.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZDRVAC
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZDRVAC(Dotype,Nm,Mval,Nns,Nsval,Thresh,Nmax,A,Afac,B,X,&
...
!     .. External Subroutines ..
      EXTERNAL ALAERH , ZLACPY , ZLAIPD , ZLARHS , ZLATB4 , ZLATMS ,    &
     &         ZPOT06 , ZCPOSV
!     ..
!     .. Intrinsic Functions ..
...
!
                           IF ( info/=izero .AND. izero/=0 ) THEN
                              WRITE (Nout,FMT=99005) 'ZCPOSV' , info ,  &
     &                               izero , n , imat
                           ELSE
                              WRITE (Nout,FMT=99006) 'ZCPOSV' , info ,  &
     &                               n , imat
                           ENDIF
                        ENDIF
!
...
!
                        CALL ZPOT06(uplo,n,nrhs,A,lda,X,lda,Work,lda,   &
     &                              Rwork,result(1))
!
...
!
      IF ( nfail>0 ) THEN
         WRITE (Nout,FMT=99002) 'ZCPOSV' , nfail , nrun
      ELSE
         WRITE (Nout,FMT=99003) 'ZCPOSV' , nrun
      ENDIF
