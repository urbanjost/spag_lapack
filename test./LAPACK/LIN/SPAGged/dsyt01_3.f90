!*==dsyt01_3.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DSYT01_3
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DSYT01_3(Uplo,N,A,Lda,Afac,Ldafac,E,Ipiv,C,Ldc,Rwork,  &
     &                    Resid)
      IMPLICIT NONE
!*--DSYT01_3144
!
...
!     .. Array Arguments ..
      INTEGER Ipiv(*)
      DOUBLE PRECISION A(Lda,*) , Afac(Ldafac,*) , C(Ldc,*) , E(*) ,    &
     &                 Rwork(*)
!     ..
!
!  =====================================================================
...
!
      CALL DLAVSY_ROOK(Uplo,'Transpose','Non-unit',N,N,Afac,Ldafac,Ipiv,&
     &                 C,Ldc,info)
!
!     4) Call DLAVSY_ROOK again to multiply by U (or L ).
!
      CALL DLAVSY_ROOK(Uplo,'No transpose','Unit',N,N,Afac,Ldafac,Ipiv, &
     &                 C,Ldc,info)
!
