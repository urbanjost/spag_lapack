!*==cdrvge.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVGEX
!
!  =========== DOCUMENTATION ===========
!
...
!
                              ...
                              IF ( info>0 .AND. info<n+1 ) THEN
                                 rpvgrw = CLA_GERPVGRW(n,info,A,lda,    &
     &                              Afac,lda)
                              ELSE
                                 rpvgrw = CLA_GERPVGRW(n,n,A,lda,Afac,  &
     &                              lda)
                              ENDIF
