!*==slattp.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SLATTP
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
     ...
     &     ra , rb , rexp , s , sfac , smlnum , star1 , stemp , t ,     &
...
!     .. External Subroutines ..
      EXTERNAL SLABAD , SLARNV , SLATB4 , SLATMS , SROT , SROTG , SSCAL
!     ..
!     .. Intrinsic Functions ..
...
!              Multiply by [ c -s;  s  c] on the right.
!
               IF ( N>j+1 ) CALL SROT(N-j-1,A(jcnext+1),1,A(jc+2),1,c,  &
     &                                -s)
!
!              Multiply by [-c  s; -s -c] on the left.
!
