!*==zchksp.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKSP
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKSP(Dotype,Nn,Nval,Nns,Nsval,Thresh,Tsterr,Nmax,A,  &
...
!
                        CALL ZSPT03(uplo,n,A,Ainv,Work,lda,Rwork,rcondc,&
     &                              result(2))
                        nt = 2
                     ENDIF
!
...
!
                        SRNamt = 'ZSPTRS'
                        CALL ZSPTRS(uplo,n,nrhs,Afac,Iwork,X,lda,info)
!
...
!
                        ...
                        CALL ZSPT02(uplo,n,nrhs,A,X,lda,Work,lda,Rwork, &
     &                              result(3))
!
!+    TEST 4
...
!
 2                   anorm = ZLANSP('1',uplo,n,A,Rwork)
                     SRNamt = 'ZSPCON'
