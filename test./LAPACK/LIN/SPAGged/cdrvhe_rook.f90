!*==cdrvhe_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVHE_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CDRVHE_ROOK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,  &
...
!     .. External Subroutines ..
     ...
     &         CLACPY , CLARHS , CLATB4 , CLATMS , CHESV_ROOK ,         &
     &         CHET01_ROOK , CPOT02 , CHETRF_ROOK , CHETRI_ROOK
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'CHESV_ROOK'
                           CALL CHESV_ROOK(uplo,n,Nrhs,Afac,lda,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
     ...
     &                                CALL ALADHD(Nout,path)
                                 WRITE (Nout,FMT=99001) 'CHESV_ROOK' ,  &
