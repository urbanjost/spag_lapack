!*==schkqr.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCHKQR
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKQR(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!                       Test SGEQRF
!
                           CALL SQRT01(m,n,A,Af,Aq,Ar,lda,Tau,Work,     &
     &                                 lwork,Rwork,result(1))
!
!                       Test SGEQRFP
!
                           CALL SQRT01P(m,n,A,Af,Aq,Ar,lda,Tau,Work,    &
     &                                  lwork,Rwork,result(8))
 
                           IF ( .NOT.SGENND(m,n,Af,lda) ) result(9)     &
     &                          = 2*Thresh
                           nt = nt + 1
                        ELSEIF ( m>=n ) THEN
!
...
!                       returned by SQRT01
!
                           CALL SQRT02(m,n,k,A,Af,Aq,Ar,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ENDIF
                        IF ( m>=k ) THEN
!
...
!                       by SQRT01
!
                           CALL SQRT03(m,n,k,Af,Ac,Ar,Aq,lda,Tau,Work,  &
...
!
                              ...
                              SRNamt = 'SGEQRS'
                              CALL SGEQRS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
