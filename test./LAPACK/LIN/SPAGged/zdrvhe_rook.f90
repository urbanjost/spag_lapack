!*==zdrvhe_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZDRVHE_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZDRVHE_ROOK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,  &
...
!     .. External Subroutines ..
     ...
     &         ZLACPY , ZLARHS , ZLATB4 , ZLATMS , ZHESV_ROOK ,         &
     &         ZHET01_ROOK , ZPOT02 , ZHETRF_ROOK , ZHETRI_ROOK
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'ZHESV_ROOK'
                           CALL ZHESV_ROOK(uplo,n,Nrhs,Afac,lda,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
     ...
     &                                CALL ALADHD(Nout,path)
                                 WRITE (Nout,FMT=99001) 'ZHESV_ROOK' ,  &
