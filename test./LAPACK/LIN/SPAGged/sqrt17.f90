!*==sqrt17.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SQRT17
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      REAL FUNCTION SQRT17(Trans,Iresid,M,N,Nrhs,A,Lda,X,Ldx,B,Ldb,C,   &
     &                     Work,Lwork)
      IMPLICIT NONE
!*--SQRT17154
!
...
!
      ...
      CALL SGEMM(Trans,'No transpose',nrows,Nrhs,ncols,-ONE,A,Lda,X,Ldx,&
     &           ONE,C,Ldb)
...
!     compute R'*A
!
      CALL SGEMM('Transpose',Trans,Nrhs,ncols,nrows,ONE,C,Ldb,A,Lda,    &
     &           ZERO,Work,Nrhs)
!
