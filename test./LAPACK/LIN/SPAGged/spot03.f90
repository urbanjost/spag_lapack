!*==spot03.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SPOT03
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SPOT03(Uplo,N,A,Lda,Ainv,Ldainv,Work,Ldwork,Rwork,     &
     &                  Rcond,Resid)
      IMPLICIT NONE
!*--SPOT03129
!
...
!
      ...
      ELSE
         ...
         ENDDO
      ENDIF
      CALL SSYMM('Left',Uplo,N,N,-ONE,A,Lda,Ainv,Ldainv,ZERO,Work,      &
     &           Ldwork)
!
