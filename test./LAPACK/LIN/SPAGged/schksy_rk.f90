!*==schksy_rk.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCHKSY_RK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKSY_RK(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,   &
...
!     .. External Subroutines ..
     ...
     &         SSYCON_3 , SSYT01_3 , SSYTRF_RK , SSYTRI_3 , SSYTRS_3 ,  &
     &         XLAENV
!     ..
!     .. Intrinsic Functions ..
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'SSYTRF_RK',info,k,uplo,n,&
...
!
                              SRNamt = 'SSYTRS_3'
                              CALL SSYTRS_3(uplo,n,nrhs,Afac,lda,E,     &
     &                           Iwork,X,lda,info)
!
...
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'SSYCON_3',info,0,uplo,&
