!*==dgtt05.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DGTT05
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DGTT05(Trans,N,Nrhs,Dl,D,Du,B,Ldb,X,Ldx,Xact,Ldxact,   &
     &                  Ferr,Berr,Reslts)
      IMPLICIT NONE
!*--DGTT05169
!
...
!     ..
!     .. Array Arguments ..
      DOUBLE PRECISION B(Ldb,*) , Berr(*) , D(*) , Dl(*) , Du(*) ,      &
     &                 Ferr(*) , Reslts(*) , X(Ldx,*) , Xact(Ldxact,*)
!     ..
!
!  =====================================================================
!
