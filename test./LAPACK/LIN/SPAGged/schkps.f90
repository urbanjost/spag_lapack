!*==schkps.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCHKPS
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKPS(Dotype,Nn,Nval,Nnb,Nbval,Nrank,Rankval,Thresh,  &
...
!              with SLATMT.
!
                        CALL SLATB5(path,imat,n,type,kl,ku,anorm,mode,  &
     &                              cndnum,dist)
!
                        SRNamt = 'SLATMT'
...
!
                        IF ( info/=0 ) THEN
                           CALL ALAERH(path,'SLATMT',info,0,uplo,n,n,-1,&
...
!
                           tol = -ONE
                           CALL SPSTRF(uplo,n,Afac,lda,Piv,comprank,tol,&
     &                                 Work,info)
!
...
!
     ...
     &                          (info<=izero .AND. rank<n) ) THEN
                              CALL ALAERH(path,'SPSTRF',info,izero,uplo,&
...
!
                              CALL SPST01(uplo,n,A,lda,Afac,lda,Perm,   &
