!*==csyt01_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CSYT01
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CSYT01_AA(Uplo,N,A,Lda,Afac,Ldafac,Ipiv,C,Ldc,Rwork,   &
     &                     Resid)
      IMPLICIT NONE
!*--CSYT01_AA130
!
...
!
         IF ( LSAME(Uplo,'U') ) THEN
            CALL CTRMM('Left',Uplo,'Transpose','Unit',N-1,N,CONE,       &
...
!
     ...
     &                 Afac(1,2),Ldafac,C(1,2),Ldc)
         ELSE
            CALL CTRMM('Right',Uplo,'Transpose','Unit',N,N-1,CONE,      &
