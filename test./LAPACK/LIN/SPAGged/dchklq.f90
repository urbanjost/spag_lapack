!*==dchklq.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKLQ
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKLQ(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!     .. Array Arguments ..
      ...
      DOUBLE PRECISION A(*) , Ac(*) , Af(*) , Al(*) , Aq(*) , B(*) ,    &
...
!                       Test DGELQF
!
                           CALL DLQT01(m,n,A,Af,Aq,Al,lda,Tau,Work,     &
...
!                       returned by DLQT01
!
                           CALL DLQT02(m,n,k,A,Af,Aq,Al,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ELSE
                           result(1) = ZERO
                           result(2) = ZERO
...
!                       by DLQT01
!
                           CALL DLQT03(m,n,k,Af,Ac,Al,Aq,lda,Tau,Work,  &
...
!
                              ...
                              SRNamt = 'DGELQS'
                              CALL DGELQS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
