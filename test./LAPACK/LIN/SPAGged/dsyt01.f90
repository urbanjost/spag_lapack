!*==dsyt01.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DSYT01
!
!  =========== DOCUMENTATION ===========
!
...
!
      CALL DLAVSY(Uplo,'Transpose','Non-unit',N,N,Afac,Ldafac,Ipiv,C,   &
     &            Ldc,info)
!
!     Call DLAVSY again to multiply by U (or L ).
!
      CALL DLAVSY(Uplo,'No transpose','Unit',N,N,Afac,Ldafac,Ipiv,C,Ldc,&
     &            info)
!
