!*==cgelqs.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CGELQS
!
!  =========== DOCUMENTATION ===========
!
...
!     Solve L*X = B(1:m,:)
!
      CALL CTRSM('Left','Lower','No transpose','Non-unit',M,Nrhs,CONE,A,&
     &           Lda,B,Ldb)
!
!     Set B(m+1:n,:) to zero
!
...
!     B := Q' * B
!
      CALL CUNMLQ('Left','Conjugate transpose',N,Nrhs,M,A,Lda,Tau,B,Ldb,&
     &            Work,Lwork,Info)
!
!
!     End of CGELQS
