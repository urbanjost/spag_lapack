!*==ddrvgb.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DDRVGBX
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DDRVGB(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,A,La,Afb,Lafb,&
...
!
                                 CALL DLACPY('Full',kl+ku+1,n,Asav,lda, &
     &                              A,lda)
                                 CALL DLACPY('Full',n,Nrhs,Bsav,ldb,B,  &
     &                              ldb)
...
!
                                 SRNamt = 'DGBSVXX'
                                 n_err_bnds = 3
                                 CALL DGBSVXX(fact,trans,n,kl,ku,Nrhs,A,&
     &                              lda,Afb,ldafb,Iwork,equed,S,S(n+1), &
...
!
                                    ...
                                    IF ( info>0 .AND. info<n+1 ) THEN
                                       rpvgrw = DLA_GBRPVGRW(n,kl,ku,   &
     &                                    info,A,lda,Afb,ldafb)
                                    ELSE
                                       rpvgrw = DLA_GBRPVGRW(n,kl,ku,n, &
     &                                    A,lda,Afb,ldafb)
                                    ENDIF
...
99001 FORMAT (' *** In DDRVGB, LA=',I5,' is too small for N=',I5,       &
     &        ', KU=',I5,', KL=',I5,/' ==> Increase LA to at least ',I5)
99002 FORMAT (' *** In DDRVGB, LAFB=',I5,' is too small for N=',I5,     &
