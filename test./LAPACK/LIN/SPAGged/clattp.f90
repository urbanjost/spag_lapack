!*==clattp.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CLATTP
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CLATTP(Imat,Uplo,Trans,Diag,Iseed,N,Ap,B,Work,Rwork,   &
     &                  Info)
      IMPLICIT NONE
!*--CLATTP135
!
...
!     .. Local Scalars ..
     ...
     &     smlnum , t , texp , tleft , tscal , ulp , unfl , x , y , z
...
!              Multiply by [ c -s;  conjg(s) c] on the right.
!
               IF ( N>j+1 ) CALL CROT(N-j-1,Ap(jcnext+1),1,Ap(jc+2),1,c,&
     &                                -s)
!
!              Multiply by [-c  s; -conjg(s) -c] on the left.
!
