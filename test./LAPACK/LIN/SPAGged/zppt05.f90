!*==zppt05.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZPPT05
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZPPT05(Uplo,N,Nrhs,Ap,B,Ldb,X,Ldx,Xact,Ldxact,Ferr,    &
     &                  Berr,Reslts)
      IMPLICIT NONE
!*--ZPPT05161
!
...
!     .. Array Arguments ..
      DOUBLE PRECISION Berr(*) , Ferr(*) , Reslts(*)
      COMPLEX*16 Ap(*) , B(Ldb,*) , X(Ldx,*) , Xact(Ldxact,*)
!     ..
!
!  =====================================================================
!
