!*==cdrvhe_aa_2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE CDRVHE_AA_2STAGE(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,    &
...
!     .. External Subroutines ..
     ...
     &         CLACPY , CLARHS , CLATB4 , CLATMS , CHESV_AA_2STAGE ,    &
     &         CPOT02 , CHETRF_AA_2STAGE
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
      END SUBROUTINE CDRVHE_AA_2STAGE
