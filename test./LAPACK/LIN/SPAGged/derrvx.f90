!*==derrvx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DERRVX
!
!  =========== DOCUMENTATION ===========
!
...
!
         ...
         INFot = 1
         CALL DSYSV_AA_2STAGE('/',0,0,a,1,a,1,ip,ip,b,1,w,1,info)
         CALL CHKXER('DSYSV_AA_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 2
         CALL DSYSV_AA_2STAGE('U',-1,0,a,1,a,1,ip,ip,b,1,w,1,info)
         CALL CHKXER('DSYSV_AA_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 3
         CALL DSYSV_AA_2STAGE('U',0,-1,a,1,a,1,ip,ip,b,1,w,1,info)
         CALL CHKXER('DSYSV_AA_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 5
         CALL DSYSV_AA_2STAGE('U',2,1,a,1,a,1,ip,ip,b,1,w,1,info)
         CALL CHKXER('DSYSV_AA_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 11
         CALL DSYSV_AA_2STAGE('U',2,1,a,2,a,8,ip,ip,b,1,w,1,info)
         CALL CHKXER('DSYSV_AA_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 7
         CALL DSYSV_AA_2STAGE('U',2,1,a,2,a,1,ip,ip,b,2,w,1,info)
         CALL CHKXER('DSYSV_AA_2STAGE',INFot,NOUt,LERr,OK)
!
