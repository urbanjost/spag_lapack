!*==dchkab.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKAB
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Arrays ..
      ...
      DOUBLE PRECISION a(LDAMAX*NMAX,2) , b(NMAX*MAXRHS,2) , rwork(NMAX)&
     &                 , work(NMAX*MAXRHS*2)
...
!
         IF ( tstdrv ) THEN
            CALL DDRVAB(dotype,nm,mval,nns,nsval,thresh,lda,a(1,1),     &
     &                  a(1,2),b(1,1),b(1,2),work,rwork,swork,iwork,    &
     &                  NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) 'DSGESV'
         ENDIF
!
...
!
         IF ( tstdrv ) THEN
            CALL DDRVAC(dotype,nm,mval,nns,nsval,thresh,lda,a(1,1),     &
...
99006 FORMAT (' Tests of the DOUBLE PRECISION LAPACK DSGESV/DSPOSV',    &
     &        ' routines ',/' LAPACK VERSION ',I1,'.',I1,'.',I1,        &
