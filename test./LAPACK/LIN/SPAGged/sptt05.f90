!*==sptt05.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SPTT05
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SPTT05(N,Nrhs,D,E,B,Ldb,X,Ldx,Xact,Ldxact,Ferr,Berr,   &
     &                  Reslts)
      IMPLICIT NONE
!*--SPTT05154
!
...
!     ..
!     .. Array Arguments ..
      REAL B(Ldb,*) , Berr(*) , D(*) , E(*) , Ferr(*) , Reslts(*) ,     &
     &     X(Ldx,*) , Xact(Ldxact,*)
!     ..
!
!  =====================================================================
