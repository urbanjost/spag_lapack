!*==dchkql.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKQL
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKQL(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!                       Test DGEQLF
!
                           CALL DQLT01(m,n,A,Af,Aq,Al,lda,Tau,Work,     &
...
!                       returned by DQLT01
!
                           CALL DQLT02(m,n,k,A,Af,Aq,Al,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ENDIF
                        IF ( m>=k ) THEN
!
...
!                       by DQLT01
!
                           CALL DQLT03(m,n,k,Af,Ac,Al,Aq,lda,Tau,Work,  &
...
!
                              ...
                              SRNamt = 'DGEQLS'
                              CALL DGEQLS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
