!*==zchkqr.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKQR
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKQR(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!     .. Array Arguments ..
      ...
      DOUBLE PRECISION Rwork(*)
      COMPLEX*16 A(*) , Ac(*) , Af(*) , Aq(*) , Ar(*) , B(*) , Tau(*) , &
     &           Work(*) , X(*) , Xact(*)
!     ..
!
!  =====================================================================
...
!                       Test ZGEQRF
!
                           CALL ZQRT01(m,n,A,Af,Aq,Ar,lda,Tau,Work,     &
     &                                 lwork,Rwork,result(1))
!
!                       Test ZGEQRFP
!
                           CALL ZQRT01P(m,n,A,Af,Aq,Ar,lda,Tau,Work,    &
     &                                  lwork,Rwork,result(8))
 
                           IF ( .NOT.ZGENND(m,n,Af,lda) ) result(9)     &
     &                          = 2*Thresh
                           nt = nt + 1
                        ELSEIF ( m>=n ) THEN
!
...
!                       returned by ZQRT01
!
                           CALL ZQRT02(m,n,k,A,Af,Aq,Ar,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ENDIF
                        IF ( m>=k ) THEN
!
...
!                       by ZQRT01
!
                           CALL ZQRT03(m,n,k,Af,Ac,Ar,Aq,lda,Tau,Work,  &
...
!
                              ...
                              SRNamt = 'ZGEQRS'
                              CALL ZGEQRS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
