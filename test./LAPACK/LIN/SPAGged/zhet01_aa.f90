!*==zhet01_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZHET01_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZHET01_AA(Uplo,N,A,Lda,Afac,Ldafac,Ipiv,C,Ldc,Rwork,   &
     &                     Resid)
      IMPLICIT NONE
!*--ZHET01_AA129
!
...
!
         IF ( LSAME(Uplo,'U') ) THEN
            CALL ZTRMM('Left',Uplo,'Conjugate transpose','Unit',N-1,N,  &
...
!
     ...
     &                 Afac(1,2),Ldafac,C(1,2),Ldc)
         ELSE
            CALL ZTRMM('Right',Uplo,'Conjugate transpose','Unit',N,N-1, &
