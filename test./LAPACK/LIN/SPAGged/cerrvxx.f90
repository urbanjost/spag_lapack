!*==cerrvx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CERRVXX
!
!  =========== DOCUMENTATION ===========
!
...
!     .. External Subroutines ..
     ...
     &         CHESV , CHESV_RK , CHESV_ROOK , CHESVX , CHKXER , CHPSV ,&
     &         CHPSVX , CPBSV , CPBSVX , CPOSV , CPOSVX , CPPSV ,       &
     &         CPPSVX , CPTSV , CPTSVX , CSPSV , CSPSVX , CSYSV ,       &
     &         CSYSV_RK , CSYSV_ROOK , CSYSVX , CGESVXX , CPOSVXX ,     &
     &         CSYSVXX , CHESVXX , CGBSVXX
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
