!*==cpot03.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CPOT03
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CPOT03(Uplo,N,A,Lda,Ainv,Ldainv,Work,Ldwork,Rwork,     &
     &                  Rcond,Resid)
      IMPLICIT NONE
!*--CPOT03130
!
...
!
      ...
      ELSE
         ...
         ENDDO
      ENDIF
      CALL CHEMM('Left',Uplo,N,N,-CONE,A,Lda,Ainv,Ldainv,CZERO,Work,    &
     &           Ldwork)
!
