!*==sdrvsy_rk.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SDRVSY_RK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVSY_RK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,    &
...
!     .. Array Arguments ..
      LOGICAL Dotype(*)
      INTEGER Iwork(*) , Nval(*)
      REAL A(*) , Afac(*) , Ainv(*) , B(*) , E(*) , Rwork(*) , Work(*) ,&
     &     X(*) , Xact(*)
!     ..
!
!  =====================================================================
...
!     .. External Subroutines ..
     ...
     &         SLARHS , SLATB4 , SLATMS , SPOT02 , SSYSV_RK , SSYT01_3 ,&
     &         SSYTRF_RK , SSYTRI_3 , XLAENV
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'SSYSV_RK'
                           CALL SSYSV_RK(uplo,n,Nrhs,Afac,lda,E,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'SSYSV_RK',info,k,uplo,n,&
