!*==dpbt01.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DPBT01
!
!  =========== DOCUMENTATION ===========
!
...
!
            IF ( klen>0 ) CALL DTRMV('Upper','Transpose','Non-unit',    &
...
!
            IF ( klen>0 ) CALL DSYR('Lower',klen,ONE,Afac(2,k),1,       &
     &                              Afac(1,k+1),Ldafac-1)
!
