!*==schksy_aa_2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE SCHKSY_AA_2STAGE(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,   &
...
!     .. External Subroutines ..
     ...
     &         SLATB4 , SLATMS , SPOT02 , SSYT01_AA , SSYTRF_AA_2STAGE ,&
...
!
                        ...
                        CALL SSYTRF_AA_2STAGE(uplo,n,Afac,lda,Ainv,     &
...
!
                        IF ( info/=k )                                  &
     &                        CALL ALAERH(path,'SSYTRF_AA_2STAGE',info, &
...
!
     ...
     &                                 nrhs , imat , k , result(k)
                              ...
                              ENDDO
                           ELSEIF ( izero==0 ) THEN
                              CALL ALAERH(path,'SSYTRS_AA_2STAGE',info, &
...
!
      END SUBROUTINE SCHKSY_AA_2STAGE
