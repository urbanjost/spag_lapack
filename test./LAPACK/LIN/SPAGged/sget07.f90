!*==sget07.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SGET07
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SGET07(Trans,N,Nrhs,A,Lda,B,Ldb,X,Ldx,Xact,Ldxact,Ferr,&
     &                  Chkferr,Berr,Reslts)
      IMPLICIT NONE
!*--SGET07169
!
...
!     ..
!     .. Array Arguments ..
      REAL A(Lda,*) , B(Ldb,*) , Berr(*) , Ferr(*) , Reslts(*) ,        &
     &     X(Ldx,*) , Xact(Ldxact,*)
!     ..
!
!  =====================================================================
