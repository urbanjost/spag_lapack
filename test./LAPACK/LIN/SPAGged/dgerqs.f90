!*==dgerqs.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DGERQS
!
!  =========== DOCUMENTATION ===========
!
...
!     Solve R*X = B(n-m+1:n,:)
!
      CALL DTRSM('Left','Upper','No transpose','Non-unit',M,Nrhs,ONE,   &
...
!     B := Q' * B
!
      CALL DORMRQ('Left','Transpose',N,Nrhs,M,A,Lda,Tau,B,Ldb,Work,     &
     &            Lwork,Info)
!
!
!     End of DGERQS
!
      END SUBROUTINE DGERQS
