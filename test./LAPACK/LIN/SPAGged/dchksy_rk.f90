!*==dchksy_rk.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DCHKSY_RK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKSY_RK(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,   &
...
!     .. External Subroutines ..
     ...
     &         DSYCON_3 , DSYT01_3 , DSYTRF_RK , DSYTRI_3 , DSYTRS_3 ,  &
     &         XLAENV
!     ..
!     .. Intrinsic Functions ..
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'DSYTRF_RK',info,k,uplo,n,&
...
!
                              SRNamt = 'DSYTRS_3'
                              CALL DSYTRS_3(uplo,n,nrhs,Afac,lda,E,     &
     &                           Iwork,X,lda,info)
!
...
!
                           IF ( info/=0 )                               &
     &                          CALL ALAERH(path,'DSYCON_3',info,0,uplo,&
