!*==zchkhe_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKHE_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKHE_AA(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,   &
...
!     .. External Subroutines ..
      EXTERNAL ALAERH , ALAHD , ALASUM , XLAENV , ZERRHE , ZHET01_AA ,  &
     &         ZHETRF_AA , ZHETRS_AA , ZLACPY , ZLAIPD , ZLARHS ,       &
     &         ZLATB4 , ZLATMS , ZPOT02
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
!     ..
...
!
                        ...
                        SRNamt = 'ZHETRF_AA'
                        CALL ZHETRF_AA(uplo,n,Afac,lda,Iwork,Ainv,lwork,&
     &                                 info)
!
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'ZHETRF_AA',info,k,uplo,n,&
     &                       n,-1,-1,nb,imat,nfail,nerrs,Nout)
!
!+    TEST 1
!                 Reconstruct matrix from factors and compute residual.
!
                        CALL ZHET01_AA(uplo,n,A,lda,Afac,lda,Iwork,Ainv,&
     &                                 lda,Rwork,result(1))
                        nt = 1
!
!
...
!
                           SRNamt = 'ZHETRS_AA'
                           lwork = MAX(1,3*n-2)
                           CALL ZHETRS_AA(uplo,n,nrhs,Afac,lda,Iwork,X, &
     &                        lda,Work,lwork,info)
!
...
!
     ...
     &                                 nrhs , imat , k , result(k)
                              ...
                              ENDDO
                           ELSEIF ( izero==0 ) THEN
                              CALL ALAERH(path,'ZHETRS_AA',info,0,uplo, &
