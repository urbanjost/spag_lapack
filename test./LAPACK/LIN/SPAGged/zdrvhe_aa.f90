!*==zdrvhe_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZDRVHE_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZDRVHE_AA(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,    &
...
!     .. External Subroutines ..
     ...
     &         ZHESV_AA , ZHET01_AA , ZHETRF_AA , ZHETRI2 , ZLACPY ,    &
...
!
                           SRNamt = 'ZHESV_AA '
                           CALL ZHESV_AA(uplo,n,Nrhs,Afac,lda,Iwork,X,  &
     &                        lda,Work,lwork,info)
!
