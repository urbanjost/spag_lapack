!*==cdrvsy_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVSY_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CDRVSY_ROOK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,  &
...
!
                           SRNamt = 'CSYSV_ROOK'
                           CALL CSYSV_ROOK(uplo,n,Nrhs,Afac,lda,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
     ...
     &                                CALL ALADHD(Nout,path)
                                 WRITE (Nout,FMT=99001) 'CSYSV_ROOK' ,  &
