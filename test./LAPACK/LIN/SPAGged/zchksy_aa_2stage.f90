!*==zchksy_aa_2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE ZCHKSY_AA_2STAGE(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,   &
...
!     .. External Subroutines ..
     ...
     &         ZLATB4 , ZLATMS , ZSYT02 , ZSYT01 , ZSYTRF_AA_2STAGE ,   &
...
!
                        ...
                        CALL ZSYTRF_AA_2STAGE(uplo,n,Afac,lda,Ainv,     &
...
!
                        IF ( info/=k )                                  &
     &                        CALL ALAERH(path,'ZSYTRF_AA_2STAGE',info, &
...
!
     ...
     &                                 nrhs , imat , k , result(k)
                              ...
                              ENDDO
                           ELSEIF ( izero==0 ) THEN
                              CALL ALAERH(path,'ZSYTRS_AA_2STAGE',info, &
...
!
      END SUBROUTINE ZCHKSY_AA_2STAGE
