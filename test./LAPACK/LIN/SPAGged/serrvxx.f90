!*==serrvx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SERRVXX
!
!  =========== DOCUMENTATION ===========
!
...
!
         ...
         SRNamt = 'SGESVXX'
         INFot = 1
         CALL SGESVXX('/','N',0,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,     &
     ...
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 3
         CALL SGESVXX('N','N',-1,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,    &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 4
         CALL SGESVXX('N','N',0,-1,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,    &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 6
         CALL SGESVXX('N','N',2,1,a,1,af,2,ip,eq,r,c,b,2,x,2,rcond,     &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 8
         CALL SGESVXX('N','N',2,1,a,2,af,1,ip,eq,r,c,b,2,x,2,rcond,     &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 10
         eq = '/'
         CALL SGESVXX('F','N',0,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,     &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 11
         eq = 'R'
         CALL SGESVXX('F','N',1,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,     &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 12
     ...
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 14
         CALL SGESVXX('N','N',2,1,a,2,af,2,ip,eq,r,c,b,1,x,2,rcond,     &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
         INFot = 16
         CALL SGESVXX('N','N',2,1,a,2,af,2,ip,eq,r,c,b,2,x,1,rcond,     &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGESVXX',INFot,NOUt,LERr,OK)
!
...
!
         ...
         SRNamt = 'SGBSVXX'
         INFot = 1
         CALL SGBSVXX('/','N',0,0,0,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 2
         CALL SGBSVXX('N','/',0,1,1,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 3
         CALL SGBSVXX('N','N',-1,1,1,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,&
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 4
         CALL SGBSVXX('N','N',2,-1,1,0,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,&
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 5
     ...
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 6
         CALL SGBSVXX('N','N',0,1,1,-1,a,1,af,1,ip,eq,r,c,b,1,x,1,rcond,&
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 8
         CALL SGBSVXX('N','N',2,1,1,1,a,2,af,2,ip,eq,r,c,b,2,x,2,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 10
         CALL SGBSVXX('N','N',2,1,1,1,a,3,af,3,ip,eq,r,c,b,2,x,2,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 12
         eq = '/'
         CALL SGBSVXX('F','N',0,1,1,0,a,3,af,4,ip,eq,r,c,b,1,x,1,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 13
         eq = 'R'
         CALL SGBSVXX('F','N',1,1,1,0,a,3,af,4,ip,eq,r,c,b,1,x,1,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 14
     ...
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 15
         CALL SGBSVXX('N','N',2,1,1,1,a,3,af,4,ip,eq,r,c,b,1,x,2,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
         INFot = 16
         CALL SGBSVXX('N','N',2,1,1,1,a,3,af,4,ip,eq,r,c,b,2,x,1,rcond, &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SGBSVXX',INFot,NOUt,LERr,OK)
!
...
!
         ...
         SRNamt = 'SPOSVXX'
         INFot = 1
         CALL SPOSVXX('/','U',0,0,a,1,af,1,eq,c,b,1,x,1,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 2
         CALL SPOSVXX('N','/',0,0,a,1,af,1,eq,c,b,1,x,1,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 3
         CALL SPOSVXX('N','U',-1,0,a,1,af,1,eq,c,b,1,x,1,rcond,rpvgrw,  &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 4
         CALL SPOSVXX('N','U',0,-1,a,1,af,1,eq,c,b,1,x,1,rcond,rpvgrw,  &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 6
         CALL SPOSVXX('N','U',2,0,a,1,af,2,eq,c,b,2,x,2,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 8
         CALL SPOSVXX('N','U',2,0,a,2,af,1,eq,c,b,2,x,2,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 9
         eq = '/'
         CALL SPOSVXX('F','U',0,0,a,1,af,1,eq,c,b,1,x,1,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 10
         eq = 'Y'
         CALL SPOSVXX('F','U',1,0,a,1,af,1,eq,c,b,1,x,1,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 12
         CALL SPOSVXX('N','U',2,0,a,2,af,2,eq,c,b,1,x,2,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
         INFot = 14
         CALL SPOSVXX('N','U',2,0,a,2,af,2,eq,c,b,2,x,1,rcond,rpvgrw,   &
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SPOSVXX',INFot,NOUt,LERr,OK)
!
...
!
         ...
         INFot = 1
         eq = 'N'
         CALL SSYSVXX('/','U',0,0,a,1,af,1,ip,eq,r,b,1,x,1,rcond,rpvgrw,&
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 2
         CALL SSYSVXX('N','/',0,0,a,1,af,1,ip,eq,r,b,1,x,1,rcond,rpvgrw,&
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 3
         CALL SSYSVXX('N','U',-1,0,a,1,af,1,ip,eq,r,b,1,x,1,rcond,      &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 4
         eq = '/'
         CALL SSYSVXX('N','U',0,-1,a,1,af,1,ip,eq,r,b,1,x,1,rcond,      &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         eq = 'Y'
         INFot = 6
         CALL SSYSVXX('N','U',2,0,a,1,af,2,ip,eq,r,b,2,x,2,rcond,rpvgrw,&
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 8
         CALL SSYSVXX('N','U',2,0,a,2,af,1,ip,eq,r,b,2,x,2,rcond,rpvgrw,&
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 10
         CALL SSYSVXX('F','U',2,0,a,2,af,2,ip,'A',r,b,2,x,2,rcond,      &
     &                rpvgrw,berr,n_err_bnds,err_bnds_n,err_bnds_c,     &
     &                nparams,params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 11
         eq = 'Y'
         CALL SSYSVXX('F','U',2,0,a,2,af,2,ip,eq,r,b,2,x,2,rcond,rpvgrw,&
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 11
     ...
     &                params,w,iw,info)
         ...
         INFot = 13
         eq = 'N'
         CALL SSYSVXX('N','U',2,0,a,2,af,2,ip,eq,r,b,1,x,2,rcond,rpvgrw,&
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
         INFot = 15
         CALL SSYSVXX('N','U',2,0,a,2,af,2,ip,eq,r,b,2,x,1,rcond,rpvgrw,&
     &                berr,n_err_bnds,err_bnds_n,err_bnds_c,nparams,    &
     &                params,w,iw,info)
         CALL CHKXER('SSYSVXX',INFot,NOUt,LERr,OK)
!
