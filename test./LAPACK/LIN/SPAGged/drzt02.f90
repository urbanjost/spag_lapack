!*==drzt02.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DRZT02
!
!  =========== DOCUMENTATION ===========
!
...
!     Q := P(1) * ... * P(m) * Q
!
      CALL DORMRZ('Left','No transpose',N,N,M,N-M,Af,Lda,Tau,Work,N,    &
     &            Work(N*N+1),Lwork-N*N,info)
!
!     Q := P(m) * ... * P(1) * Q
!
      CALL DORMRZ('Left','Transpose',N,N,M,N-M,Af,Lda,Tau,Work,N,       &
     &            Work(N*N+1),Lwork-N*N,info)
!
!     Q := Q - I
!
