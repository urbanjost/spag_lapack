!*==cchkhe_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCHKHE_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKHE_AA(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh,   &
...
!
                        ...
                        SRNamt = 'CHETRF_AA'
                        CALL CHETRF_AA(uplo,n,Afac,lda,Iwork,Ainv,lwork,&
     &                                 info)
!
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'CHETRF_AA',info,k,uplo,n,&
     &                       n,-1,-1,nb,imat,nfail,nerrs,Nout)
!
!+    TEST 1
!                 Reconstruct matrix from factors and compute residual.
!
                        CALL CHET01_AA(uplo,n,A,lda,Afac,lda,Iwork,Ainv,&
     &                                 lda,Rwork,result(1))
                        nt = 1
!
!
...
!
                           SRNamt = 'CHETRS_AA'
                           lwork = MAX(1,3*n-2)
                           CALL CHETRS_AA(uplo,n,nrhs,Afac,lda,Iwork,X, &
     &                        lda,Work,lwork,info)
!
...
!
     ...
     &                                 nrhs , imat , k , result(k)
                              ...
                              ENDDO
                           ELSEIF ( izero==0 ) THEN
                              CALL ALAERH(path,'CHETRS_AA',info,0,uplo, &
