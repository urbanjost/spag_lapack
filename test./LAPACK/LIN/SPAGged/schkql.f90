!*==schkql.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCHKQL
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKQL(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!                       Test SGEQLF
!
                           CALL SQLT01(m,n,A,Af,Aq,Al,lda,Tau,Work,     &
...
!                       returned by SQLT01
!
                           CALL SQLT02(m,n,k,A,Af,Aq,Al,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ENDIF
                        IF ( m>=k ) THEN
!
...
!                       by SQLT01
!
                           CALL SQLT03(m,n,k,Af,Ac,Al,Aq,lda,Tau,Work,  &
...
!
                              ...
                              SRNamt = 'SGEQLS'
                              CALL SGEQLS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
