!*==zdrvsy_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZDRVSY_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZDRVSY_ROOK(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,  &
...
!
                           SRNamt = 'ZSYSV_ROOK'
                           CALL ZSYSV_ROOK(uplo,n,Nrhs,Afac,lda,Iwork,X,&
     &                        lda,Work,lwork,info)
!
...
!
     ...
     &                                CALL ALADHD(Nout,path)
                                 WRITE (Nout,FMT=99001) 'ZSYSV_ROOK' ,  &
