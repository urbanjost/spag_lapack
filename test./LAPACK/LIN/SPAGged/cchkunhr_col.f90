!*==cchkunhr_col.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE CCHKUNHR_COL(Thresh,Tsterr,Nm,Mval,Nn,Nval,Nnb,Nbval,  &
     &                        Nout)
      IMPLICIT NONE
!*--CCHKUNHR_COL112
!
...
!
99001 FORMAT ('CUNGTSQR and CUNHR_COL: M=',I5,', N=',I5,', MB1=',I5,    &
     &        ', NB1=',I5,', NB2=',I5,' test(',I2,')=',G12.5)
99002 FORMAT ('CUNGTSQR_ROW and CUNHR_COL: M=',I5,', N=',I5,', MB1=',I5,&
     &        ', NB1=',I5,', NB2=',I5,' test(',I2,')=',G12.5)
!
!     End of CCHKUNHR_COL
!
      END SUBROUTINE CCHKUNHR_COL
