!*==sdrvsy_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SDRVSY_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVSY_AA(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,    &
...
!     .. External Subroutines ..
     ...
     &         SLARHS , SLASET , SLATB4 , SLATMS , SPOT02 , SSYSV_AA ,  &
     &         SSYT01_AA , SSYTRF_AA , XLAENV
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'SSYSV_AA'
                           CALL SSYSV_AA(uplo,n,Nrhs,Afac,lda,Iwork,X,  &
     &                        lda,Work,lwork,info)
!
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'SSYSV_AA ',info,k,uplo, &
