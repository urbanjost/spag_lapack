!*==dchksy_aa_2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE DCHKSY_AA_2STAGE(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,   &
...
!
                        ...
                        CALL DSYTRF_AA_2STAGE(uplo,n,Afac,lda,Ainv,     &
...
!
                        IF ( info/=k )                                  &
     &                        CALL ALAERH(path,'DSYTRF_AA_2STAGE',info, &
...
!
     ...
     &                                 nrhs , imat , k , result(k)
                              ...
                              ENDDO
                           ELSEIF ( izero==0 ) THEN
                              CALL ALAERH(path,'DSYTRS_AA_2STAGE',info, &
...
!
      END SUBROUTINE DCHKSY_AA_2STAGE
