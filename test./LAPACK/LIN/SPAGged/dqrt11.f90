!*==dqrt11.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!     Form Q
!
      CALL DORM2R('Left','No transpose',M,M,K,A,Lda,Tau,Work,M,         &
     &            Work(M*M+1),info)
!
!     Form Q'*Q
!
      CALL DORM2R('Left','Transpose',M,M,K,A,Lda,Tau,Work,M,Work(M*M+1),&
     &            info)
!
      DO j = 1 , M
