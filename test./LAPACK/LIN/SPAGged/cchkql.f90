!*==cchkql.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCHKQL
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKQL(Dotype,Nm,Mval,Nn,Nval,Nnb,Nbval,Nxval,Nrhs,    &
...
!                       Test CGEQLF
!
                           CALL CQLT01(m,n,A,Af,Aq,Al,lda,Tau,Work,     &
...
!                       returned by CQLT01
!
                           CALL CQLT02(m,n,k,A,Af,Aq,Al,lda,Tau,Work,   &
     &                                 lwork,Rwork,result(1))
                        ENDIF
                        IF ( m>=k ) THEN
!
...
!                       by CQLT01
!
                           CALL CQLT03(m,n,k,Af,Ac,Al,Aq,lda,Tau,Work,  &
...
!
                              ...
                              SRNamt = 'CGEQLS'
                              CALL CGEQLS(m,n,Nrhs,Af,lda,Tau,X,lda,    &
     &                           Work,lwork,info)
!
!                          Check error code from CGEQLS.
!
                              IF ( info/=0 )                            &
     &                             CALL ALAERH(path,'CGEQLS',info,0,' ',&
