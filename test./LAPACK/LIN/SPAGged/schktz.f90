!*==schktz.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCHKTZ
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKTZ(Dotype,Nm,Mval,Nn,Nval,Thresh,Tsterr,A,Copya,S, &
     &                  Tau,Work,Nout)
      IMPLICIT NONE
!*--SCHKTZ136
!
...
!
                     IF ( mode==0 ) THEN
                        ...
                        ENDDO
                     ELSE
                        CALL SLATMS(m,n,'Uniform',iseed,'Nonsymmetric', &
     &                              S,imode,ONE/eps,ONE,m,n,            &
     &                              'No packing',A,lda,Work,info)
                        CALL SGEQR2(m,n,A,lda,Work,Work(mnmin+1),info)
                        CALL SLASET('Lower',m-1,n,ZERO,ZERO,A(2),lda)
