!*==dptt05.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DPTT05
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DPTT05(N,Nrhs,D,E,B,Ldb,X,Ldx,Xact,Ldxact,Ferr,Berr,   &
     &                  Reslts)
      IMPLICIT NONE
!*--DPTT05154
!
...
!     ..
!     .. Array Arguments ..
      DOUBLE PRECISION B(Ldb,*) , Berr(*) , D(*) , E(*) , Ferr(*) ,     &
