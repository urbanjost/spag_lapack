!*==ddrvsy_aa.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DDRVSY_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DDRVSY_AA(Dotype,Nn,Nval,Nrhs,Thresh,Tsterr,Nmax,A,    &
...
!     .. External Subroutines ..
     ...
     &         DLARHS , DLASET , DLATB4 , DLATMS , DPOT02 , DSYSV_AA ,  &
     &         DSYT01_AA , DSYTRF_AA , XLAENV
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
...
!
                           SRNamt = 'DSYSV_AA'
                           CALL DSYSV_AA(uplo,n,Nrhs,Afac,lda,Iwork,X,  &
     &                        lda,Work,lwork,info)
!
...
!
                           IF ( info/=k ) THEN
                              CALL ALAERH(path,'DSYSV_AA ',info,k,uplo, &
