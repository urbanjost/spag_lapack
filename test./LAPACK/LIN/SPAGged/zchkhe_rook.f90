!*==zchkhe_rook.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKHE_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKHE_ROOK(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,Thresh, &
...
!     .. External Subroutines ..
     ...
     &         ZHECON_ROOK , ZHET01_ROOK , ZHETRF_ROOK , ZHETRI_ROOK ,  &
     &         ZHETRS_ROOK , XLAENV
!     ..
!     .. Intrinsic Functions ..
...
!
                        IF ( info/=k )                                  &
     &                       CALL ALAERH(path,'ZHETRF_ROOK',info,k,uplo,&
...
!
                              SRNamt = 'ZHETRS_ROOK'
                              CALL ZHETRS_ROOK(uplo,n,nrhs,Afac,lda,    &
     &                           Iwork,X,lda,info)
!
!                    Check error code from ZHETRS_ROOK and handle error.
!
                              IF ( info/=0 )                            &
     &                              CALL ALAERH(path,'ZHETRS_ROOK',info,&
