!*==zchkhe_aa_2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE ZCHKHE_AA_2STAGE(Dotype,Nn,Nval,Nnb,Nbval,Nns,Nsval,   &
...
!     .. Array Arguments ..
      LOGICAL Dotype(*)
      INTEGER Iwork(*) , Nbval(*) , Nsval(*) , Nval(*)
      COMPLEX*16 A(*) , Afac(*) , Ainv(*) , B(*) , Rwork(*) , Work(*) , &
     &           X(*) , Xact(*)
!     ..
!
!  =====================================================================
...
!     .. External Subroutines ..
     ...
     &         ZLATB4 , ZLATMS , ZPOT02 , ZHETRF_AA_2STAGE ,            &
     &         ZHETRS_AA_2STAGE , XLAENV
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
!     ..
...
!
                        ...
                        CALL ZHETRF_AA_2STAGE(uplo,n,Afac,lda,Ainv,     &
...
!
                        IF ( info/=k )                                  &
     &                        CALL ALAERH(path,'ZHETRF_AA_2STAGE',info, &
...
!
     ...
     &                                 nrhs , imat , k , result(k)
                              ...
                              ENDDO
                           ELSEIF ( izero==0 ) THEN
                              CALL ALAERH(path,'ZHETRS_AA_2STAGE',info, &
...
!
      END SUBROUTINE ZCHKHE_AA_2STAGE
