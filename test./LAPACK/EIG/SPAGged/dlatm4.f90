!*==dlatm4.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DLATM4
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DLATM4(Itype,N,Nz1,Nz2,Isign,Amagn,Rcond,Triang,Idist, &
     &                  Iseed,A,Lda)
      IMPLICIT NONE
!*--DLATM4179
!
...
!     .. Local Scalars ..
     ...
     &        klen
      DOUBLE PRECISION alpha , cl , cr , safmin , sl , sr , sv1 , sv2 , &
     &                 temp
!     ..
!     .. External Functions ..
