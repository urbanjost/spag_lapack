!*==sget35.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SGET35
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
     ...
     &        isgn , itrana , itranb , j , m , n
      REAL bignum , cnrm , eps , res , res1 , rmul , scale , smlnum ,   &
     &     tnrm , xnrm
!     ..
!     .. Local Arrays ..
...
!
                        ...
                        DO imloff = 1 , 2
                           DO imb = 1 , 8
                              DO imldb1 = 1 , 3
                                 ...
                                 ENDDO
                                 Knt = Knt + 1
                                 CALL STRSYL(trana,tranb,isgn,m,n,a,6,b,&
     &                              6,c,6,scale,info)
     ...
     &                                 rmul = ONE/MAX(xnrm,tnrm)
                                 ENDIF
                                 CALL SGEMM(trana,'N',m,n,m,rmul,a,6,c, &
     &                              6,-scale*rmul,cc,6)
                                 CALL SGEMM('N',tranb,m,n,n,REAL(isgn)  &
