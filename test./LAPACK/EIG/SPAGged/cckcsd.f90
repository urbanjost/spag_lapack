!*==cckcsd.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCKCSD
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCKCSD(Nm,Mval,Pval,Qval,Nmats,Iseed,Thresh,Mmax,X,Xf, &
...
!     .. Parameters ..
      ...
      PARAMETER (GAPDIGIT=10.0E0,ORTH=1.0E-4,REALONE=1.0E0,             &
     &           REALZERO=0.0E0,TEN=10.0E0)
      COMPLEX ONE , ZERO
...
!
               nt = 15
!
               CALL CCSDTS(m,p,q,X,Xf,ldx,U1,ldu1,U2,ldu2,V1t,ldv1t,V2t,&
...
!
99001 FORMAT (' CLAROR in CCKCSD: M = ',I5,', INFO = ',I15)
99002 FORMAT (' M=',I4,' P=',I4,', Q=',I4,', type ',I2,', test ',I2,    &
     &        ', ratio=',G13.6)
!
!     End of CCKCSD
!
      END SUBROUTINE CCKCSD
!*==clacsg.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!
!
!
