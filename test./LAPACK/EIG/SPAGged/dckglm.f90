!*==dckglm.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE DCKGLM(Nn,Mval,Pval,Nval,Nmats,Iseed,Thresh,Nmax,A,Af, &
...
!
                  ...
                  ENDDO
!
                  CALL DGLMTS(n,m,p,A,Af,lda,B,Bf,ldb,X,X(Nmax+1),      &
...
!
99001 FORMAT (' DLATMS in DCKGLM INFO = ',I5)
