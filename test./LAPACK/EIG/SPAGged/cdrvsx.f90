!*==cdrvsx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVSX
!
!  =========== DOCUMENTATION ===========
!
...
!
                  DO iwk = 1 , 2
                     ...
                     nnwork = MAX(nnwork,1)
!
                     CALL CGET24(.FALSE.,jtype,Thresh,ioldsd,Nounit,n,A,&
...
!
         CALL CGET24(.TRUE.,22,Thresh,Iseed,Nounit,n,A,Lda,H,Ht,W,Wt,   &
...
99009 FORMAT (' CDRVSX: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of CDRVSX
!
      END SUBROUTINE CDRVSX
