!*==sckcsd.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCKCSD
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCKCSD(Nm,Mval,Pval,Qval,Nmats,Iseed,Thresh,Mmax,X,Xf, &
...
!     .. Parameters ..
      ...
      PARAMETER (GAPDIGIT=10.0E0,ONE=1.0E0,ORTH=1.0E-4,TEN=10.0E0,      &
     &           ZERO=0.0E0)
      REAL PIOVER2
...
!
               nt = 15
!
               CALL SCSDTS(m,p,q,X,Xf,ldx,U1,ldu1,U2,ldu2,V1t,ldv1t,V2t,&
...
!
99001 FORMAT (' SLAROR in SCKCSD: M = ',I5,', INFO = ',I15)
99002 FORMAT (' M=',I4,' P=',I4,', Q=',I4,', type ',I2,', test ',I2,    &
     &        ', ratio=',G13.6)
!
!     End of SCKCSD
!
      END SUBROUTINE SCKCSD
!*==slacsg.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!
!
!
