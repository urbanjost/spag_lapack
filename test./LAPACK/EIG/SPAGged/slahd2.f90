!*==slahd2.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SLAHD2
!
!  =========== DOCUMENTATION ===========
!
...
99023 FORMAT (/' Tests performed:   ',                                  &
     ...
     &        '  | A Z - B Z D | / ( |A| |Z| n ulp )     ')
99024 FORMAT (' 7 = SSYGV, with ITYPE=2 and UPLO=''U'':',               &
     &        '  | A B Z - Z D | / ( |A| |Z| n ulp )     ',             &
...
99025 FORMAT (/' Tests performed:   ',                                  &
     ...
     &        '  | A Z - B Z D | / ( |A| |Z| n ulp )     ')
99026 FORMAT (' 7 = CHEGV, with ITYPE=2 and UPLO=''U'':',               &
     &        '  | A B Z - Z D | / ( |A| |Z| n ulp )     ',             &
