!*==schksb.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SCHKSB
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKSB(Nsizes,Nn,Nwdths,Kk,Ntypes,Dotype,Iseed,Thresh, &
...
!
      ...
      RETURN
!
99001 FORMAT (' SCHKSB: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
99002 FORMAT (/1X,A3,                                                   &
     &        ' -- Real Symmetric Banded Tridiagonal Reduction Routines'&
     &        )
99003 FORMAT (' Matrix types (see SCHKSB for details): ')
!
