!*==zckgqr.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCKGQR
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCKGQR(Nm,Mval,Np,Pval,Nn,Nval,Nmats,Iseed,Thresh,Nmax,&
...
!     .. Array Arguments ..
      INTEGER Iseed(4) , Mval(*) , Nval(*) , Pval(*)
      DOUBLE PRECISION Rwork(*)
      COMPLEX*16 A(*) , Af(*) , Aq(*) , Ar(*) , B(*) , Bf(*) , Bt(*) ,  &
     &           Bwk(*) , Bz(*) , Taua(*) , Taub(*) , Work(*)
!     ..
!
!  =====================================================================
!
...
!
                     nt = 4
!
                     CALL ZGRQTS(m,p,n,A,Af,Aq,Ar,lda,Taua,B,Bf,Bz,Bt,  &
...
!
                     nt = 4
!
                     CALL ZGQRTS(n,m,p,A,Af,Aq,Ar,lda,Taua,B,Bf,Bz,Bt,  &
     &                           Bwk,ldb,Taub,Work,lwork,Rwork,result)
!
!                 Print information about the tests that did not
!                 pass the threshold.
...
!
99001 FORMAT (' ZLATMS in ZCKGQR:    INFO = ',I5)
