!*==cchkst2stg.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCHKST2STG
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKST2STG(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,&
...
!
            ...
            lh = MAX(1,4*n)
            lw = Lwork - lh
            CALL CHETRD_2STAGE('N',"U",n,V,Ldu,Sd,Se,Tau,Work,lh,       &
     &                         Work(lh+1),lw,iinfo)
!
...
!
            ...
            CALL CHETRD_2STAGE('N',"L",n,V,Ldu,Sd,Se,Tau,Work,lh,       &
     &                         Work(lh+1),lw,iinfo)
!
...
!
      ...
      RETURN
!
99001 FORMAT (' CCHKST2STG: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,   &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
99002 FORMAT (/1X,A3,' -- Complex Hermitian eigenvalue problem')
99003 FORMAT (' Matrix types (see CCHKST2STG for details): ')
!
...
!
99009 FORMAT (/'Test performed:  see CCHKST2STG for details.',/)
!     End of CCHKST2STG
!
      END SUBROUTINE CCHKST2STG
