!*==cckglm.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!
!  =====================================================================
      SUBROUTINE CCKGLM(Nn,Nval,Mval,Pval,Nmats,Iseed,Thresh,Nmax,A,Af, &
...
!
                  ...
                  ENDDO
!
                  CALL CGLMTS(n,m,p,A,Af,lda,B,Bf,ldb,X,X(Nmax+1),      &
...
!
99001 FORMAT (' CLATMS in CCKGLM INFO = ',I5)
