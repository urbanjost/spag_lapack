!*==dget40.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DGET40
!
!  =========== DOCUMENTATION ===========
!
...
!     ..
!     .. Local Arrays ..
      DOUBLE PRECISION q(LDT,LDT) , z(LDT,LDT) , result(4) , t(LDT,LDT) &
     &                 , t1(LDT,LDT) , t2(LDT,LDT) , s(LDT,LDT) ,       &
     &                 s1(LDT,LDT) , s2(LDT,LDT) , tmp(LDT,LDT) ,       &
     &                 work(LWORK)
!     ..
!     .. External Functions ..
...
!
         ...
         CALL DTGEXC(.FALSE.,.FALSE.,n,t1,LDT,s1,LDT,q,LDT,z,LDT,ifst1, &
...
!
         CALL DLASET('Full',n,n,ZERO,ONE,q,LDT)
         CALL DLASET('Full',n,n,ZERO,ONE,z,LDT)
         CALL DTGEXC(.TRUE.,.TRUE.,n,t2,LDT,s2,LDT,q,LDT,z,LDT,ifst2,   &
