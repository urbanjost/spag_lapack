!*==ddrvvx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DDRVVX
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DDRVVX(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Niunit,    &
...
!
         ...
         ENDDO
         CALL DGET23(.TRUE.,'N',22,Thresh,Iseed,Nounit,n,A,Lda,H,Wr,Wi, &
...
99008 FORMAT (' DDRVVX: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of DDRVVX
!
      END SUBROUTINE DDRVVX
