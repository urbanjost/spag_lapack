!*==sdrvsx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SDRVSX
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVSX(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Niunit,    &
     &                  Nounit,A,Lda,H,Ht,Wr,Wi,Wrt,Wit,Wrtmp,Witmp,Vs, &
     &                  Ldvs,Vs1,Result,Work,Lwork,Iwork,Bwork,Info)
      IMPLICIT NONE
!*--SDRVSX457
!
...
!     .. Local Scalars ..
     ...
     &        nslct , ntest , ntestf , ntestt
      REAL anorm , cond , conds , ovfl , rcdein , rcdvin , rtulp ,      &
     &     rtulpi , ulp , ulpinv , unfl
!     ..
!     .. Local Arrays ..
      CHARACTER adumma(1)
...
!
                  DO iwk = 1 , 2
                     ...
                     nnwork = MAX(nnwork,1)
!
                     CALL SGET24(.FALSE.,jtype,Thresh,ioldsd,Nounit,n,A,&
     &                           Lda,H,Ht,Wr,Wi,Wrt,Wit,Wrtmp,Witmp,Vs, &
...
!
      jtype = 0
      DO
         READ (Niunit,FMT=*,END=100) n , nslct
         IF ( n==0 ) EXIT
         jtype = jtype + 1
         Iseed(1) = jtype
...
!
         CALL SGET24(.TRUE.,22,Thresh,Iseed,Nounit,n,A,Lda,H,Ht,Wr,Wi,  &
     &               Wrt,Wit,Wrtmp,Witmp,Vs,Ldvs,Vs1,rcdein,rcdvin,     &
     &               nslct,islct,Result,Work,Lwork,Iwork,Bwork,Info)
!
!     Check for RESULT(j) > THRESH
!
         ntest = 0
...
!
99001 FORMAT (/1X,A3,' -- Real Schur Form Decomposition Expert ',       &
...
99009 FORMAT (' SDRVSX: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of SDRVSX
!
      END SUBROUTINE SDRVSX
