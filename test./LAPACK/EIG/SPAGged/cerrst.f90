!*==cerrst.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CERRST
!
!  =========== DOCUMENTATION ===========
!
...
!
         ...
         INFot = 1
         CALL CHEEVX_2STAGE('/','A','U',0,a,1,0.0D0,0.0D0,0,0,0.0D0,m,x,&
     &                      z,1,w,1,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 1
         CALL CHEEVX_2STAGE('V','A','U',0,a,1,0.0D0,0.0D0,0,0,0.0D0,m,x,&
     &                      z,1,w,1,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 2
         CALL CHEEVX_2STAGE('N','/','U',0,a,1,0.0D0,1.0D0,1,0,0.0D0,m,x,&
     &                      z,1,w,1,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 3
         CALL CHEEVX_2STAGE('N','A','/',0,a,1,0.0D0,0.0D0,0,0,0.0D0,m,x,&
     &                      z,1,w,1,rw,iw,i3,info)
         INFot = 4
         CALL CHEEVX_2STAGE('N','A','U',-1,a,1,0.0D0,0.0D0,0,0,0.0D0,m, &
     &                      x,z,1,w,1,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 6
         CALL CHEEVX_2STAGE('N','A','U',2,a,1,0.0D0,0.0D0,0,0,0.0D0,m,x,&
     &                      z,2,w,3,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 8
         CALL CHEEVX_2STAGE('N','V','U',1,a,1,0.0D0,0.0D0,0,0,0.0D0,m,x,&
     &                      z,1,w,1,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 9
         CALL CHEEVX_2STAGE('N','I','U',1,a,1,0.0D0,0.0D0,0,0,0.0D0,m,x,&
     &                      z,1,w,1,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 10
         CALL CHEEVX_2STAGE('N','I','U',2,a,2,0.0D0,0.0D0,2,1,0.0D0,m,x,&
     &                      z,2,w,3,rw,iw,i3,info)
         CALL CHKXER('CHEEVX_2STAGE',INFot,NOUt,LERr,OK)
         INFot = 15
         CALL CHEEVX_2STAGE('N','A','U',2,a,2,0.0D0,0.0D0,0,0,0.0D0,m,x,&
