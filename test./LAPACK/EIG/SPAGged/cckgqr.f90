!*==cckgqr.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CCKGQR
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCKGQR(Nm,Mval,Np,Pval,Nn,Nval,Nmats,Iseed,Thresh,Nmax,&
...
!
                     nt = 4
!
                     CALL CGRQTS(m,p,n,A,Af,Aq,Ar,lda,Taua,B,Bf,Bz,Bt,  &
...
!
                     nt = 4
!
                     CALL CGQRTS(n,m,p,A,Af,Aq,Ar,lda,Taua,B,Bf,Bz,Bt,  &
     &                           Bwk,ldb,Taub,Work,lwork,Rwork,result)
!
!                 Print information about the tests that did not
!                 pass the threshold.
...
!
99001 FORMAT (' CLATMS in CCKGQR:    INFO = ',I5)
