!*==cdrvvx.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CDRVVX
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CDRVVX(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Niunit,    &
...
!
         ...
         DO i = 1 , n
            ...
            W1(i) = CMPLX(wr,wi)
         ENDDO
         CALL CGET23(.TRUE.,isrt,'N',22,Thresh,Iseed,Nounit,n,A,Lda,H,W,&
...
99008 FORMAT (' CDRVVX: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of CDRVVX
!
      END SUBROUTINE CDRVVX
