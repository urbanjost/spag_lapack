!*==slarhs.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SLARHS
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SLARHS(Path,Xtype,Uplo,Trans,M,N,Kl,Ku,Nrhs,A,Lda,X,   &
...
!     .. External Subroutines ..
      EXTERNAL SGBMV , SGEMM , SLACPY , SLARNV , SSBMV , SSPMV , SSYMM ,&
     &         STBMV , STPMV , STRMM , XERBLA
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX
!     ..
...
!
         DO j = 1 , Nrhs
            CALL SGBMV(Trans,mb,nx,Kl,Ku,ONE,A,Lda,X(1,j),1,ZERO,B(1,j),&
     &                 1)
         ENDDO
!
