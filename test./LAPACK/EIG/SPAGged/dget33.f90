!*==dget33.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b DGET33
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
      ...
      DOUBLE PRECISION bignum , cs , eps , res , smlnum , sn , sum ,    &
     &                 tnrm , wi1 , wi2 , wr1 , wr2
!     ..
!     .. Local Arrays ..
      DOUBLE PRECISION q(2,2) , t(2,2) , t1(2,2) , t2(2,2) , val(4) ,   &
     &                 vm(3)
!     ..
!     .. External Functions ..
...
!
     ...
     &                               ABS(t(2,1)),ABS(t(2,2)))
                              ...
                              q(2,2) = ONE
!
                              CALL DLANV2(t(1,1),t(1,2),t(2,1),t(2,2),  &
