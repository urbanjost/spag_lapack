!*==zchkhb.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZCHKHB
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKHB(Nsizes,Nn,Nwdths,Kk,Ntypes,Dotype,Iseed,Thresh, &
...
!
      ...
      RETURN
!
99001 FORMAT (' ZCHKHB: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
