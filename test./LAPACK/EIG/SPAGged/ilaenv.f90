!*==ilaenv.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ILAENV
!
!  =========== DOCUMENTATION ===========
!
...
!
      ELSEIF ( (Ispec>=12) .AND. (Ispec<=16) ) THEN
!
...
!
      ELSEIF ( (Ispec>=17) .AND. (Ispec<=21) ) THEN
!
...
!
      END FUNCTION ILAENV
!*==ilaenv2stage.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!*==iparmq.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
