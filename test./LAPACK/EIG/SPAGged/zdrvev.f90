!*==zdrvev.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b ZDRVEV
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZDRVEV(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,A,  &
...
!
                  ...
                  CALL ZGEEV('V','V',n,H,Lda,W,Vl,Ldvl,Vr,Ldvr,Work,    &
     &                       nnwork,Rwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'ZGEEV1' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
!
                  CALL ZLACPY('F',n,n,A,Lda,H,Lda)
                  CALL ZGEEV('N','N',n,H,Lda,W1,dum,1,dum,1,Work,nnwork,&
     &                       Rwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'ZGEEV2' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
!
                  CALL ZLACPY('F',n,n,A,Lda,H,Lda)
                  CALL ZGEEV('N','V',n,H,Lda,W1,dum,1,Lre,Ldlre,Work,   &
     &                       nnwork,Rwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'ZGEEV3' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
!
                  CALL ZLACPY('F',n,n,A,Lda,H,Lda)
                  CALL ZGEEV('V','N',n,H,Lda,W1,Lre,Ldlre,dum,1,Work,   &
     &                       nnwork,Rwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'ZGEEV4' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
99006 FORMAT (' N=',I5,', IWK=',I2,', seed=',4(I4,','),' type ',I2,     &
     &        ', test(',I2,')=',G10.3)
99007 FORMAT (' ZDRVEV: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of ZDRVEV
!
      END SUBROUTINE ZDRVEV
