!*==sdrvst2stg.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SDRVST2STG
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVST2STG(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,&
     &                      A,Lda,D1,D2,D3,D4,Eveigs,Wa1,Wa2,Wa3,U,Ldu, &
     &                      V,Tau,Z,Work,Lwork,Iwork,Liwork,Result,Info)
      IMPLICIT NONE
!*--SDRVST2STG456
!
...
!     .. Array Arguments ..
      LOGICAL Dotype(*)
      INTEGER Iseed(4) , Iwork(*) , Nn(*)
      REAL A(Lda,*) , D1(*) , D2(*) , D3(*) , D4(*) , Eveigs(*) ,       &
     &     Result(*) , Tau(*) , U(Ldu,*) , V(Ldu,*) , Wa1(*) , Wa2(*) , &
     &     Wa3(*) , Work(*) , Z(Ldu,*)
!     ..
!
!  =====================================================================
...
!
               IF ( jtype<=7 ) THEN
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEV(V)' , iinfo , n ,  &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEV(N)' , iinfo , n ,  &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 5                ntest = 4
                  ...
                  ENDDO
                  SRNamt = 'SSTEVX'
                  CALL SSTEVX('V','A',n,D1,D2,vl,vu,il,iu,abstol,m,Wa1, &
     &                        Z,Ldu,Work,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVX(V,A)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVX'
                  CALL SSTEVX('N','A',n,D3,D4,vl,vu,il,iu,abstol,m2,Wa2,&
     &                        Z,Ldu,Work,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVX(N,A)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 10               ntest = 7
                  ...
                  ENDDO
                  SRNamt = 'SSTEVR'
                  CALL SSTEVR('V','A',n,D1,D2,vl,vu,il,iu,abstol,m,Wa1, &
     &                        Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1),      &
     &                        Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVR(V,A)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVR'
                  CALL SSTEVR('N','A',n,D3,D4,vl,vu,il,iu,abstol,m2,Wa2,&
     &                        Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1),      &
     &                        Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVR(N,A)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 15               ntest = 10
                  ...
                  ENDDO
                  SRNamt = 'SSTEVX'
                  CALL SSTEVX('V','I',n,D1,D2,vl,vu,il,iu,abstol,m2,Wa2,&
     &                        Z,Ldu,Work,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVX(V,I)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  DO i = 1 , n - 1
                     D4(i) = REAL(A(i+1,i))
                  ENDDO
                  CALL SSTT22(n,m2,0,D3,D4,Wa2,D2,Z,Ldu,Work,MAX(1,m2), &
     &                        Result(10))
!
!
                  ntest = 12
                  ...
                  ENDDO
                  SRNamt = 'SSTEVX'
                  CALL SSTEVX('N','I',n,D3,D4,vl,vu,il,iu,abstol,m3,Wa3,&
     &                        Z,Ldu,Work,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVX(N,I)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVX'
                  CALL SSTEVX('V','V',n,D1,D2,vl,vu,il,iu,abstol,m2,Wa2,&
     &                        Z,Ldu,Work,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVX(V,V)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVX'
                  CALL SSTEVX('N','V',n,D3,D4,vl,vu,il,iu,abstol,m3,Wa3,&
     &                        Z,Ldu,Work,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVX(N,V)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 25               ntest = 16
                  ...
                  ENDDO
                  SRNamt = 'SSTEVD'
                  CALL SSTEVD('V',n,D1,D2,Z,Ldu,Work,lwedc,Iwork,liwedc,&
     &                        iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVD(V)' , iinfo , n , &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVD'
                  CALL SSTEVD('N',n,D3,D4,Z,Ldu,Work,lwedc,Iwork,liwedc,&
     &                        iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVD(N)' , iinfo , n , &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 30               ntest = 19
                  ...
                  ENDDO
                  SRNamt = 'SSTEVR'
                  CALL SSTEVR('V','I',n,D1,D2,vl,vu,il,iu,abstol,m2,Wa2,&
     &                        Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1),      &
     &                        Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVR(V,I)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVR'
                  CALL SSTEVR('N','I',n,D3,D4,vl,vu,il,iu,abstol,m3,Wa3,&
     &                        Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1),      &
     &                        Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVR(N,I)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVR'
                  CALL SSTEVR('V','V',n,D1,D2,vl,vu,il,iu,abstol,m2,Wa2,&
     &                        Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1),      &
     &                        Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVR(V,V)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  ENDDO
                  SRNamt = 'SSTEVR'
                  CALL SSTEVR('N','V',n,D3,D4,vl,vu,il,iu,abstol,m3,Wa3,&
     &                        Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1),      &
     &                        Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSTEVR(N,V)' , iinfo ,   &
     &                      n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEV(V,'//uplo//')' ,   &
...
!
                  CALL SSYT21(1,uplo,n,0,V,Ldu,D1,D2,A,Ldu,Z,Ldu,Tau,   &
     &                        Work,Result(ntest))
!
...
!
     ...
     &                              iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEV_2STAGE(N,'//uplo// &
     &                      ')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 45               CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
!
                  ntest = ntest + 1
!
                  IF ( n>0 ) THEN
...
!
                  SRNamt = 'SSYEVX'
                  CALL SSYEVX('V','A',uplo,n,A,Ldu,vl,vu,il,iu,abstol,m,&
     &                        Wa1,Z,Ldu,Work,Lwork,Iwork,Iwork(5*n+1),  &
     &                        iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX(V,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
!
                  CALL SSYT21(1,uplo,n,0,A,Ldu,D1,D2,Z,Ldu,V,Ldu,Tau,   &
     &                        Work,Result(ntest))
!
                  ntest = ntest + 2
                  SRNamt = 'SSYEVX_2STAGE'
                  CALL SSYEVX_2STAGE('N','A',uplo,n,A,Ldu,vl,vu,il,iu,  &
     &                               abstol,m2,Wa2,Z,Ldu,Work,Lwork,    &
     &                               Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX_2STAGE(N,A,'//    &
...
!
 50               ntest = ntest + 1
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVX'
                  CALL SSYEVX('V','I',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m2,Wa2,Z,Ldu,Work,Lwork,Iwork,Iwork(5*n+1)&
     &                        ,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX(V,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
!
                  CALL SSYT22(1,uplo,n,m2,0,A,Ldu,Wa2,D2,Z,Ldu,V,Ldu,   &
     &                        Tau,Work,Result(ntest))
!
                  ntest = ntest + 2
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVX_2STAGE'
                  CALL SSYEVX_2STAGE('N','I',uplo,n,A,Ldu,vl,vu,il,iu,  &
     &                               abstol,m3,Wa3,Z,Ldu,Work,Lwork,    &
     &                               Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX_2STAGE(N,I,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 55               ntest = ntest + 1
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVX'
                  CALL SSYEVX('V','V',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m2,Wa2,Z,Ldu,Work,Lwork,Iwork,Iwork(5*n+1)&
     &                        ,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX(V,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVX_2STAGE'
                  CALL SSYEVX_2STAGE('N','V',uplo,n,A,Ldu,vl,vu,il,iu,  &
     &                               abstol,m3,Wa3,Z,Ldu,Work,Lwork,    &
     &                               Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX_2STAGE(N,V,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 60               CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
!
...
!
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEV(V,'//uplo//')' ,   &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  CALL SSYT21(1,uplo,n,0,A,Lda,D1,D2,Z,Ldu,V,Ldu,Tau,   &
     &                        Work,Result(ntest))
!
                  IF ( iuplo==1 ) THEN
                     indx = 1
...
!
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEV(N,'//uplo//')' ,   &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSPEVX'
                  CALL SSPEVX('V','A',uplo,n,Work,vl,vu,il,iu,abstol,m, &
     &                        Wa1,Z,Ldu,V,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVX(V,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  CALL SSYT21(1,uplo,n,0,A,Ldu,Wa1,D2,Z,Ldu,V,Ldu,Tau,  &
     &                        Work,Result(ntest))
!
                  ntest = ntest + 2
!
...
!
                  SRNamt = 'SSPEVX'
                  CALL SSPEVX('N','A',uplo,n,Work,vl,vu,il,iu,abstol,m2,&
     &                        Wa2,Z,Ldu,V,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVX(N,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSPEVX'
                  CALL SSPEVX('V','I',uplo,n,Work,vl,vu,il,iu,abstol,m2,&
     &                        Wa2,Z,Ldu,V,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVX(V,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSPEVX'
                  CALL SSPEVX('N','I',uplo,n,Work,vl,vu,il,iu,abstol,m3,&
     &                        Wa3,Z,Ldu,V,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVX(N,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSPEVX'
                  CALL SSPEVX('V','V',uplo,n,Work,vl,vu,il,iu,abstol,m2,&
     &                        Wa2,Z,Ldu,V,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVX(V,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSPEVX'
                  CALL SSPEVX('N','V',uplo,n,Work,vl,vu,il,iu,abstol,m3,&
     &                        Wa3,Z,Ldu,V,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVX(N,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEV(V,'//uplo//')' ,   &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 2
                  SRNamt = 'SSBEV_2STAGE'
                  CALL SSBEV_2STAGE('N',uplo,n,kd,V,Ldu,D3,Z,Ldu,Work,  &
     &                              Lwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEV_2STAGE(N,'//uplo// &
     &                      ')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 1
                  SRNamt = 'SSBEVX'
                  CALL SSBEVX('V','A',uplo,n,kd,V,Ldu,U,Ldu,vl,vu,il,iu,&
     &                        abstol,m,Wa2,Z,Ldu,Work,Iwork,Iwork(5*n+1)&
     &                        ,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX(V,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  CALL SSYT21(1,uplo,n,0,A,Ldu,Wa2,D2,Z,Ldu,V,Ldu,Tau,  &
     &                        Work,Result(ntest))
!
                  ntest = ntest + 2
!
...
!
                  ...
                  CALL SSBEVX_2STAGE('N','A',uplo,n,kd,V,Ldu,U,Ldu,vl,  &
     &                               vu,il,iu,abstol,m3,Wa3,Z,Ldu,Work, &
     &                               Lwork,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX_2STAGE(N,A,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSBEVX'
                  CALL SSBEVX('V','I',uplo,n,kd,V,Ldu,U,Ldu,vl,vu,il,iu,&
     &                        abstol,m2,Wa2,Z,Ldu,Work,Iwork,           &
     &                        Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX(V,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSBEVX_2STAGE'
                  CALL SSBEVX_2STAGE('N','I',uplo,n,kd,V,Ldu,U,Ldu,vl,  &
     &                               vu,il,iu,abstol,m3,Wa3,Z,Ldu,Work, &
     &                               Lwork,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX_2STAGE(N,I,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSBEVX'
                  CALL SSBEVX('V','V',uplo,n,kd,V,Ldu,U,Ldu,vl,vu,il,iu,&
     &                        abstol,m2,Wa2,Z,Ldu,Work,Iwork,           &
     &                        Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX(V,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSBEVX_2STAGE'
                  CALL SSBEVX_2STAGE('N','V',uplo,n,kd,V,Ldu,U,Ldu,vl,  &
     &                               vu,il,iu,abstol,m3,Wa3,Z,Ldu,Work, &
     &                               Lwork,Iwork,Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX_2STAGE(N,V,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!              7)      Call SSYEVD
!
 100              CALL SLACPY(' ',n,n,A,Lda,V,Ldu)
!
                  ntest = ntest + 1
                  SRNamt = 'SSYEVD'
                  CALL SSYEVD('V',uplo,n,A,Ldu,D1,Work,lwedc,Iwork,     &
     &                        liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVD(V,'//uplo//')' ,  &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SSYEVD_2STAGE('N',uplo,n,A,Ldu,D3,Work,Lwork,    &
     &                               Iwork,liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVD_2STAGE(N,'//uplo//&
     &                      ')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!              8)      Call SSPEVD.
!
 105              CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
!
!              Load array WORK with the upper or lower triangular
!              part of the matrix in packed form.
!
...
!
                  ntest = ntest + 1
                  SRNamt = 'SSPEVD'
                  CALL SSPEVD('V',uplo,n,Work,D1,Z,Ldu,Work(indx),      &
     &                        lwedc-indx+1,Iwork,liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVD(V,'//uplo//')' ,  &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 2
                  SRNamt = 'SSPEVD'
                  CALL SSPEVD('N',uplo,n,Work,D3,Z,Ldu,Work(indx),      &
     &                        lwedc-indx+1,Iwork,liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSPEVD(N,'//uplo//')' ,  &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 1
                  SRNamt = 'SSBEVD'
                  CALL SSBEVD('V',uplo,n,kd,V,Ldu,D1,Z,Ldu,Work,lwedc,  &
     &                        Iwork,liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVD(V,'//uplo//')' ,  &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SSBEVD_2STAGE('N',uplo,n,kd,V,Ldu,D3,Z,Ldu,Work, &
     &                               Lwork,Iwork,liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVD_2STAGE(N,'//uplo//&
     &                      ')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
!
 115              CALL SLACPY(' ',n,n,A,Lda,V,Ldu)
                  ntest = ntest + 1
                  SRNamt = 'SSYEVR'
                  CALL SSYEVR('V','A',uplo,n,A,Ldu,vl,vu,il,iu,abstol,m,&
     &                        Wa1,Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1),  &
     &                        Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR(V,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SSYEVR_2STAGE('N','A',uplo,n,A,Ldu,vl,vu,il,iu,  &
     &                               abstol,m2,Wa2,Z,Ldu,Iwork,Work,    &
     &                               Lwork,Iwork(2*n+1),Liwork-2*n,     &
     &                               iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR_2STAGE(N,A,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 120              ntest = ntest + 1
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVR'
                  CALL SSYEVR('V','I',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m2,Wa2,Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1)&
     &                        ,Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR(V,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVR_2STAGE'
                  CALL SSYEVR_2STAGE('N','I',uplo,n,A,Ldu,vl,vu,il,iu,  &
     &                               abstol,m3,Wa3,Z,Ldu,Iwork,Work,    &
     &                               Lwork,Iwork(2*n+1),Liwork-2*n,     &
     &                               iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR_2STAGE(N,I,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
 125              ntest = ntest + 1
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVR'
                  CALL SSYEVR('V','V',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m2,Wa2,Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1)&
     &                        ,Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR(V,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVR_2STAGE'
                  CALL SSYEVR_2STAGE('N','V',uplo,n,A,Ldu,vl,vu,il,iu,  &
     &                               abstol,m3,Wa3,Z,Ldu,Iwork,Work,    &
     &                               Lwork,Iwork(2*n+1),Liwork-2*n,     &
     &                               iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR_2STAGE(N,V,'//    &
     &                      uplo//')' , iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
               ntestt = ntestt + ntest
!
               CALL SLAFTS('SST',n,n,jtype,ntest,Result,ioldsd,Thresh,  &
     &                     Nounit,nerrs)
            ENDIF
!
         ENDDO
...
!
99001 FORMAT (' SDRVST2STG: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,   &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of SDRVST2STG
!
      END SUBROUTINE SDRVST2STG
