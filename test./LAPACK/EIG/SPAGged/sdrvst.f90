!*==sdrvst.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b SDRVST
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVST(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,A,  &
...
!
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEV(N,'//uplo//')' ,   &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 2
                  SRNamt = 'SSYEVX'
                  CALL SSYEVX('N','A',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m2,Wa2,Z,Ldu,Work,Lwork,Iwork,Iwork(5*n+1)&
     &                        ,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX(N,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVX'
                  CALL SSYEVX('N','I',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m3,Wa3,Z,Ldu,Work,Lwork,Iwork,Iwork(5*n+1)&
     &                        ,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX(N,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVX'
                  CALL SSYEVX('N','V',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m3,Wa3,Z,Ldu,Work,Lwork,Iwork,Iwork(5*n+1)&
     &                        ,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVX(N,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEV(N,'//uplo//')' ,   &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSBEVX'
                  CALL SSBEVX('N','A',uplo,n,kd,V,Ldu,U,Ldu,vl,vu,il,iu,&
     &                        abstol,m3,Wa3,Z,Ldu,Work,Iwork,           &
     &                        Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX(N,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSBEVX'
                  CALL SSBEVX('N','I',uplo,n,kd,V,Ldu,U,Ldu,vl,vu,il,iu,&
     &                        abstol,m3,Wa3,Z,Ldu,Work,Iwork,           &
     &                        Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX(N,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  SRNamt = 'SSBEVX'
                  CALL SSBEVX('N','V',uplo,n,kd,V,Ldu,U,Ldu,vl,vu,il,iu,&
     &                        abstol,m3,Wa3,Z,Ldu,Work,Iwork,           &
     &                        Iwork(5*n+1),iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVX(N,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 2
                  SRNamt = 'SSYEVD'
                  CALL SSYEVD('N',uplo,n,A,Ldu,D3,Work,lwedc,Iwork,     &
     &                        liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVD(N,'//uplo//')' ,  &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 2
                  SRNamt = 'SSBEVD'
                  CALL SSBEVD('N',uplo,n,kd,V,Ldu,D3,Z,Ldu,Work,lwedc,  &
     &                        Iwork,liwedc,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSBEVD(N,'//uplo//')' ,  &
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ntest = ntest + 2
                  SRNamt = 'SSYEVR'
                  CALL SSYEVR('N','A',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m2,Wa2,Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1)&
     &                        ,Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR(N,A,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVR'
                  CALL SSYEVR('N','I',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m3,Wa3,Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1)&
     &                        ,Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR(N,I,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
                  ...
                  CALL SLACPY(' ',n,n,V,Ldu,A,Lda)
                  SRNamt = 'SSYEVR'
                  CALL SSYEVR('N','V',uplo,n,A,Ldu,vl,vu,il,iu,abstol,  &
     &                        m3,Wa3,Z,Ldu,Iwork,Work,Lwork,Iwork(2*n+1)&
     &                        ,Liwork-2*n,iinfo)
                  IF ( iinfo/=0 ) THEN
                     WRITE (Nounit,FMT=99001) 'SSYEVR(N,V,'//uplo//')' ,&
     &                      iinfo , n , jtype , ioldsd
                     Info = ABS(iinfo)
                     IF ( iinfo<0 ) THEN
                        RETURN
...
!
99001 FORMAT (' SDRVST: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of SDRVST
!
      END SUBROUTINE SDRVST
