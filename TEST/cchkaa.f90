!*==cchkaa.f90  processed by SPAG 7.51RB at 17:34 on  4 Mar 2022
!> \brief \b CCHKAA
!
!  =========== DOCUMENTATION ===========
!
...
!     .. External Subroutines ..
     ...
     EXTERNAL         CCHKHE_ROOK , CCHKHE_RK , CCHKHE_AA , CCHKHP , CCHKLQ 
     EXTERNAL         CCHKUNHR_COL , CCHKPB , CCHKPO , CCHKPS , CCHKPP 
     EXTERNAL         CCHKPT , CCHKQ3 , CCHKQL , CCHKQR , CCHKRQ , CCHKSP 
     EXTERNAL         CCHKSY , CCHKSY_ROOK , CCHKSY_RK , CCHKSY_AA , CCHKTB 
     EXTERNAL         CCHKTP , CCHKTR , CCHKTZ , CDRVGB , CDRVGE , CDRVGT 
     EXTERNAL         CDRVHE , CDRVHE_ROOK , CDRVHE_RK , CDRVHE_AA , CDRVHP 
     EXTERNAL         CDRVLS , CDRVPB , CDRVPO , CDRVPP , CDRVPT , CDRVSP 
     EXTERNAL         CDRVSY , CDRVSY_ROOK , CDRVSY_RK , CDRVSY_AA , ILAVER 
     EXTERNAL         CCHKQRT , CCHKQRTP
!     ..
!     .. Scalars in Common ..
      LOGICAL LERr , OK
      CHARACTER*32 SRNamt
