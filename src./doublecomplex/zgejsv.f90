!*==zgejsv.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZGEJSV
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL(R8KIND) :: aapp , aaqq , aatmax , aatmin , big , big1 ,      &
     &                condr1 , condr2 , cond_ok , entra , entrat ,      &
     &                epsln , maxprj , scalem , sconda , sfmin , small ,&
     &                temp1 , uscal1 , uscal2 , xsc
     ...
     &           lwlqf , lwqp3 , lwqrf , lwrk_zgelqf , lwrk_zgeqp3 ,    &
     &           lwrk_zgeqp3n , lwrk_zgeqrf , lwrk_zgesvj ,             &
     &           lwrk_zgesvju , lwrk_zgesvjv , lwrk_zunmlq ,            &
     &           lwrk_zunmqr , lwrk_zunmqrm , lwsvdj , lwsvdjv ,        &
