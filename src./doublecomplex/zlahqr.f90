!*==zlahqr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      REAL(R8KIND) :: aa , ab , ba , bb , h10 , h21 , rtemp , s ,       &
     &                safmax , safmin , smlnum , sx , t2 , tst , ulp
      REAL(R8KIND) :: CABS1
      COMPLEX(CX16KIND) :: cdum , h11 , h11s , h22 , sc , sum , t , t1 ,&
     &                     temp , u , v2 , x , y
      INTEGER :: i , i1 , i2 , itmax , its , j , jhi , jlo , k , kdefl ,&
     &           l , m , nh , nz
      COMPLEX(CX16KIND) , DIMENSION(2) :: v
!
