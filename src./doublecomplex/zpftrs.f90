!*==zpftrs.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZPFTRS
!
!  =========== DOCUMENTATION ===========
!
...
!
      IF ( lower ) THEN
         CALL ZTFSM(Transr,'L',Uplo,'N','N',N,Nrhs,CONE,A,B,Ldb)
         CALL ZTFSM(Transr,'L',Uplo,'C','N',N,Nrhs,CONE,A,B,Ldb)
      ELSE
         CALL ZTFSM(Transr,'L',Uplo,'C','N',N,Nrhs,CONE,A,B,Ldb)
         CALL ZTFSM(Transr,'L',Uplo,'N','N',N,Nrhs,CONE,A,B,Ldb)
      ENDIF
