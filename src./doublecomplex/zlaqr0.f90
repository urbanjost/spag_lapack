!*==zlaqr0.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      COMPLEX(CX16KIND) :: aa , bb , cc , cdum , dd , det , rtdisc ,    &
     &                     swap , tr2
      REAL(R8KIND) :: CABS1
     ...
     &           nsmax , nsr , nve , nw , nwmax , nwr , nwupbd
      ...
      REAL(R8KIND) :: s
      LOGICAL :: sorted
      COMPLEX(CX16KIND) , DIMENSION(1,1) :: zdum
!
...
!
         CALL ZLAQR3(Wantt,Wantz,N,Ilo,Ihi,nwr+1,H,Ldh,Iloz,Ihiz,Z,Ldz, &
...
!           ==== Aggressive early deflation ====
!
            CALL ZLAQR3(Wantt,Wantz,N,ktop,kbot,nw,H,Ldh,Iloz,Ihiz,Z,   &
...
!
                  IF ( kbot-ks+1<=ns/2 ) THEN
                     ...
                     IF ( ns>nmin ) THEN
                        CALL ZLAQR4(.FALSE.,.FALSE.,ns,1,ns,H(kt,1),Ldh,&
