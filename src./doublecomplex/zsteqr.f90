!*==zsteqr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZSTEQR
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL(R8KIND) :: anorm , b , c , eps , eps2 , f , g , p , r , rt1 ,&
     &                rt2 , s , safmax , safmin , ssfmax , ssfmin , tst
      INTEGER :: i , icompz , ii , iscale , j , jtot , k , l , l1 ,     &
     &           lend , lendm1 , lendp1 , lendsv , lm1 , lsv , m , mm , &
     &           mm1 , nm1 , nmaxit
!
...
!     matrix.
!
      IF ( icompz==2 ) CALL ZLASET('Full',N,N,CZERO,CONE,Z,Ldz)
!
      nmaxit = N*MAXIT
      jtot = 0
!
...
!
 80            IF ( iscale==1 ) THEN
                  CALL DLASCL('G',0,0,ssfmax,anorm,lendsv-lsv+1,1,D(lsv)&
     &                        ,N,Info)
                  CALL DLASCL('G',0,0,ssfmax,anorm,lendsv-lsv,1,E(lsv), &
     &                        N,Info)
               ELSEIF ( iscale==2 ) THEN
                  CALL DLASCL('G',0,0,ssfmin,anorm,lendsv-lsv+1,1,D(lsv)&
     &                        ,N,Info)
