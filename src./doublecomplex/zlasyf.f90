!*==zlasyf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      ...
      REAL(R8KIND) :: CABS1
      COMPLEX(CX16KIND) :: d11 , d21 , d22 , r1 , t , z
...
!
     ...
     &                          ,1)
                     IF ( k<N ) CALL ZGEMV('No transpose',k,N-k,-CONE,  &
