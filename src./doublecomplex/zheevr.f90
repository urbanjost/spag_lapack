!*==zheevr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &           liwmin , llrwork , llwork , llwrkn , lrwmin , lwkopt , &
     &           lwmin , nb , nsplit
      CHARACTER :: order
!
...
!
      CALL ZHETRD(Uplo,N,A,Lda,Rwork(indrd),Rwork(indre),Work(indtau),  &
