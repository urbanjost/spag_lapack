!*==zgetri.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZGETRI
!
!  =========== DOCUMENTATION ===========
!
...
!
            IF ( j<N ) CALL ZGEMV('No transpose',N,N-j,-ONE,A(1,j+1),   &
...
!
            IF ( j+jb<=N ) CALL ZGEMM('No transpose','No transpose',N,  &
     &                                jb,N-j-jb+1,-ONE,A(1,j+jb),Lda,   &
     &                                Work(j+jb),ldwork,ONE,A(1,j),Lda)
            CALL ZTRSM('Right','Lower','No transpose','Unit',N,jb,ONE,  &
