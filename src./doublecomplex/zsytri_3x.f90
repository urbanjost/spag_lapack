!*==zsytri_3x.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZSYTRI_3X
!
!  =========== DOCUMENTATION ===========
!
...
!           U11**T * invD1 * U11 -> U11
!
            CALL ZTRMM('L','U','T','U',nnb,nnb,CONE,A(cut+1,cut+1),Lda, &
     &                 Work(u11+1,1),N+Nb+1)
!
            DO i = 1 , nnb
               DO j = i , nnb
...
!
            CALL ZGEMM('T','N',nnb,nnb,cut,CONE,A(1,cut+1),Lda,Work,    &
...
!           L11**T * invD1 * L11 -> L11
!
            CALL ZTRMM('L',Uplo,'T','U',nnb,nnb,CONE,A(cut+1,cut+1),Lda,&
     &                 Work(u11+1,1),N+Nb+1)
