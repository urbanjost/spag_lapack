!*==zlaunhr_col_getrfnp2.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!        B22 := B22 - B21*B12
!
         CALL ZGEMM('N','N',M-n1,n2,n1,-CONE,A(n1+1,1),Lda,A(1,n1+1),   &
     &              Lda,CONE,A(n1+1,n1+1),Lda)
!
!        Factor B22, recursive call
!
         CALL ZLAUNHR_COL_GETRFNP2(M-n1,n2,A(n1+1,n1+1),Lda,D(n1+1),    &
     &                             iinfo)
!
      ENDIF
!
