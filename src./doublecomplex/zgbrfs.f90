!*==zgbrfs.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZGBRFS
!
!  =========== DOCUMENTATION ===========
!
...
!
            ...
            CALL ZGBMV(Trans,N,N,Kl,Ku,-CONE,Ab,Ldab,X(1,j),1,CONE,Work,&
     &                 1)
!
...
!
                  CALL ZGBTRS(transt,N,Kl,Ku,1,Afb,Ldafb,Ipiv,Work,N,   &
     &                        Info)
                  DO i = 1 , N
...
!
                  DO i = 1 , N
                     Work(i) = Rwork(i)*Work(i)
                  ENDDO
                  CALL ZGBTRS(transn,N,Kl,Ku,1,Afb,Ldafb,Ipiv,Work,N,   &
     &                        Info)
               ENDIF
               CYCLE
            ENDIF
