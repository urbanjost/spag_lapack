!*==zlaswlq.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZLASWLQ
!
!  Definition:
!  ===========
...
!
         CALL ZTPLQT(M,Nb-M,0,Mb,A(1,1),Lda,A(1,i),Lda,T(1,ctr*M+1),Ldt,&
     &               Work,Info)
         ctr = ctr + 1
      ENDDO
!
...
!
      IF ( ii<=N ) CALL ZTPLQT(M,kk,0,Mb,A(1,1),Lda,A(1,ii),Lda,        &
