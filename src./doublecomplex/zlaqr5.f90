!*==zlaqr5.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      LOGICAL :: accum , bmp22
      COMPLEX(CX16KIND) :: alpha , beta , cdum , refsum
      REAL(R8KIND) :: CABS1
      REAL(R8KIND) :: h11 , h12 , h21 , h22 , safmax , safmin , scl ,   &
     &                smlnum , tst1 , tst2 , ulp
      INTEGER :: i2 , i4 , incol , j , jbot , jcol , jlen , jrow ,      &
     &           jtop , k , k1 , kdu , kms , krcol , m , m22 , mbot ,   &
     &           mtop , nbmps , ndcol , ns , nu
      COMPLEX(CX16KIND) , DIMENSION(3) :: vt
!
