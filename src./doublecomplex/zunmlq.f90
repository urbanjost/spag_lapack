!*==zunmlq.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZUNMLQ
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL ZLARFT('Forward','Rowwise',nq-i+1,ib,A(i,i),Lda,Tau(i),&
     &                  Work(iwt),LDT)
            IF ( left ) THEN
!
...
!           Apply H or H**H
!
            CALL ZLARFB(Side,transt,'Forward','Rowwise',mi,ni,ib,A(i,i),&
