!*==ztgevc.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZTGEVC
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL(R8KIND) :: ABS1
      REAL(R8KIND) :: acoefa , acoeff , anorm , ascale , bcoefa , big , &
     &                bignum , bnorm , bscale , dmin , safmin , sbeta , &
     &                scale , small , temp , ulp , xmax
      COMPLEX(CX16KIND) :: bcoeff , ca , cb , d , salpha , sum , suma , &
     &                     sumb , x
