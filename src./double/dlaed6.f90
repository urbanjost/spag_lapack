!*==dlaed6.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      REAL(R8KIND) :: a , b , base , c , ddf , df , eps , erretm , eta ,&
     &                f , fc , lbd , sclfac , sclinv , small1 , small2 ,&
     &                sminv1 , sminv2 , temp , temp1 , temp2 , temp3 ,  &
     &                temp4 , ubd
      REAL(R8KIND) , DIMENSION(3) :: dscale , zscale
