!*==dormlq.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DORMLQ
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL DLARFT('Forward','Rowwise',nq-i+1,ib,A(i,i),Lda,Tau(i),&
     &                  Work(iwt),LDT)
            IF ( left ) THEN
!
...
!           Apply H or H**T
!
            CALL DLARFB(Side,transt,'Forward','Rowwise',mi,ni,ib,A(i,i),&
