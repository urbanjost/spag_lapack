!*==dsyevr_2stage.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &           wantz
      INTEGER :: i , ib , ieeeok , iinfo , imax , indd , inddd , inde , &
     &           indee , indhous , indibl , indifl , indisp , indiwo ,  &
     &           indtau , indwk , indwkn , iscale , j , jj , kd ,       &
     &           lhtrd , liwmin , llwork , llwrkn , lwmin , lwtrd ,     &
     &           nsplit
      CHARACTER :: order
!
...
!
!
      CALL DSYTRD_2STAGE(Jobz,Uplo,N,A,Lda,Work(indd),Work(inde),       &
