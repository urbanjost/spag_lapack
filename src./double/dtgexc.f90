!*==dtgexc.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DTGEXC
!
!  =========== DOCUMENTATION ===========
!
...
!
               ...
               ENDIF
               CALL DTGEX2(Wantq,Wantz,N,A,Lda,B,Ldb,Q,Ldq,Z,Ldz,here,  &
...
!
               ...
               ENDIF
               CALL DTGEX2(Wantq,Wantz,N,A,Lda,B,Ldb,Q,Ldq,Z,Ldz,here+1,&
...
!
                  CALL DTGEX2(Wantq,Wantz,N,A,Lda,B,Ldb,Q,Ldq,Z,Ldz,    &
