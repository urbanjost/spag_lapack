!*==dlasda.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      ...
      INTEGER :: i , i1 , ic , idxq , idxqi , im1 , inode , itemp ,     &
     &           iwk , j , lf , ll , lvl , lvl2 , m , ncc , nd , ndb1 , &
     &           ndiml , ndimr , nl , nlf , nlp1 , nlvl , nr , nrf ,    &
     &           nrp1 , nru , nwork1 , nwork2 , smlszp , sqrei , vf ,   &
     &           vfi , vl , vli
!
...
!
      IF ( N<=Smlsiz ) THEN
         IF ( Icompq==0 ) THEN
            CALL DLASDQ('U',Sqre,N,0,0,0,D,E,Vt,Ldu,U,Ldu,U,Ldu,Work,   &
     &                  Info)
         ELSE
            CALL DLASDQ('U',Sqre,N,m,N,0,D,E,Vt,Ldu,U,Ldu,U,Ldu,Work,   &
     &                  Info)
         ENDIF
         RETURN
      ENDIF
...
!
     ...
     &                  ,nl,Work(nwork2),Info)
         ...
         ELSE
            ...
            CALL DLASDQ('U',sqrei,nl,nlp1,nl,ncc,D(nlf),E(nlf),Vt(nlf,1)&
     ...
     &                  ,nr,Work(nwork2),Info)
         ...
         ELSE
            ...
            CALL DLASDQ('U',sqrei,nr,nrp1,nr,ncc,D(nrf),E(nrf),Vt(nrf,1)&
...
!
         ...
         DO i = lf , ll
            ...
            beta = E(ic)
            IF ( Icompq==0 ) THEN
               CALL DLASD6(Icompq,nl,nr,sqrei,D(nlf),Work(vfi),Work(vli)&
