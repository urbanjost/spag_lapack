!*==dggsvd3.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      REAL(R8KIND) :: anorm , bnorm , smax , temp , tola , tolb , ulp , &
     &                unfl
      INTEGER :: i , ibnd , isub , j , lwkopt , ncycle
      LOGICAL :: lquery , wantq , wantu , wantv
!
...
!
      IF ( Info==0 ) THEN
         CALL DGGSVP3(Jobu,Jobv,Jobq,M,P,N,A,Lda,B,Ldb,tola,tolb,K,L,U, &
     &                Ldu,V,Ldv,Q,Ldq,Iwork,Work,Work,-1,Info)
         lwkopt = N + INT(Work(1))
...
!     Preprocessing
!
      CALL DGGSVP3(Jobu,Jobv,Jobq,M,P,N,A,Lda,B,Ldb,tola,tolb,K,L,U,Ldu,&
