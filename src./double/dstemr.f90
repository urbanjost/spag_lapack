!*==dstemr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DSTEMR
!
!  =========== DOCUMENTATION ===========
!
...
!
      ...
      REAL(R8KIND) :: bignum , cs , eps , pivmin , r1 , r2 , rmax ,     &
...
!           eigenvalues
!
            CALL DLARRV(N,wl,wu,D,E,pivmin,Iwork(iinspl),M,1,M,MINRGP,  &
