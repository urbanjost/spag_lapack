!*==dlatdf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      REAL(R8KIND) :: bm , bp , pmone , sminu , splus , temp
      INTEGER :: i , info , j , k
      INTEGER , DIMENSION(MAXDIM) :: iwork
      REAL(R8KIND) , DIMENSION(4*MAXDIM) :: work
      REAL(R8KIND) , DIMENSION(MAXDIM) :: xm , xp
!
