!*==dpotrf2.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DPOTRF2
!
!  =========== DOCUMENTATION ===========
!
...
!
         IF ( A(1,1)<=ZERO .OR. DISNAN(A(1,1)) ) THEN
            Info = 1
            RETURN
         ENDIF
!
...
!
            CALL DTRSM('L','U','T','N',n1,n2,ONE,A(1,1),Lda,A(1,n1+1),  &
     &                 Lda)
!
...
!
            CALL DTRSM('R','L','T','N',n2,n1,ONE,A(1,1),Lda,A(n1+1,1),  &
     &                 Lda)
!
!           Update and factor A22
!
