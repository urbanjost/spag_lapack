!*==dormrq.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DORMRQ
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL DLARFT('Backward','Rowwise',nq-K+i+ib-1,ib,A(i,1),Lda, &
     &                  Tau(i),Work(iwt),LDT)
            IF ( left ) THEN
!
...
!           Apply H or H**T
!
            CALL DLARFB(Side,transt,'Backward','Rowwise',mi,ni,ib,A(i,1)&
