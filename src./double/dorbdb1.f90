!*==dorbdb1.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DORBDB1
!
!  =========== DOCUMENTATION ===========
!
...
!
     ...
     &                 X21(i+1,i+1),Ldx21,Work(ilarf))
            c = SQRT(DNRM2(P-i,X11(i+1,i+1),1)                          &
     &          **2+DNRM2(M-P-i,X21(i+1,i+1),1)**2)
            Phi(i) = ATAN2(s,c)
            CALL DORBDB5(P-i,M-P-i,Q-i-1,X11(i+1,i+1),1,X21(i+1,i+1),1, &
