!*==dormql.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DORMQL
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL DLARFT('Backward','Columnwise',nq-K+i+ib-1,ib,A(1,i),  &
...
!           Apply H or H**T
!
            CALL DLARFB(Side,Trans,'Backward','Columnwise',mi,ni,ib,    &
