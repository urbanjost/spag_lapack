!*==dtgevc.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DTGEVC
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL(R8KIND) :: acoef , acoefa , anorm , ascale , bcoefa ,        &
     &                bcoefi , bcoefr , big , bignum , bnorm , bscale , &
     &                cim2a , cim2b , cimaga , cimagb , cre2a , cre2b , &
     &                creala , crealb , dmin , safmin , salfar , sbeta ,&
     &                scale , small , temp , temp2 , temp2i , temp2r ,  &
     &                ulp , xmax , xscale
      REAL(R8KIND) , DIMENSION(2) :: bdiag
     ...
     &           j , ja , jc , je , jr , jw , na , nw
      REAL(R8KIND) , DIMENSION(2,2) :: sum , sump , sums
!
...
!              Complex eigenvalue
!
                  CALL DLAG2(S(je,je),Lds,P(je,je),Ldp,safmin*SAFETY,   &
...
!
                  CALL DLALN2(.FALSE.,na,nw,dmin,acoef,S(j,j),Lds,      &
