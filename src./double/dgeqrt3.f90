!*==dgeqrt3.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
         DO j = 1 , n2
            ...
            ENDDO
         ENDDO
         CALL DTRMM('L','L','T','U',n1,n2,ONE,A,Lda,T(1,j1),Ldt)
!
         CALL DGEMM('T','N',n1,n2,M-n1,ONE,A(j1,1),Lda,A(j1,j1),Lda,ONE,&
     &              T(1,j1),Ldt)
!
         CALL DTRMM('L','U','T','N',n1,n2,ONE,T,Ldt,T(1,j1),Ldt)
!
         CALL DGEMM('N','N',M-n1,n2,n1,-ONE,A(j1,1),Lda,T(1,j1),Ldt,ONE,&
     &              A(j1,j1),Lda)
!
         CALL DTRMM('L','L','N','U',n1,n2,ONE,A,Lda,T(1,j1),Ldt)
!
         DO j = 1 , n2
            DO i = 1 , n1
...
!
         CALL DGEQRT3(M-n1,n2,A(j1,j1),Lda,T(j1,j1),Ldt,iinfo)
!
...
!
         ...
         ENDDO
!
         CALL DTRMM('R','L','N','U',n1,n2,ONE,A(j1,j1),Lda,T(1,j1),Ldt)
!
         CALL DGEMM('T','N',n1,n2,M-N,ONE,A(i1,1),Lda,A(i1,j1),Lda,ONE, &
     &              T(1,j1),Ldt)
!
         CALL DTRMM('L','U','N','N',n1,n2,-ONE,T,Ldt,T(1,j1),Ldt)
!
         CALL DTRMM('R','U','N','N',n1,n2,ONE,T(j1,j1),Ldt,T(1,j1),Ldt)
!
