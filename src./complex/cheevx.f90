!*==cheevx.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &           itmp1 , j , jj , llwork , lwkmin , lwkopt , nb , nsplit
      CHARACTER :: order
!
...
!
      ...
      CALL CHETRD(Uplo,N,A,Lda,Rwork(indd),Rwork(inde),Work(indtau),    &
