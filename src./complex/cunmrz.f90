!*==cunmrz.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CUNMRZ
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CLARZT('Backward','Rowwise',L,ib,A(i,ja),Lda,Tau(i),   &
     &                  Work(iwt),LDT)
!
            IF ( left ) THEN
!
...
!           Apply H or H**H
!
            CALL CLARZB(Side,transt,'Backward','Rowwise',mi,ni,ib,L,    &
