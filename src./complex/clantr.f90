!*==clantr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
         ...
         IF ( LSAME(Uplo,'U') ) THEN
            IF ( LSAME(Diag,'U') ) THEN
               ...
               DO j = 2 , N
                  colssq(1) = ZERO
                  colssq(2) = ONE
                  CALL CLASSQ(MIN(M,j-1),A(1,j),1,colssq(1),colssq(2))
            ...
            ELSE
               ...
               DO j = 1 , N
                  colssq(1) = ZERO
                  colssq(2) = ONE
                  CALL CLASSQ(MIN(M,j),A(1,j),1,colssq(1),colssq(2))
                  CALL SCOMBSSQ(ssq,colssq)
               ENDDO
            ENDIF
         ELSEIF ( LSAME(Diag,'U') ) THEN
            ...
            DO j = 1 , N
               colssq(1) = ZERO
               colssq(2) = ONE
               CALL CLASSQ(M-j,A(MIN(M,j+1),j),1,colssq(1),colssq(2))
               CALL SCOMBSSQ(ssq,colssq)
            ENDDO
         ELSE
            ssq(1) = ZERO
            ...
            DO j = 1 , N
               colssq(1) = ZERO
               colssq(2) = ONE
               CALL CLASSQ(M-j+1,A(j,j),1,colssq(1),colssq(2))
               CALL SCOMBSSQ(ssq,colssq)
            ENDDO
         ENDIF
