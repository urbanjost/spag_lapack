!*==csytrs_aa.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CSYTRS_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CTRSM('L','U','T','U',N-1,Nrhs,ONE,A(1,2),Lda,B(2,1),  &
     &                 Ldb)
         ENDIF
!
...
!
            CALL CTRSM('L','L','T','U',N-1,Nrhs,ONE,A(2,1),Lda,B(2,1),  &
     &                 Ldb)
!
