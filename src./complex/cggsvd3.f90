!*==cggsvd3.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      IF ( Info==0 ) THEN
         CALL CGGSVP3(Jobu,Jobv,Jobq,M,P,N,A,Lda,B,Ldb,tola,tolb,K,L,U, &
...
!
      CALL CGGSVP3(Jobu,Jobv,Jobq,M,P,N,A,Lda,B,Ldb,tola,tolb,K,L,U,Ldu,&
