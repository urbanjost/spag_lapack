!*==cgemlqt.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CGEMLQT
!
!  Definition:
!  ===========
...
!
         DO i = 1 , K , Mb
            ib = MIN(Mb,K-i+1)
            CALL CLARFB('L','C','F','R',M-i+1,N,ib,V(i,i),Ldv,T(1,i),   &
...
!
         DO i = 1 , K , Mb
            ib = MIN(Mb,K-i+1)
            CALL CLARFB('R','N','F','R',M,N-i+1,ib,V(i,i),Ldv,T(1,i),   &
...
!
         ...
         DO i = kf , 1 , -Mb
            ib = MIN(Mb,K-i+1)
            CALL CLARFB('L','N','F','R',M-i+1,N,ib,V(i,i),Ldv,T(1,i),   &
     &                  Ldt,C(i,1),Ldc,Work,ldwork)
         ENDDO
!
...
!
         ...
         DO i = kf , 1 , -Mb
            ib = MIN(Mb,K-i+1)
            CALL CLARFB('R','C','F','R',M,N-i+1,ib,V(i,i),Ldv,T(1,i),   &
     &                  Ldt,C(1,i),Ldc,Work,ldwork)
         ENDDO
!
      ENDIF
