!*==ctzrzf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CTZRZF
!
!  =========== DOCUMENTATION ===========
!
...
!
               CALL CLARZT('Backward','Rowwise',N-M,ib,A(i,m1),Lda,     &
     &                     Tau(i),Work,ldwork)
!
!              Apply H to A(1:i-1,i:n) from the right
!
               CALL CLARZB('Right','No transpose','Backward','Rowwise', &
...
!
      IF ( mu>0 ) CALL CLATRZ(mu,N,N-M,A,Lda,Tau,Work)
!
      Work(1) = lwkopt
!
!
