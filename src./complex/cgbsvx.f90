!*==cgbsvx.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &               Afb(MAX(1,Kl+Ku+2-Info),1),Ldafb,Rwork)
            IF ( rpvgrw==ZERO ) THEN
               rpvgrw = ONE
            ELSE
               rpvgrw = anorm/rpvgrw
...
!
      CALL CGBRFS(Trans,N,Kl,Ku,Nrhs,Ab,Ldab,Afb,Ldafb,Ipiv,B,Ldb,X,Ldx,&
