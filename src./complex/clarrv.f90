!*==clarrv.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &        lambda , left , lgap , mingma , nrminv , resid , rgap ,   &
     &        right , rqcorr , rqtol , savgap , sgndef , sigma ,        &
     &        spdiam , ssigma , tau , tmp , tol , ztz
      INTEGER :: done , i , ibegin , idone , iend , ii , iindc1 ,       &
     &           iindc2 , iindr , iindwk , iinfo , im , in , indeig ,   &
     &           indin1 , indin2 , indld , indlld , indwrk , isupmn ,   &
     &           isupmx , iter , itmp1 , j , jblk , k , miniwsize ,     &
     &           minwsize , nclus , ndepth , negcnt , newcls , newfst , &
     &           newftt , newlst , newsiz , offset , oldcls , oldfst ,  &
     &           oldien , oldlst , oldncl , p , parity , q , wbegin ,   &
     &           wend , windex , windmn , windpl , zfrom , zto ,        &
...
!     The width of the part of Z that is used
      ...
      CALL CLASET('Full',N,zusedw,CZERO,CZERO,Z(1,zusedl),Ldz)
...
!        corresponding eigenvectors.
            CALL SCOPY(im,W(wbegin),1,Work(wbegin),1)
...
!                 Set the corresponding entries in Z to zero
                     CALL CLASET('Full',in,2,CZERO,CZERO,Z(ibegin,j),   &
     &                           Ldz)
                  ENDIF
...
!                 eigenvalues to the precision needed.
                     CALL SLARRB(in,D(ibegin),Work(indlld+ibegin-1),p,q,&
