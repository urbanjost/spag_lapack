!*==cgelss.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &           itau , itaup , itauq , iwork , ldwork , lwork_cgebrd , &
     &           lwork_cgelqf , lwork_cgeqrf , lwork_cungbr ,           &
     &           lwork_cunmbr , lwork_cunmlq , lwork_cunmqr , maxmn ,   &
     &           maxwrk , minmn , minwrk , mm , mnthr
      COMPLEX , DIMENSION(1) :: dum
      LOGICAL :: lquery
!
