!*==chegvx.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CHEGVX
!
!  =========== DOCUMENTATION ===========
!
...
!
            ...
            ENDIF
!
            CALL CTRSM('Left',Uplo,trans,'Non-unit',N,M,CONE,B,Ldb,Z,   &
     &                 Ldz)
!
         ELSEIF ( Itype==3 ) THEN
!
...
!
            ...
            ENDIF
!
            CALL CTRMM('Left',Uplo,trans,'Non-unit',N,M,CONE,B,Ldb,Z,   &
     &                 Ldz)
         ENDIF
      ENDIF
!
