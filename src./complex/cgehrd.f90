!*==cgehrd.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CGEHRD
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CLAHR2(Ihi,i,ib,A(1,i),Lda,Tau(i),Work(iwt),LDT,Work,  &
     &                  ldwork)
!
...
!           right
!
            CALL CTRMM('Right','Lower','Conjugate transpose','Unit',i,  &
