!*==cpbtrf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CPBTRF
!
!  =========== DOCUMENTATION ===========
!
...
!
      ...
      COMPLEX , DIMENSION(LDWORK,NBMAX) :: work
!
...
!                    Update A22
!
                  CALL CHERK('Upper','Conjugate transpose',i2,ib,-ONE,  &
...
!                    Update A33
!
                  CALL CHERK('Upper','Conjugate transpose',i3,ib,-ONE,  &
...
!                    Update A33
!
                  CALL CHERK('Lower','No transpose',i3,ib,-ONE,work,    &
