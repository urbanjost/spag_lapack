!*==csytrf_rk.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
               CALL CLASYF_RK(Uplo,k,nb,kb,A,Lda,E,Ipiv,Work,ldwork,    &
     &                        iinfo)
            ELSE
!
...
!
               CALL CLASYF_RK(Uplo,N-k+1,nb,kb,A(k,k),Lda,E(k),Ipiv(k), &
     &                        Work,ldwork,iinfo)
