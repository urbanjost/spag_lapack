!*==cgehd2.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
         CALL CLARF('Right',Ihi,Ihi-i,A(i+1,i),1,Tau(i),A(1,i+1),Lda,   &
     &              Work)
!
!        Apply H(i)**H to A(i+1:ihi,i+1:n) from the left
!
         CALL CLARF('Left',Ihi-i,N-i,A(i+1,i),1,CONJG(Tau(i)),A(i+1,i+1)&
     &              ,Lda,Work)
!
         A(i+1,i) = alpha
      ENDDO
