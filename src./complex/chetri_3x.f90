!*==chetri_3x.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CHETRI_3X
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL :: ak , akp1 , t
      COMPLEX :: akkp1 , d , u01_ip1_j , u01_i_j , u11_ip1_j , u11_i_j
...
!           U11**H * invD1 * U11 -> U11
!
            CALL CTRMM('L','U','C','U',nnb,nnb,CONE,A(cut+1,cut+1),Lda, &
     &                 Work(u11+1,1),N+Nb+1)
!
            DO i = 1 , nnb
               DO j = i , nnb
...
!
            CALL CGEMM('C','N',nnb,nnb,cut,CONE,A(1,cut+1),Lda,Work,    &
...
!           L11**H * invD1 * L11 -> L11
!
            CALL CTRMM('L',Uplo,'C','U',nnb,nnb,CONE,A(cut+1,cut+1),Lda,&
     &                 Work(u11+1,1),N+Nb+1)
