!*==slaqr4.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
         CALL SLAQR2(Wantt,Wantz,N,Ilo,Ihi,nwr+1,H,Ldh,Iloz,Ihiz,Z,Ldz, &
...
!           ==== Aggressive early deflation ====
!
            CALL SLAQR2(Wantt,Wantz,N,ktop,kbot,nw,H,Ldh,Iloz,Ihiz,Z,   &
