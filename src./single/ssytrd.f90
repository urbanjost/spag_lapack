!*==ssytrd.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SSYTRD
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL SSYR2K(Uplo,'No transpose',i-1,nb,-ONE,A(1,i),Lda,Work,&
     &                  ldwork,ONE,A,Lda)
!
...
!
            CALL SSYR2K(Uplo,'No transpose',N-i-nb+1,nb,-ONE,A(i+nb,i), &
