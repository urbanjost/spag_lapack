!*==sgbtrf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SGBTRF
!
!  =========== DOCUMENTATION ===========
!
...
!
     ...
     &           jp , ju , k2 , km , kv , nb , nw
      REAL :: temp
      REAL , DIMENSION(LDWORK,NBMAX) :: work13 , work31
!
...
!                 Update A12
!
                  CALL STRSM('Left','Lower','No transpose','Unit',jb,j2,&
...
!                    Update A22
!
                  IF ( i2>0 ) CALL SGEMM('No transpose','No transpose', &
...
!                    Update A32
!
                  IF ( i3>0 ) CALL SGEMM('No transpose','No transpose', &
...
!
                  CALL STRSM('Left','Lower','No transpose','Unit',jb,j3,&
...
!
               nw = MIN(i3,jj-j+1)
               IF ( nw>0 ) CALL SCOPY(nw,work31(1,jj-j+1),1,Ab(kv+Kl+1- &
     &                                jj+j,jj),1)
            ENDDO
         ENDDO
      ENDIF
