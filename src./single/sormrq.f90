!*==sormrq.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SORMRQ
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL SLARFT('Backward','Rowwise',nq-K+i+ib-1,ib,A(i,1),Lda, &
     &                  Tau(i),Work(iwt),LDT)
            IF ( left ) THEN
!
...
!           Apply H or H**T
!
            CALL SLARFB(Side,transt,'Backward','Rowwise',mi,ni,ib,A(i,1)&
