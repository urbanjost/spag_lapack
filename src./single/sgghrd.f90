!*==sgghrd.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SGGHRD
!
!  =========== DOCUMENTATION ===========
!
...
!
            ...
            A(jrow,jcol) = ZERO
            CALL SROT(N-jcol,A(jrow-1,jcol+1),Lda,A(jrow,jcol+1),Lda,c, &
     &                s)
            CALL SROT(N+2-jrow,B(jrow-1,jrow-1),Ldb,B(jrow,jrow-1),Ldb, &
     &                c,s)
