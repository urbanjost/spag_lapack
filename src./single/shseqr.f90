!*==shseqr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SHSEQR
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL , DIMENSION(NL,NL) :: hl
      INTEGER :: i , kbot , nmin
      LOGICAL :: initz , lquery , wantt , wantz
      REAL , DIMENSION(NL) :: workl
!
...
!
         CALL SLAQR0(wantt,wantz,N,Ilo,Ihi,H,Ldh,Wr,Wi,Ilo,Ihi,Z,Ldz,   &
     &               Work,Lwork,Info)
...
!           ==== Small matrix ====
!
            CALL SLAHQR(wantt,wantz,N,Ilo,Ihi,H,Ldh,Wr,Wi,Ilo,Ihi,Z,Ldz,&
     &                  Info)
!
            IF ( Info>0 ) THEN
!
...
!
                  CALL SLAQR0(wantt,wantz,N,Ilo,kbot,H,Ldh,Wr,Wi,Ilo,   &
...
!
                  ...
                  CALL SLAQR0(wantt,wantz,NL,Ilo,kbot,hl,NL,Wr,Wi,Ilo,  &
