!*==sgetsqrhrt.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SGETSQRHRT
!
!  =========== DOCUMENTATION ===========
!
...
!
      CALL SLATSQR(M,N,Mb1,nb1local,A,Lda,Work,ldwt,Work(lwt+1),lw1,    &
     &             iinfo)
!
...
!
      ...
      CALL SORGTSQR_ROW(M,N,Mb1,nb1local,A,Lda,Work,ldwt,Work(lwt+N*N+1)&
     &                  ,lw2,iinfo)
!
