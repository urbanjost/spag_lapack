!*==dchkbb.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b DCHKBB
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKBB(Nsizes,Mval,Nval,Nwdths,Kk,Ntypes,Dotype,Nrhs,  &
...
!     .. Array Arguments ..
      LOGICAL Dotype(*)
      INTEGER Iseed(4) , Kk(*) , Mval(*) , Nval(*)
      DOUBLE PRECISION A(Lda,*) , Ab(Ldab,*) , Bd(*) , Be(*) , C(Ldc,*) &
     &                 , Cc(Ldc,*) , P(Ldp,*) , Q(Ldq,*) , Result(*) ,  &
     &                 Work(*)
!     ..
!
!  =====================================================================
...
!
                           CALL DLATMS(m,n,'S',Iseed,'N',Work,imode,    &
...
!
                     CALL DGBBRD('B',m,n,Nrhs,kl,ku,Ab,Ldab,Bd,Be,Q,Ldq,&
     &                           P,Ldp,Cc,Ldc,Work,iinfo)
!
                     IF ( iinfo/=0 ) THEN
                        WRITE (Nounit,FMT=99001) 'DGBBRD' , iinfo , n , &
     &                         jtype , ioldsd
                        Info = ABS(iinfo)
                        IF ( iinfo<0 ) THEN
                           RETURN
...
!
                     CALL DBDT01(m,n,-1,A,Lda,Q,Ldq,Bd,Be,P,Ldp,Work,   &
     &                           Result(1))
...
!
      ...
      RETURN
!
99001 FORMAT (' DCHKBB: ',A,' returned INFO=',I5,'.',/9X,'M=',I5,' N=', &
