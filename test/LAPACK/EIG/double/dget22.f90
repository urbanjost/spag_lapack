!*==dget22.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b DGET22
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DGET22(Transa,Transe,Transw,N,A,Lda,E,Lde,Wr,Wi,Work,  &
     &                  Result)
      IMPLICIT NONE
!*--DGET22171
!
...
!     ..
!     .. Array Arguments ..
      DOUBLE PRECISION A(Lda,*) , E(Lde,*) , Result(2) , Wi(*) , Work(*)&
     &                 , Wr(*)
!     ..
!
!  =====================================================================
...
!
         IF ( ipair==1 ) THEN
            ...
            wmat(1,2) = Wi(jcol)
            wmat(2,2) = Wr(jcol)
            CALL DGEMM(Transe,Transw,N,2,2,ONE,E(ierow,iecol),Lde,wmat, &
...
!
         ELSE
!
            CALL DAXPY(N,Wr(jcol),E(ierow,iecol),ince,Work(N*(jcol-1)+1)&
     &                 ,1)
            ipair = 0
         ENDIF
!
