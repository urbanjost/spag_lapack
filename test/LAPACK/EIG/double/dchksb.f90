!*==dchksb.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b DCHKSB
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DCHKSB(Nsizes,Nn,Nwdths,Kk,Ntypes,Dotype,Iseed,Thresh, &
     &                  Nounit,A,Lda,Sd,Se,U,Ldu,Work,Lwork,Result,Info)
      IMPLICIT NONE
!*--DCHKSB296
!
...
!     .. Array Arguments ..
      LOGICAL Dotype(*)
      INTEGER Iseed(4) , Kk(*) , Nn(*)
      DOUBLE PRECISION A(Lda,*) , Result(*) , Sd(*) , Se(*) , U(Ldu,*) ,&
     &                 Work(*)
!     ..
!
!  =====================================================================
...
!
      ...
      RETURN
!
99001 FORMAT (' DCHKSB: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
99002 FORMAT (/1X,A3,                                                   &
     &        ' -- Real Symmetric Banded Tridiagonal Reduction Routines'&
     &        )
99003 FORMAT (' Matrix types (see DCHKSB for details): ')
!
