!*==ddrvsx.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b DDRVSX
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE DDRVSX(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Niunit,    &
...
!
                  DO iwk = 1 , 2
                     ...
                     nnwork = MAX(nnwork,1)
!
                     CALL DGET24(.FALSE.,jtype,Thresh,ioldsd,Nounit,n,A,&
...
!
         CALL DGET24(.TRUE.,22,Thresh,Iseed,Nounit,n,A,Lda,H,Ht,Wr,Wi,  &
...
99009 FORMAT (' DDRVSX: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of DDRVSX
!
      END SUBROUTINE DDRVSX
