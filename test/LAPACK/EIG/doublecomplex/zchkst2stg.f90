!*==zchkst2stg.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b ZCHKST2STG
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCHKST2STG(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,&
     &                      A,Lda,Ap,Sd,Se,D1,D2,D3,D4,D5,Wa1,Wa2,Wa3,  &
     &                      Wr,U,Ldu,V,Vp,Tau,Z,Work,Lwork,Rwork,Lrwork,&
...
!     .. Local Scalars ..
     ...
     &        nerrs , nmats , nmax , nsplit , ntest , ntestt , lh , lw
...
!
            ...
            lh = MAX(1,4*n)
            lw = Lwork - lh
            CALL ZHETRD_2STAGE('N',"U",n,V,Ldu,Sd,Se,Tau,Work,lh,       &
     &                         Work(lh+1),lw,iinfo)
!
...
!
            ...
            CALL ZHETRD_2STAGE('N',"L",n,V,Ldu,Sd,Se,Tau,Work,lh,       &
     &                         Work(lh+1),lw,iinfo)
!
...
!
      ...
      RETURN
!
99001 FORMAT (' ZCHKST2STG: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,   &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
99002 FORMAT (/1X,A3,' -- Complex Hermitian eigenvalue problem')
99003 FORMAT (' Matrix types (see ZCHKST2STG for details): ')
!
...
!
99009 FORMAT (/'Test performed:  see ZCHKST2STG for details.',/)
!     End of ZCHKST2STG
!
      END SUBROUTINE ZCHKST2STG
