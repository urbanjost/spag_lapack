!*==zckgsv.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b ZCKGSV
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCKGSV(Nm,Mval,Pval,Nval,Nmats,Iseed,Thresh,Nmax,A,Af, &
...
!
               nt = 6
!
               CALL ZGSVTS3(m,p,n,A,Af,lda,B,Bf,ldb,U,ldu,V,ldv,Q,ldq,  &
...
!
99001 FORMAT (' ZLATMS in ZCKGSV   INFO = ',I5)
99002 FORMAT (' M=',I4,' P=',I4,', N=',I4,', type ',I2,', test ',I2,    &
     &        ', ratio=',G13.6)
!
!     End of ZCKGSV
!
      END SUBROUTINE ZCKGSV
