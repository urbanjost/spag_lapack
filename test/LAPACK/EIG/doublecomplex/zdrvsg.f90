!*==zdrvsg.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b ZDRVSG
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZDRVSG(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,A,  &
...
!
      RETURN
!
99001 FORMAT (' ZDRVSG: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!     End of ZDRVSG
!
      END SUBROUTINE ZDRVSG
