!*==zcklse.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b ZCKLSE
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE ZCKLSE(Nn,Mval,Pval,Nval,Nmats,Iseed,Thresh,Nmax,A,Af, &
...
!
                  nt = 2
!
                  CALL ZLSETS(m,p,n,A,Af,lda,B,Bf,ldb,X,X(Nmax+1),      &
...
!
99001 FORMAT (' ZLATMS in ZCKLSE   INFO = ',I5)
