!*==sdrvsg2stg.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SDRVSG2STG
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVSG2STG(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,&
...
!     .. Local Scalars ..
     ...
     &     ulp , ulpinv , unfl , vl , vu , temp1 , temp2
!     ..
!     .. Local Arrays ..
...
!
                     ...
                     CALL SLACPY(uplo,n,n,B,Ldb,Bb,Ldb)
!
                     CALL SSYGV_2STAGE(ibtype,'N',uplo,n,Z,Ldz,Bb,Ldb,  &
     &                                 D2,Work,Nwork,iinfo)
                     IF ( iinfo/=0 ) THEN
                        WRITE (Nounit,FMT=99001) 'SSYGV_2STAGE(V,'//    &
...
!     End of SDRVSG2STG
!
99001 FORMAT (' SDRVSG2STG: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,   &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
      END SUBROUTINE SDRVSG2STG
