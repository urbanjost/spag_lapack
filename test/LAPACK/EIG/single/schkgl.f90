!*==schkgl.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SCHKGL
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Arrays ..
      INTEGER lmax(5)
      REAL a(LDA,LDA) , ain(LDA,LDA) , b(LDB,LDB) , bin(LDB,LDB) ,      &
     &     lscale(LDA) , lsclin(LDA) , rscale(LDA) , rsclin(LDA) ,      &
     &     work(LWORK)
!     ..
!     .. External Functions ..
      REAL SLAMCH , SLANGE
...
99001       FORMAT (1X,'.. test output of SGGBAL .. ')
!
