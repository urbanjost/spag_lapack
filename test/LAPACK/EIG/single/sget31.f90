!*==sget31.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SGET31
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Arrays ..
      LOGICAL ltrans(0:1)
      REAL a(2,2) , b(2,2) , vab(3) , vca(5) , vdd(4) , vsmin(4) ,      &
     &     vwi(4) , vwr(4) , x(2,2)
!     ..
!     .. External Functions ..
      REAL SLAMCH
...
!
     ...
     &                             THEN
                              ...
                              ENDIF
                              wi = ZERO
                              CALL SLALN2(ltrans(itrans),na,nw,smin,ca, &
...
!
     ...
     &                                ca==ONE ) THEN
                                 ...
                                 ELSE
                                    wi = vwi(iwi)
                                 ENDIF
                                 CALL SLALN2(ltrans(itrans),na,nw,smin, &
