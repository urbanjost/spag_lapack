!*==shst01.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SHST01
!
!  =========== DOCUMENTATION ===========
!
...
!     Compute Q*H
!
      CALL SGEMM('No transpose','No transpose',N,N,N,ONE,Q,Ldq,H,Ldh,   &
     &           ZERO,Work(ldwork*N+1),ldwork)
!
!     Compute A - Q*H*Q'
!
      CALL SGEMM('No transpose','Transpose',N,N,N,-ONE,Work(ldwork*N+1),&
