!*==schkst2stg.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SCHKST2STG
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCHKST2STG(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,&
...
!
            ...
            lh = MAX(1,4*n)
            lw = Lwork - lh
            CALL SSYTRD_2STAGE('N',"U",n,V,Ldu,Sd,Se,Tau,Work,lh,       &
     &                         Work(lh+1),lw,iinfo)
!
...
!
            ...
            CALL SSYTRD_2STAGE('N',"L",n,V,Ldu,Sd,Se,Tau,Work,lh,       &
     &                         Work(lh+1),lw,iinfo)
!
...
!
      ...
      RETURN
!
99001 FORMAT (' SCHKST2STG: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,   &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
99002 FORMAT (/1X,A3,' -- Real Symmetric eigenvalue problem')
99003 FORMAT (' Matrix types (see SCHKST2STG for details): ')
!
...
99007 FORMAT (' N=',I5,', seed=',4(I4,','),' type ',I2,', test(',I2,    &
     &        ')=',G10.3)
!
99008 FORMAT (/'Test performed:  see SCHKST2STG for details.',/)
!     End of SCHKST2STG
!
      END SUBROUTINE SCHKST2STG
