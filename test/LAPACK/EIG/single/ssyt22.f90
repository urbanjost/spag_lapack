!*==ssyt22.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SSYT22
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SSYT22(Itype,Uplo,N,M,Kband,A,Lda,D,E,U,Ldu,V,Ldv,Tau, &
     &                  Work,Result)
      IMPLICIT NONE
!*--SSYT22161
!
...
!     Compute  U**T U - I
!
      IF ( Itype==1 ) CALL SORT01('Columns',N,M,U,Ldu,Work,2*N*N,       &
     &                            Result(2))
!
!
!     End of SSYT22
!
      END SUBROUTINE SSYT22
