!*==sdrvev.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SDRVEV
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SDRVEV(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,A,  &
...
!     .. Array Arguments ..
      LOGICAL Dotype(*)
      INTEGER Iseed(4) , Iwork(*) , Nn(*)
      REAL A(Lda,*) , H(Lda,*) , Lre(Ldlre,*) , Result(7) , Vl(Ldvl,*) ,&
     &     Vr(Ldvr,*) , Wi(*) , Wi1(*) , Work(*) , Wr(*) , Wr1(*)
!     ..
!
!  =====================================================================
!
...
!
                  ...
                  CALL SGEEV('V','V',n,H,Lda,Wr,Wi,Vl,Ldvl,Vr,Ldvr,Work,&
     &                       nnwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'SGEEV1' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
!
                  CALL SLACPY('F',n,n,A,Lda,H,Lda)
                  CALL SGEEV('N','N',n,H,Lda,Wr1,Wi1,dum,1,dum,1,Work,  &
     &                       nnwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'SGEEV2' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
!
                  CALL SLACPY('F',n,n,A,Lda,H,Lda)
                  CALL SGEEV('N','V',n,H,Lda,Wr1,Wi1,dum,1,Lre,Ldlre,   &
     &                       Work,nnwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'SGEEV3' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
!
                  CALL SLACPY('F',n,n,A,Lda,H,Lda)
                  CALL SGEEV('V','N',n,H,Lda,Wr1,Wi1,Lre,Ldlre,dum,1,   &
     &                       Work,nnwork,iinfo)
                  IF ( iinfo/=0 ) THEN
                     Result(1) = ulpinv
                     WRITE (Nounit,FMT=99007) 'SGEEV4' , iinfo , n ,    &
     &                      jtype , ioldsd
                     Info = ABS(iinfo)
                     GOTO 5
                  ENDIF
...
99006 FORMAT (' N=',I5,', IWK=',I2,', seed=',4(I4,','),' type ',I2,     &
     &        ', test(',I2,')=',G10.3)
99007 FORMAT (' SDRVEV: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of SDRVEV
!
      END SUBROUTINE SDRVEV
