!*==sget32.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SGET32
!
!  =========== DOCUMENTATION ===========
!
               ...
               DO itl = 1 , 3
                  DO itr = 1 , 3
                     DO ib = 1 , 3
                        ...
                        b(1,1) = val(ib)
                        Knt = Knt + 1
                        CALL SLASY2(ltranl,ltranr,isgn,n1,n2,tl,2,tr,2, &
                     ...
                     DO itr = 1 , 3
                        DO ib1 = 1 , 3
                           DO ib2 = 1 , 3
                              ...
                              tr(1,1) = val(itr)
                              Knt = Knt + 1
                              CALL SLASY2(ltranl,ltranr,isgn,n1,n2,tl,2,&
...
!
     ...
     &                                 val(ib3))
                                    ...
                                    tl(2,2) = itval(2,2,itl)*val(itlscl)
                                    Knt = Knt + 1
                                    CALL SLASY2(ltranl,ltranr,isgn,n1,  &
