!*==sckgsv.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b SCKGSV
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE SCKGSV(Nm,Mval,Pval,Nval,Nmats,Iseed,Thresh,Nmax,A,Af, &
...
!
               CALL SLATB9(path,imat,m,p,n,type,kla,kua,klb,kub,anorm,  &
...
!
               nt = 6
!
               CALL SGSVTS3(m,p,n,A,Af,lda,B,Bf,ldb,U,ldu,V,ldv,Q,ldq,  &
...
!
99001 FORMAT (' SLATMS in SCKGSV   INFO = ',I5)
99002 FORMAT (' M=',I4,' P=',I4,', N=',I4,', type ',I2,', test ',I2,    &
     &        ', ratio=',G13.6)
!
!     End of SCKGSV
!
      END SUBROUTINE SCKGSV
