!*==cdrves.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b CDRVES
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CDRVES(Nsizes,Nn,Ntypes,Dotype,Iseed,Thresh,Nounit,A,  &
...
!     .. Array Arguments ..
      ...
      INTEGER Iseed(4) , Iwork(*) , Nn(*)
      REAL Result(13) , Rwork(*)
      COMPLEX A(Lda,*) , H(Lda,*) , Ht(Lda,*) , Vs(Ldvs,*) , W(*) ,     &
     &        Work(*) , Wt(*)
!     ..
!
!  =====================================================================
...
!
                     ...
                     CALL CGEES('V',sort,CSLECT,n,H,Lda,sdim,W,Vs,Ldvs, &
     &                          Work,nnwork,Rwork,Bwork,iinfo)
                     IF ( iinfo/=0 ) THEN
                        Result(1+rsub) = ulpinv
                        WRITE (Nounit,FMT=99008) 'CGEES1' , iinfo , n , &
     &                         jtype , ioldsd
                        Info = ABS(iinfo)
                        EXIT
                     ENDIF
...
!
                     lwork = MAX(1,2*n*n)
                     CALL CHST01(n,1,n,A,Lda,H,Lda,Vs,Ldvs,Work,lwork,  &
     &                           Rwork,res)
                     Result(2+rsub) = res(1)
                     Result(3+rsub) = res(2)
!
...
!
                     ...
                     CALL CGEES('N',sort,CSLECT,n,Ht,Lda,sdim,Wt,Vs,    &
     &                          Ldvs,Work,nnwork,Rwork,Bwork,iinfo)
                     IF ( iinfo/=0 ) THEN
                        Result(5+rsub) = ulpinv
                        WRITE (Nounit,FMT=99008) 'CGEES2' , iinfo , n , &
     &                         jtype , ioldsd
                        Info = ABS(iinfo)
                        EXIT
                     ENDIF
...
99007 FORMAT (' N=',I5,', IWK=',I2,', seed=',4(I4,','),' type ',I2,     &
     &        ', test(',I2,')=',G10.3)
99008 FORMAT (' CDRVES: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,       &
     &        ', JTYPE=',I6,', ISEED=(',3(I5,','),I5,')')
!
!
!     End of CDRVES
!
      END SUBROUTINE CDRVES
