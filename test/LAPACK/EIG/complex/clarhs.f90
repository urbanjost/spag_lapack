!*==clarhs.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b CLARHS
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CLARHS(Path,Xtype,Uplo,Trans,M,N,Kl,Ku,Nrhs,A,Lda,X,   &
...
!     .. External Subroutines ..
      EXTERNAL CGBMV , CGEMM , CHBMV , CHEMM , CHPMV , CLACPY , CLARNV ,&
     &         CSBMV , CSPMV , CSYMM , CTBMV , CTPMV , CTRMM , XERBLA
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX
!     ..
