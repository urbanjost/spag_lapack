!*==cchkhb2stg.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b CCHKHBSTG
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CCHKHB2STG(Nsizes,Nn,Nwdths,Kk,Ntypes,Dotype,Iseed,    &
...
!
     ...
     &                           iinfo)
                     IF ( iinfo/=0 ) THEN
                        WRITE (Nounit,FMT=99001) 'CSTEQR(N)' , iinfo ,  &
     &                         n , jtype , ioldsd
                        Info = ABS(iinfo)
                        IF ( iinfo<0 ) THEN
                           RETURN
...
!
                     ...
                     lh = MAX(1,4*n)
                     lw = Lwork - lh
                     CALL CHETRD_HB2ST('N','N',"U",n,k,U,Ldu,Sd,Se,Work,&
...
!
                     ...
                     lh = MAX(1,4*n)
                     lw = Lwork - lh
                     CALL CHETRD_HB2ST('N','N',"L",n,k,U,Ldu,Sd,Se,Work,&
     &                                 lh,Work(lh+1),lw,iinfo)
!
...
!
      ...
      RETURN
!
99001 FORMAT (' CCHKHBSTG: ',A,' returned INFO=',I6,'.',/9X,'N=',I6,    &
