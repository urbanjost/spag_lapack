!*==cglmts.f90  processed by SPAG 7.51RB at 17:37 on  4 Mar 2022
!> \brief \b CGLMTS
!
!  =========== DOCUMENTATION ===========
!
...
!
!  =====================================================================
      SUBROUTINE CGLMTS(N,M,P,A,Af,Lda,B,Bf,Ldb,D,Df,X,U,Work,Lwork,    &
     &                  Rwork,Result)
      IMPLICIT NONE
!*--CGLMTS154
!
...
!     .. Array Arguments ..
      REAL Rwork(*)
      COMPLEX A(Lda,*) , Af(Lda,*) , B(Ldb,*) , Bf(Ldb,*) , D(*) ,      &
     &        Df(*) , U(*) , Work(Lwork) , X(*)
!
!  ====================================================================
!
