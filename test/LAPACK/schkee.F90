...
!  =====================================================================
      PROGRAM SCHKEE
      USE M_TST_EIG , ONLY:ALAREQ , XLAENV , SCHKBB , SCHKBD
      USE M_TST_EIG , ONLY:SCHKBK , SCHKBL , SCHKEC , SCHKGG
      USE M_TST_EIG , ONLY:SCHKGK , SCHKGL , SCHKHS , SCHKSB2STG
      USE M_TST_EIG , ONLY:SCHKST2STG , SCHKST , SCKCSD , SCKGLM
      USE M_TST_EIG , ONLY:SCKGQR , SCKGSV , SCKLSE , SDRGES3
      USE M_TST_EIG , ONLY:SDRGES , SDRGEV3 , SDRGEV , SDRGSX
      USE M_TST_EIG , ONLY:SDRGVX , SDRVBD , SDRVES , SDRVEV
      USE M_TST_EIG , ONLY:SDRVSG2STG , SDRVST2STG , SDRVST , SDRVSX
      USE M_TST_EIG , ONLY:SDRVVX , SERRBD , SERRED , SERRGG
      USE M_TST_EIG , ONLY:SERRHS , SERRST
#if defined(_OPENMP)
      USE OMP_LIB
#endif
      IMPLICIT NONE
