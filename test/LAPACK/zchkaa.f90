!*==zchkaa.f90 processed by SPAG 7.51RB at 17:34 on  4 Mar 2022
!> \brief \b ZCHKAA
!
!  =========== DOCUMENTATION ===========
!
...
!  =====================================================================
     ...
     &         ZCHKPT , ZCHKQ3 , ZCHKQL , ZCHKQR , ZCHKRQ , ZCHKSP ,    &
     &         ZCHKSY , ZCHKSY_ROOK , ZCHKSY_RK , ZCHKSY_AA , ZCHKTB ,  &
     &         ZCHKTP , ZCHKTR , ZCHKTZ , ZDRVGB , ZDRVGE , ZDRVGT ,    &
     &         ZDRVHE , ZDRVHE_ROOK , ZDRVHE_RK , ZDRVHE_AA ,           &
     &         ZDRVHE_AA_2STAGE , ZDRVHP , ZDRVLS , ZDRVPB , ZDRVPO ,   &
     &         ZDRVPP , ZDRVPT , ZDRVSP , ZDRVSY , ZDRVSY_ROOK ,        &
     &         ZDRVSY_RK , ZDRVSY_AA , ZDRVSY_AA_2STAGE ,               &
     &         ZCHKQRT , ZCHKQRTP , ZCHKLQT , ZCHKLQTP , ZCHKTSQR,      &
     &         ZCHKHE_AA_2STAGE, ZCHKSY_AA_2STAGE
      IMPLICIT NONE
!*--ZCHKAA121
!
...
!     .. Local Arrays ..
     ...
     &        , rankval(MAXIN) , piv(NMAX)
      ...
      COMPLEX*16 a((KDMAX+1)*NMAX,7) , b(NMAX*MAXRHS,4) , e(NMAX) ,     &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKGE(dotype,nm,mval,nn,nval,nnb2,nbval2,nns,nsval,   &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVGE(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKGB(dotype,nm,mval,nn,nval,nnb2,nbval2,nns,nsval,   &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVGB(dotype,nn,nval,nrhs,thresh,tsterr,a(1,1),la,    &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKGT(dotype,nn,nval,nns,nsval,thresh,tsterr,a(1,1),  &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVGT(dotype,nn,nval,nrhs,thresh,tsterr,a(1,1),a(1,2),&
...
!
         IF ( tstchk ) THEN
            CALL ZCHKPO(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh,    &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVPO(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
     &                  a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),b(1,4),s,    &
     &                  work,rwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKPS(dotype,nn,nval,nnb2,nbval2,nrank,rankval,thresh,&
...
!
         IF ( tstchk ) THEN
            CALL ZCHKPP(dotype,nn,nval,nns,nsval,thresh,tsterr,lda,     &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVPP(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
     &                  a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),b(1,4),s,    &
     &                  work,rwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKPB(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh,    &
     &                  tsterr,lda,a(1,1),a(1,2),a(1,3),b(1,1),b(1,2),  &
     &                  b(1,3),work,rwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVPB(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
     &                  a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),b(1,4),s,    &
     &                  work,rwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKPT(dotype,nn,nval,nns,nsval,thresh,tsterr,a(1,1),s,&
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVPT(dotype,nn,nval,nrhs,thresh,tsterr,a(1,1),s,     &
     &                  a(1,2),b(1,1),b(1,2),b(1,3),work,rwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
         ENDIF
...
!
         IF ( tstchk ) THEN
            CALL ZCHKHE(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh,    &
     &                  tsterr,lda,a(1,1),a(1,2),a(1,3),b(1,1),b(1,2),  &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVHE(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVHE_ROOK(dotype,nn,nval,nrhs,thresh,tsterr,lda,     &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKHE_RK(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh, &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVHE_RK(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),&
...
!
         IF ( tstchk ) THEN
            CALL ZCHKHE_AA(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh, &
     &                     tsterr,lda,a(1,1),a(1,2),a(1,3),b(1,1),b(1,2)&
     &                     ,b(1,3),work,rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVHE_AA(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),&
...
!
         IF ( tstchk ) THEN
            CALL ZCHKHE_AA_2STAGE(dotype,nn,nval,nnb2,nbval2,nns,nsval, &
     &                            thresh,tsterr,lda,a(1,1),a(1,2),a(1,3)&
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVHE_AA_2STAGE(dotype,nn,nval,nrhs,thresh,tsterr,lda,&
...
!
         IF ( tstchk ) THEN
            CALL ZCHKHP(dotype,nn,nval,nns,nsval,thresh,tsterr,lda,     &
     &                  a(1,1),a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),work, &
     &                  rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVHP(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
     &                  a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),work,rwork,  &
     &                  iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKSY(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh,    &
     &                  tsterr,lda,a(1,1),a(1,2),a(1,3),b(1,1),b(1,2),  &
     &                  b(1,3),work,rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVSY(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
     &                  a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),work,rwork,  &
     &                  iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVSY_ROOK(dotype,nn,nval,nrhs,thresh,tsterr,lda,     &
     &                       a(1,1),a(1,2),a(1,3),b(1,1),b(1,2),b(1,3), &
     &                       work,rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKSY_RK(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh, &
     &                     tsterr,lda,a(1,1),a(1,2),e,a(1,3),b(1,1),    &
     &                     b(1,2),b(1,3),work,rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVSY_RK(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),&
     &                     a(1,2),e,a(1,3),b(1,1),b(1,2),b(1,3),work,   &
     &                     rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKSY_AA(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh, &
     &                     tsterr,lda,a(1,1),a(1,2),a(1,3),b(1,1),b(1,2)&
     &                     ,b(1,3),work,rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVSY_AA(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),&
     &                     a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),work,     &
     &                     rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKSY_AA_2STAGE(dotype,nn,nval,nnb2,nbval2,nns,nsval, &
     &                            thresh,tsterr,lda,a(1,1),a(1,2),a(1,3)&
     &                            ,b(1,1),b(1,2),b(1,3),work,rwork,     &
     &                            iwork,NOUT)
         ELSE
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVSY_AA_2STAGE(dotype,nn,nval,nrhs,thresh,tsterr,lda,&
     &                            a(1,1),a(1,2),a(1,3),b(1,1),b(1,2),   &
     &                            b(1,3),work,rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKSP(dotype,nn,nval,nns,nsval,thresh,tsterr,lda,     &
     &                  a(1,1),a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),work, &
     &                  rwork,iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVSP(dotype,nn,nval,nrhs,thresh,tsterr,lda,a(1,1),   &
     &                  a(1,2),a(1,3),b(1,1),b(1,2),b(1,3),work,rwork,  &
     &                  iwork,NOUT)
         ELSE
            WRITE (NOUT,FMT=99012) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKTR(dotype,nn,nval,nnb2,nbval2,nns,nsval,thresh,    &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKTP(dotype,nn,nval,nns,nsval,thresh,tsterr,lda,     &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKTB(dotype,nn,nval,nns,nsval,thresh,tsterr,lda,     &
     &                  a(1,1),a(1,2),b(1,1),b(1,2),b(1,3),work,rwork,  &
     &                  NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
...
!
         IF ( tstchk ) THEN
            CALL ZCHKQR(dotype,nm,mval,nn,nval,nnb,nbval,nxval,nrhs,    &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKLQ(dotype,nm,mval,nn,nval,nnb,nbval,nxval,nrhs,    &
     &                  thresh,tsterr,NMAX,a(1,1),a(1,2),a(1,3),a(1,4), &
     &                  a(1,5),b(1,1),b(1,2),b(1,3),b(1,4),work,rwork,  &
     &                  NOUT)
         ELSE
...
!
         IF ( tstchk ) THEN
            CALL ZCHKQL(dotype,nm,mval,nn,nval,nnb,nbval,nxval,nrhs,    &
     &                  thresh,tsterr,NMAX,a(1,1),a(1,2),a(1,3),a(1,4), &
     &                  a(1,5),b(1,1),b(1,2),b(1,3),b(1,4),work,rwork,  &
     &                  NOUT)
         ELSE
...
!
         IF ( tstchk ) THEN
            CALL ZCHKRQ(dotype,nm,mval,nn,nval,nnb,nbval,nxval,nrhs,    &
     &                  thresh,tsterr,NMAX,a(1,1),a(1,2),a(1,3),a(1,4), &
     &                  a(1,5),b(1,1),b(1,2),b(1,3),b(1,4),work,rwork,  &
     &                  iwork,NOUT)
         ELSE
...
!
         IF ( tstchk ) THEN
            CALL ZCHKTZ(dotype,nm,mval,nn,nval,thresh,tsterr,a(1,1),    &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKQ3(dotype,nm,mval,nn,nval,nnb,nbval,nxval,thresh,  &
...
!
         IF ( tstdrv ) THEN
            CALL ZDRVLS(dotype,nm,mval,nn,nval,nns,nsval,nnb,nbval,     &
...
!
         IF ( tstchk ) THEN
            CALL ZCHKQRT(thresh,tsterr,nm,mval,nn,nval,nnb,nbval,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
         ENDIF
!
...
!
         IF ( tstchk ) THEN
            CALL ZCHKQRTP(thresh,tsterr,nm,mval,nn,nval,nnb,nbval,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
         ENDIF
!
...
!
         IF ( tstchk ) THEN
            CALL ZCHKLQT(thresh,tsterr,nm,mval,nn,nval,nnb,nbval,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
         ENDIF
!
...
!
         IF ( tstchk ) THEN
            CALL ZCHKLQTP(thresh,tsterr,nm,mval,nn,nval,nnb,nbval,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
         ENDIF
!
...
!
         IF ( tstchk ) THEN
            CALL ZCHKTSQR(thresh,tsterr,nm,mval,nn,nval,nnb,nbval,NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
         ENDIF
!
...
!
         IF ( tstchk ) THEN
            CALL ZCHKUNHR_COL(thresh,tsterr,nm,mval,nn,nval,nnb,nbval,  &
     &                        NOUT)
         ELSE
            WRITE (NOUT,FMT=99011) path
         ENDIF
...
99006 FORMAT (' Tests of the COMPLEX*16 LAPACK routines ',              &
