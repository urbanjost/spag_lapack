...
!  =====================================================================
      PROGRAM DCHKEE
      USE M_TST__EIG , ONLY:ALAREQ , DCHKBB , DCHKBD , DCHKBK
      USE M_TST__EIG , ONLY:DCHKBL , DCHKHS , DCKGLM
      USE M_TST__EIG , ONLY:DCHKEC , DCHKGG , DCHKGK , DCHKGL
      USE M_TST__EIG , ONLY:DCHKSB2STG , DCHKST2STG , DCHKST , DCKCSD
      USE M_TST__EIG , ONLY:DCKGQR , DCKGSV , DCKLSE , DDRGES3
      USE M_TST__EIG , ONLY:DDRGES , DDRVBD , DERRGG , DDRVST
      USE M_TST__EIG , ONLY:DDRGEV3 , DDRGEV , DDRGSX , DDRGVX
      USE M_TST__EIG , ONLY:DDRVES , DDRVEV , DDRVSG2STG , DDRVST2STG
      USE M_TST__EIG , ONLY:DDRVSX , DDRVVX , DERRBD , DERRED
      USE M_TST__EIG , ONLY:DERRHS , DERRST , XLAENV
#if defined(_OPENMP)
      USE OMP_LIB
#endif
      IMPLICIT NONE
