!*==cgegv.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
...
!     .. Local Scalars ..
     ...
     &        iright , irows , irwork , itau , iwork , jc , jr , lopt , &
     &        lwkmin , lwkopt , nb , nb1 , nb2 , nb3
      REAL absai , absar , absb , anrm , anrm1 , anrm2 , bnrm , bnrm1 , &
     &     bnrm2 , eps , safmax , safmin , salfai , salfar , sbeta ,    &
     &     scale , temp
      COMPLEX x
!     ..
!     .. Local Arrays ..
...
!
      IF ( ilvl ) THEN
         ...
         CALL CLACPY('L',irows-1,irows-1,B(ilo+1,ilo),Ldb,Vl(ilo+1,ilo),&
     &               Ldvl)
