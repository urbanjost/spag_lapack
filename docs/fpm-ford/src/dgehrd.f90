!*==dgehrd.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DGEHRD
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL DLAHR2(Ihi,i,ib,A(1,i),Lda,Tau(i),Work(iwt),LDT,Work,  &
     &                  ldwork)
!
...
!           right
!
            CALL DTRMM('Right','Lower','Transpose','Unit',i,ib-1,ONE,   &
...
!           left
!
            CALL DLARFB('Left','Transpose','Forward','Columnwise',Ihi-i,&
