!*==chbgvd.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CHBGVD
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
      ...
      CHARACTER vect
      INTEGER iinfo , inde , indwk2 , indwrk , liwmin , llrwk , llwk2 , &
     &        lrwmin , lwmin
!     ..
!     .. External Functions ..
      LOGICAL LSAME
...
!
      ...
      CALL CHBGST(Jobz,Uplo,N,Ka,Kb,Ab,Ldab,Bb,Ldbb,Z,Ldz,Work,Rwork,   &
     &            iinfo)
!
