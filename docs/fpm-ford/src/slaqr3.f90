!*==slaqr3.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
         CALL SLAQR4(.TRUE.,.TRUE.,jw,1,jw,T,Ldt,Sr,Si,1,jw,V,Ldv,Work, &
     &               -1,infqr)
         lwk3 = INT(Work(1))
!
!        ==== Optimal workspace ====
...
!
      ...
      IF ( jw>nmin ) THEN
         CALL SLAQR4(.TRUE.,.TRUE.,jw,1,jw,T,Ldt,Sr(kwtop),Si(kwtop),1, &
