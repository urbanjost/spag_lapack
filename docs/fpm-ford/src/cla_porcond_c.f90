!*==cla_porcond_c.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
!  =====================================================================
      REAL FUNCTION CLA_PORCOND_C(Uplo,N,A,Lda,Af,Ldaf,C,Capply,Info,   &
     &                            Work,Rwork)
      IMPLICIT NONE
!*--CLA_PORCOND_C134
!
...
!
         IF ( ainvnm/=0.0E+0 ) CLA_PORCOND_C = 1.0E+0/ainvnm
         EXIT
      ENDDO
!
!
