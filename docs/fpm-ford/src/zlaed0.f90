!*==zlaed0.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Scalars ..
     ...
     &        lgn , ll , matsiz , msd2 , smlsiz , smm1 , spm1 , spm2 ,  &
     &        submat , subpbs , tlvls
...
!
         ...
         DO i = 0 , spm1
            ...
            CALL DSTEQR('I',matsiz,D(submat),E(submat),Rwork(ll),matsiz,&
     &                  Rwork,Info)
            CALL ZLACRM(Qsiz,matsiz,Q(1,submat),Ldq,Rwork(ll),matsiz,   &
