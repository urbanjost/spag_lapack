!*==slaein.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Scalars ..
      ...
      REAL absbii , absbjj , ei , ej , growto , norm , nrmsml , rec ,   &
     &     rootn , scale , temp , vcrit , vmax , vnorm , w , w1 , x ,   &
     &     xi , xr , y
!     ..
!     .. External Functions ..
      INTEGER ISAMAX
...
!           overwriting x on v.
!
            CALL SLATRS('Upper',trans,'Nonunit',normin,N,B,Ldb,Vr,scale,&
     &                  Work,ierr)
            normin = 'Y'
!
