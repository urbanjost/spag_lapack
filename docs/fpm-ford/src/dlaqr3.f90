!*==dlaqr3.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     ..
!     .. Array Arguments ..
      DOUBLE PRECISION H(Ldh,*) , Si(*) , Sr(*) , T(Ldt,*) , V(Ldv,*) , &
     &                 Work(*) , Wv(Ldwv,*) , Z(Ldz,*)
!     ..
!
!  ================================================================
...
!
         CALL DLAQR4(.TRUE.,.TRUE.,jw,1,jw,T,Ldt,Sr,Si,1,jw,V,Ldv,Work, &
     &               -1,infqr)
         lwk3 = INT(Work(1))
!
!        ==== Optimal workspace ====
...
!
      ...
      IF ( jw>nmin ) THEN
         CALL DLAQR4(.TRUE.,.TRUE.,jw,1,jw,T,Ldt,Sr(kwtop),Si(kwtop),1, &
     &               jw,V,Ldv,Work,Lwork,infqr)
      ELSE
         CALL DLAHQR(.TRUE.,.TRUE.,jw,1,jw,T,Ldt,Sr(kwtop),Si(kwtop),1, &
     &               jw,V,Ldv,infqr)
      ENDIF
!
