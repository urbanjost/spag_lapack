!*==csytrf_rook.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CSYTRF_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
               CALL CLASYF_ROOK(Uplo,k,nb,kb,A,Lda,Ipiv,Work,ldwork,    &
     &                          iinfo)
            ELSE
!
...
!
               CALL CLASYF_ROOK(Uplo,N-k+1,nb,kb,A(k,k),Lda,Ipiv(k),    &
     &                          Work,ldwork,iinfo)
            ELSE
!
