!*==ssbevd_2stage.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Scalars ..
     ...
     &        llwork , lwmin , lhtrd , lwtrd , ib , indhous , llwrk2
...
!     .. External Subroutines ..
      EXTERNAL SGEMM , SLACPY , SLASCL , SSCAL , SSTEDC , SSTERF ,      &
     &         XERBLA , SSYTRD_SB2ST
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC SQRT
...
!
      CALL SSYTRD_SB2ST("N",Jobz,Uplo,N,Kd,Ab,Ldab,W,Work(inde),        &
