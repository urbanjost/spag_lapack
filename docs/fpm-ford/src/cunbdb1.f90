!*==cunbdb1.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CUNBDB1
!
!  =========== DOCUMENTATION ===========
!
...
!
     ...
     &                 X21(i+1,i+1),Ldx21,Work(ilarf))
            CALL CLACGV(Q-i,X21(i,i+1),Ldx21)
            c = SQRT(SCNRM2(P-i,X11(i+1,i+1),1)                         &
     &          **2+SCNRM2(M-P-i,X21(i+1,i+1),1)**2)
            Phi(i) = ATAN2(s,c)
            CALL CUNBDB5(P-i,M-P-i,Q-i-1,X11(i+1,i+1),1,X21(i+1,i+1),1, &
