!*==dgbsvxx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
      EXTERNAL DGBEQUB , DGBTRF , DGBTRS , DLACPY , DLAQGB , XERBLA ,   &
     &         DLASCL2 , DGBRFSX
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
      CALL DGBRFSX(Trans,Equed,N,Kl,Ku,Nrhs,Ab,Ldab,Afb,Ldafb,Ipiv,R,C, &
