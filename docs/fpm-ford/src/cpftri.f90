!*==cpftri.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CPFTRI
!
!  =========== DOCUMENTATION ===========
!
...
!
               ...
               CALL CHERK('L','C',n1,n2,ONE,A(n1),N,ONE,A(0),N)
               CALL CTRMM('L','U','N','N',n2,n1,CONE,A(N),N,A(n1),N)
...
!
               ...
               CALL CHERK('L','N',n1,n2,ONE,A(0),N,ONE,A(n2),N)
               CALL CTRMM('R','U','C','N',n1,n2,CONE,A(n1),N,A(0),N)
...
!
            ...
            CALL CHERK('U','N',n1,n2,ONE,A(n1*n1),n1,ONE,A(0),n1)
            CALL CTRMM('R','L','N','N',n1,n2,CONE,A(1),n1,A(n1*n1),n1)
...
!
            ...
            CALL CHERK('U','C',n1,n2,ONE,A(0),n2,ONE,A(n2*n2),n2)
            CALL CTRMM('L','L','C','N',n2,n1,CONE,A(n1*n2),n2,A(0),n2)
...
!
            ...
            CALL CHERK('L','C',k,k,ONE,A(k+1),N+1,ONE,A(1),N+1)
            CALL CTRMM('L','U','N','N',k,k,CONE,A(0),N+1,A(k+1),N+1)
...
!
            ...
            CALL CHERK('L','N',k,k,ONE,A(0),N+1,ONE,A(k+1),N+1)
            CALL CTRMM('R','U','C','N',k,k,CONE,A(k),N+1,A(0),N+1)
...
!
         ...
         CALL CHERK('U','N',k,k,ONE,A(k*(k+1)),k,ONE,A(k),k)
         CALL CTRMM('R','L','N','N',k,k,CONE,A(0),k,A(k*(k+1)),k)
...
!
         ...
         CALL CHERK('U','C',k,k,ONE,A(0),k,ONE,A(k*(k+1)),k)
         CALL CTRMM('L','L','C','N',k,k,CONE,A(k*k),k,A(0),k)
