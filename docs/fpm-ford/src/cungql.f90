!*==cungql.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CUNGQL
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
      LOGICAL lquery
      INTEGER i , ib , iinfo , iws , j , kk , l , ldwork , lwkopt , nb ,&
     &        nbmin , nx
!     ..
...
!
            CALL CUNG2L(M-K+i+ib-1,ib,ib,A(1,N-K+i),Lda,Tau(i),Work,    &
     &                  iinfo)
!
