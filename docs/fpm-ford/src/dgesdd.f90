!*==dgesdd.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DGESDD
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
     ...
     &        nwork , wrkbl
      INTEGER lwork_dgebrd_mn , lwork_dgebrd_mm , lwork_dgebrd_nn ,     &
     &        lwork_dgelqf_mn , lwork_dgeqrf_mn , lwork_dorgbr_p_mm ,   &
     &        lwork_dorgbr_q_nn , lwork_dorglq_mn , lwork_dorglq_nn ,   &
     &        lwork_dorgqr_mm , lwork_dorgqr_mn , lwork_dormbr_prt_mm , &
     &        lwork_dormbr_qln_mm , lwork_dormbr_prt_mn ,               &
     &        lwork_dormbr_qln_mn , lwork_dormbr_prt_nn ,               &
     &        lwork_dormbr_qln_nn
