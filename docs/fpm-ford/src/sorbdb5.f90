!*==sorbdb5.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
      CALL SORBDB6(M1,M2,N,X1,Incx1,X2,Incx2,Q1,Ldq1,Q2,Ldq2,Work,Lwork,&
     &             childinfo)
!
!     If the projection is nonzero, then return
!
      IF ( SNRM2(M1,X1,Incx1)/=ZERO .OR. SNRM2(M2,X2,Incx2)/=ZERO )     &
     &     RETURN
!
...
!
      DO i = 1 , M1
         ...
         DO j = 1 , M2
            X2(j) = ZERO
         ENDDO
         CALL SORBDB6(M1,M2,N,X1,Incx1,X2,Incx2,Q1,Ldq1,Q2,Ldq2,Work,   &
     &                Lwork,childinfo)
         IF ( SNRM2(M1,X1,Incx1)/=ZERO .OR. SNRM2(M2,X2,Incx2)/=ZERO )  &
     &        RETURN
      ENDDO
