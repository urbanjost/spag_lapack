!*==sorbdb3.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
      REAL Phi(*) , Theta(*)
      REAL Taup1(*) , Taup2(*) , Tauq1(*) , Work(*) , X11(Ldx11,*) ,    &
     &     X21(Ldx21,*)
!     ..
!
!  ====================================================================
...
!
      DO i = 1 , M - P
!
         IF ( i>1 ) CALL SROT(Q-i+1,X11(i-1,i),Ldx11,X21(i,i),Ldx11,c,s)
!
         CALL SLARFGP(Q-i+1,X21(i,i),X21(i,i+1),Ldx21,Tauq1(i))
         s = X21(i,i)
         X21(i,i) = ONE
         CALL SLARF('R',P-i+1,Q-i+1,X21(i,i),Ldx21,Tauq1(i),X11(i,i),   &
     &              Ldx11,Work(ilarf))
         CALL SLARF('R',M-P-i,Q-i+1,X21(i,i),Ldx21,Tauq1(i),X21(i+1,i), &
     &              Ldx21,Work(ilarf))
         c = SQRT(SNRM2(P-i+1,X11(i,i),1)**2+SNRM2(M-P-i,X21(i+1,i),1)  &
     &       **2)
         Theta(i) = ATAN2(s,c)
!
         CALL SORBDB5(P-i+1,M-P-i,Q-i,X11(i,i),1,X21(i+1,i),1,X11(i,i+1)&
     ...
     &                childinfo)
         ...
         IF ( i<M-P ) THEN
            ...
            s = SIN(Phi(i))
            X21(i+1,i) = ONE
            CALL SLARF('L',M-P-i,Q-i,X21(i+1,i),1,Taup2(i),X21(i+1,i+1),&
     &                 Ldx21,Work(ilarf))
         ENDIF
         X11(i,i) = ONE
