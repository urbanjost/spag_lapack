!*==zhetrd_he2hb.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Parameters ..
      ...
      PARAMETER (RONE=1.0D+0,ZERO=(0.0D+0,0.0D+0),ONE=(1.0D+0,0.0D+0),  &
     &           HALF=(0.5D+0,0.0D+0))
!     ..
!     .. Local Scalars ..
...
!     .. External Subroutines ..
      EXTERNAL XERBLA , ZHER2K , ZHEMM , ZGEMM , ZCOPY , ZLARFT ,       &
     &         ZGELQF , ZGEQRF , ZLASET
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MIN , MAX
!     ..
