!*==slasd1.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
      CALL SLASD2(Nl,Nr,Sqre,k,D,Work(iz),Alpha,Beta,U,Ldu,Vt,Ldvt,     &
...
!
      ldq = k
      CALL SLASD3(Nl,Nr,Sqre,k,D,Work(iq),ldq,Work(isigma),U,Ldu,       &
