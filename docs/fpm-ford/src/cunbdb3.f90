!*==cunbdb3.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
      REAL Phi(*) , Theta(*)
      COMPLEX Taup1(*) , Taup2(*) , Tauq1(*) , Work(*) , X11(Ldx11,*) , &
     &        X21(Ldx21,*)
!     ..
!
!  ====================================================================
...
!
      DO i = 1 , M - P
!
         IF ( i>1 ) CALL CSROT(Q-i+1,X11(i-1,i),Ldx11,X21(i,i),Ldx11,c, &
     &                         s)
!
         ...
         s = REAL(X21(i,i))
         X21(i,i) = ONE
         CALL CLARF('R',P-i+1,Q-i+1,X21(i,i),Ldx21,Tauq1(i),X11(i,i),   &
     &              Ldx11,Work(ilarf))
         CALL CLARF('R',M-P-i,Q-i+1,X21(i,i),Ldx21,Tauq1(i),X21(i+1,i), &
     &              Ldx21,Work(ilarf))
         CALL CLACGV(Q-i+1,X21(i,i),Ldx21)
         c = SQRT(SCNRM2(P-i+1,X11(i,i),1)**2+SCNRM2(M-P-i,X21(i+1,i),1)&
     &       **2)
         Theta(i) = ATAN2(s,c)
!
         CALL CUNBDB5(P-i+1,M-P-i,Q-i,X11(i,i),1,X21(i+1,i),1,X11(i,i+1)&
     ...
     &                 X21(i+1,i+1),Ldx21,Work(ilarf))
         ENDIF
         X11(i,i) = ONE
         CALL CLARF('L',P-i+1,Q-i,X11(i,i),1,CONJG(Taup1(i)),X11(i,i+1),&
     &              Ldx11,Work(ilarf))
!
      ENDDO
!
