!*==dgesvxx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
      EXTERNAL DGEEQUB , DGETRF , DGETRS , DLACPY , DLAQGE , XERBLA ,   &
     &         DLASCL2 , DGERFSX
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
         CALL DGEEQUB(N,N,A,Lda,R,C,rowcnd,colcnd,amax,infequ)
         IF ( infequ==0 ) THEN
!
