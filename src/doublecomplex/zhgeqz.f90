!*==zhgeqz.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b ZHGEQZ
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Array Arguments ..
      DOUBLE PRECISION Rwork(*)
      COMPLEX*16 Alpha(*) , Beta(*) , H(Ldh,*) , Q(Ldq,*) , T(Ldt,*) ,  &
     &           Work(*) , Z(Ldz,*)
!     ..
!
!  =====================================================================
...
!     .. Local Scalars ..
     ...
     &        jr , maxit
      DOUBLE PRECISION absb , anorm , ascale , atol , bnorm , bscale ,  &
     &                 btol , c , safmin , temp , temp2 , tempr , ulp
      COMPLEX*16 abi22 , ad11 , ad12 , ad21 , ad22 , ctemp , ctemp2 ,   &
     &           ctemp3 , eshift , s , shift , signbc , u12 , x ,       &
     &           abi12 , y
!     ..
!     .. External Functions ..
      COMPLEX*16 ZLADIV
