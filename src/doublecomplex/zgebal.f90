!*==zgebal.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b ZGEBAL
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
      ...
      DOUBLE PRECISION c , ca , f , g , r , ra , s , sfmax1 , sfmax2 ,  &
     &                 sfmin1 , sfmin2
!     ..
!     .. External Functions ..
...
!
         DO i = 1 , l
            IF ( i/=j ) THEN
               IF ( DBLE(A(j,i))/=ZERO .OR. DIMAG(A(j,i))/=ZERO )       &
     &              GOTO 300
            ENDIF
         ENDDO
!
...
!
         DO i = k , l
            IF ( i/=j ) THEN
               IF ( DBLE(A(i,j))/=ZERO .OR. DIMAG(A(i,j))/=ZERO )       &
     &              GOTO 500
            ENDIF
         ENDDO
!
