!*==zlatsqr.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b ZLATSQR
!
!  Definition:
!  ===========
...
!
         CALL ZTPQRT(Mb-N,N,0,Nb,A(1,1),Lda,A(i,1),Lda,T(1,ctr*N+1),Ldt,&
     &               Work,Info)
         ctr = ctr + 1
      ENDDO
!
...
!
      IF ( ii<=M ) CALL ZTPQRT(kk,N,0,Nb,A(1,1),Lda,A(ii,1),Lda,        &
