!*==zgbrfsx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b ZGBRFSX
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
      ...
      INTEGER j , trans_type , prec_type , ref_type , n_norms , ithresh
...
!
      ...
      CALL ZGBCON(norm,N,Kl,Ku,Afb,Ldafb,Ipiv,anorm,Rcond,Work,Rwork,   &
     &            Info)
!
...
!
         IF ( colequ .AND. notran ) THEN
            rcond_tmp = ZLA_GBRCOND_C(Trans,N,Kl,Ku,Ab,Ldab,Afb,Ldafb,  &
...
!
         ...
         DO j = 1 , Nrhs
            IF ( Err_bnds_comp(j,LA_LINRX_ERR_I)<cwise_wrong ) THEN
               rcond_tmp = ZLA_GBRCOND_X(Trans,N,Kl,Ku,Ab,Ldab,Afb,     &
