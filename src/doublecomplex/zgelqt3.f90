!*==zgelqt3.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
         CALL ZGEMM('N','C',m2,m1,N-m1,ONE,A(i1,i1),Lda,A(1,i1),Lda,ONE,&
     &              T(i1,1),Ldt)
!
         CALL ZTRMM('R','U','N','N',m2,m1,ONE,T,Ldt,T(i1,1),Ldt)
!
         CALL ZGEMM('N','N',m2,N-m1,m1,-ONE,T(i1,1),Ldt,A(1,i1),Lda,ONE,&
     &              A(i1,i1),Lda)
!
...
!
         CALL ZGEMM('N','C',m1,m2,N-M,ONE,A(1,j1),Lda,A(i1,j1),Lda,ONE, &
     &              T(1,i1),Ldt)
!
