!*==zhpevd.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
      ...
      ELSE
         CALL ZSTEDC('I',N,W,Rwork(inde),Z,Ldz,Work(indwrk),llwrk,      &
     &               Rwork(indrwk),llrwk,Iwork,Liwork,Info)
         CALL ZUPMTR('L',Uplo,'N',N,N,Ap,Work(indtau),Z,Ldz,Work(indwrk)&
     &               ,iinfo)
      ENDIF
!
