!*==zhesvxx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
      EXTERNAL ZHEEQUB , ZHETRF , ZHETRS , ZLACPY , ZLAQHE , XERBLA ,   &
     &         ZLASCL2 , ZHERFSX
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
            IF ( N>0 ) Rpvgrw = ZLA_HERPVGRW(Uplo,N,Info,A,Lda,Af,Ldaf, &
     &                          Ipiv,Rwork)
            RETURN
         ENDIF
      ENDIF
...
!
      IF ( N>0 ) Rpvgrw = ZLA_HERPVGRW(Uplo,N,Info,A,Lda,Af,Ldaf,Ipiv,  &
     &                    Rwork)
!
