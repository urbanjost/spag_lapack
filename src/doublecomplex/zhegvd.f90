!*==zhegvd.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b ZHEGVD
!
!  =========== DOCUMENTATION ===========
!
...
!
            ...
            ENDIF
!
            CALL ZTRSM('Left',Uplo,trans,'Non-unit',N,N,CONE,B,Ldb,A,   &
     &                 Lda)
!
         ELSEIF ( Itype==3 ) THEN
!
...
!
            ...
            ENDIF
!
            CALL ZTRMM('Left',Uplo,trans,'Non-unit',N,N,CONE,B,Ldb,A,   &
     &                 Lda)
         ENDIF
      ENDIF
!
