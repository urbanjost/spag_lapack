!*==zunbdb3.f90  processed by SPAG 7.51RB at 20:09 on  3 Mar 2022
...
!
      DO i = 1 , M - P
!
         IF ( i>1 ) CALL ZDROT(Q-i+1,X11(i-1,i),Ldx11,X21(i,i),Ldx11,c, &
     &                         s)
!
         ...
         s = DBLE(X21(i,i))
         X21(i,i) = ONE
         CALL ZLARF('R',P-i+1,Q-i+1,X21(i,i),Ldx21,Tauq1(i),X11(i,i),   &
     &              Ldx11,Work(ilarf))
         CALL ZLARF('R',M-P-i,Q-i+1,X21(i,i),Ldx21,Tauq1(i),X21(i+1,i), &
     &              Ldx21,Work(ilarf))
         CALL ZLACGV(Q-i+1,X21(i,i),Ldx21)
         c = SQRT(DZNRM2(P-i+1,X11(i,i),1)**2+DZNRM2(M-P-i,X21(i+1,i),1)&
     &       **2)
         Theta(i) = ATAN2(s,c)
!
         CALL ZUNBDB5(P-i+1,M-P-i,Q-i,X11(i,i),1,X21(i+1,i),1,X11(i,i+1)&
     ...
     &                childinfo)
         ...
         IF ( i<M-P ) THEN
            ...
            s = SIN(Phi(i))
            X21(i+1,i) = ONE
            CALL ZLARF('L',M-P-i,Q-i,X21(i+1,i),1,DCONJG(Taup2(i)),     &
     &                 X21(i+1,i+1),Ldx21,Work(ilarf))
         ENDIF
         X11(i,i) = ONE
         CALL ZLARF('L',P-i+1,Q-i,X11(i,i),1,DCONJG(Taup1(i)),X11(i,i+1)&
     &              ,Ldx11,Work(ilarf))
!
      ENDDO
!
