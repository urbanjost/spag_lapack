!*==zgerqf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZGERQF
!
!  =========== DOCUMENTATION ===========
!
...
!
               CALL ZLARFT('Backward','Rowwise',N-k+i+ib-1,ib,A(M-k+i,1)&
     &                     ,Lda,Tau(i),Work,ldwork)
!
!              Apply H to A(1:m-k+i-1,1:n-k+i+ib-1) from the right
!
               CALL ZLARFB('Right','No transpose','Backward','Rowwise', &
...
!
      IF ( mu>0 .AND. nu>0 ) CALL ZGERQ2(mu,nu,A,Lda,Tau,Work,iinfo)
!
      Work(1) = iws
!
!     End of ZGERQF
