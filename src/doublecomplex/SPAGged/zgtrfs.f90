!*==zgtrfs.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZGTRFS
!
!  =========== DOCUMENTATION ===========
!
...
!
      ...
      REAL(R8KIND) :: eps , lstres , s , safe1 , safe2 , safmin
...
!
                  CALL ZGTTRS(transt,N,1,Dlf,Df,Duf,Du2,Ipiv,Work,N,    &
     &                        Info)
                  DO i = 1 , N
...
!
                  DO i = 1 , N
                     Work(i) = Rwork(i)*Work(i)
                  ENDDO
                  CALL ZGTTRS(transn,N,1,Dlf,Df,Duf,Du2,Ipiv,Work,N,    &
     &                        Info)
               ENDIF
               CYCLE
            ENDIF
