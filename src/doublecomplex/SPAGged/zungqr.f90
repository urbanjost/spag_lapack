!*==zungqr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZUNGQR
!
!  =========== DOCUMENTATION ===========
!
...
!
      IF ( kk<N ) CALL ZUNG2R(M-kk,N-kk,K-kk,A(kk+1,kk+1),Lda,Tau(kk+1),&
     &                        Work,iinfo)
!
      IF ( kk>0 ) THEN
!
...
!
               CALL ZLARFT('Forward','Columnwise',M-i+1,ib,A(i,i),Lda,  &
     &                     Tau(i),Work,ldwork)
!
!              Apply H to A(i:m,i+ib:n) from the left
!
               CALL ZLARFB('Left','No transpose','Forward','Columnwise',&
