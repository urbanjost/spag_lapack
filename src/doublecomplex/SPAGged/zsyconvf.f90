!*==zsyconvf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZSYCONVF
!
!  =========== DOCUMENTATION ===========
!
...
!
                  ...
                  IF ( i<N ) THEN
                     IF ( ip/=(i-1) )                                   &
     &                    CALL ZSWAP(N-i,A(i-1,i+1),Lda,A(ip,i+1),Lda)
                  ENDIF
!
!                 Convert IPIV
...
!
                  ...
                  IF ( i<N ) THEN
                     IF ( ip/=(i-1) )                                   &
     &                    CALL ZSWAP(N-i,A(ip,i+1),Lda,A(i-1,i+1),Lda)
                  ENDIF
!
!                 Convert IPIV
...
!
               ip = -Ipiv(i)
               IF ( i>1 ) THEN
                  IF ( ip/=(i+1) ) CALL ZSWAP(i-1,A(i+1,1),Lda,A(ip,1), &
     &                 Lda)
               ENDIF
!
!                 Convert IPIV
...
!
               ...
               ip = -Ipiv(i)
               IF ( i>1 ) THEN
                  IF ( ip/=(i+1) ) CALL ZSWAP(i-1,A(ip,1),Lda,A(i+1,1), &
     &                 Lda)
               ENDIF
!
!                 Convert IPIV
