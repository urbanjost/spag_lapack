!*==zsytri2x.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZSYTRI2X
!
!  =========== DOCUMENTATION ===========
!
...
!       U11**T*invD1*U11->U11
!
            CALL ZTRMM('L','U','T','U',nnb,nnb,ONE,A(cut+1,cut+1),Lda,  &
     &                 Work(u11+1,1),N+Nb+1)
!
            DO i = 1 , nnb
               DO j = i , nnb
...
!
            CALL ZGEMM('T','N',nnb,nnb,cut,ONE,A(1,cut+1),Lda,Work,     &
...
!        U01 =  U00**T*invD0*U01
!
            CALL ZTRMM('L',Uplo,'T','U',cut,nnb,ONE,A,Lda,Work,N+Nb+1)
...
!       L11**T*invD1*L11->L11
!
            CALL ZTRMM('L',Uplo,'T','U',nnb,nnb,ONE,A(cut+1,cut+1),Lda, &
     &                 Work(u11+1,1),N+Nb+1)
!
            DO i = 1 , nnb
               DO j = 1 , i
...
!
               CALL ZGEMM('T','N',nnb,nnb,N-nnb-cut,ONE,                &
...
!        U01 =  L22**T*invD2*L21
!
               CALL ZTRMM('L',Uplo,'T','U',N-nnb-cut,nnb,ONE,           &
