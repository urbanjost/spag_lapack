!*==zgebrd.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZGEBRD
!
!  =========== DOCUMENTATION ===========
!
...
!        part of the matrix
!
         CALL ZLABRD(M-i+1,N-i+1,nb,A(i,i),Lda,D(i),E(i),Tauq(i),Taup(i)&
...
!
      CALL ZGEBD2(M-i+1,N-i+1,A(i,i),Lda,D(i),E(i),Tauq(i),Taup(i),Work,&
     &            iinfo)
      Work(1) = ws
!
!     End of ZGEBRD
