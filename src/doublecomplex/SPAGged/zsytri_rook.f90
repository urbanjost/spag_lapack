!*==zsytri_rook.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZSYTRI_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
      COMPLEX(CX16KIND) :: ak , akkp1 , akp1 , d , t , temp
      INTEGER :: k , kp , kstep
      LOGICAL :: upper
!
...
!
               IF ( k>1 ) THEN
                  ...
                  CALL ZSYMV(Uplo,k-1,-CONE,A,Lda,Work,1,CZERO,A(1,k),1)
...
!
               IF ( k<N ) THEN
                  ...
                  CALL ZSYMV(Uplo,N-k,-CONE,A(k+1,k+1),Lda,Work,1,CZERO,&
     &                       A(k+1,k),1)
