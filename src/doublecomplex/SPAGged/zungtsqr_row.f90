!*==zungtsqr_row.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      COMPLEX(CX16KIND) , DIMENSION(1,1) :: dummy
...
!
               CALL ZLARFB_GETT('I',imb,N-kb+1,knb,T(1,jb_t+kb-1),Ldt,  &
...
!
            CALL ZLARFB_GETT('N',0,N-kb+1,knb,T(1,kb),Ldt,A(kb,kb),Lda, &
     &                       dummy(1,1),1,Work,knb)
         ELSE
            CALL ZLARFB_GETT('N',mb1-kb-knb+1,N-kb+1,knb,T(1,kb),Ldt,   &
