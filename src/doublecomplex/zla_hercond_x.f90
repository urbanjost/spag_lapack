!*==zla_hercond_x.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
!  =====================================================================
      DOUBLE PRECISION FUNCTION ZLA_HERCOND_X(Uplo,N,A,Lda,Af,Ldaf,Ipiv,&
     &   X,Info,Work,Rwork)
      IMPLICIT NONE
!*--ZLA_HERCOND_X136
!
...
!
         IF ( ainvnm/=0.0D+0 ) ZLA_HERCOND_X = 1.0D+0/ainvnm
         EXIT
      ENDDO
!
!
