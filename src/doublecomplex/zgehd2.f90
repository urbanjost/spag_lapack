!*==zgehd2.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
         CALL ZLARF('Right',Ihi,Ihi-i,A(i+1,i),1,Tau(i),A(1,i+1),Lda,   &
     &              Work)
!
!        Apply H(i)**H to A(i+1:ihi,i+1:n) from the left
!
         CALL ZLARF('Left',Ihi-i,N-i,A(i+1,i),1,DCONJG(Tau(i)),         &
     &              A(i+1,i+1),Lda,Work)
!
         A(i+1,i) = alpha
      ENDDO
