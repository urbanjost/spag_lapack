!*==zunmrq.f90  processed by SPAG 7.51RB at 20:09 on  3 Mar 2022
!> \brief \b ZUNMRQ
!
!  =========== DOCUMENTATION ===========
!
...
!        Use unblocked code
!
         CALL ZUNMR2(Side,Trans,M,N,K,A,Lda,Tau,C,Ldc,Work,iinfo)
      ELSE
!
!        Use blocked code
!
...
!
            CALL ZLARFT('Backward','Rowwise',nq-K+i+ib-1,ib,A(i,1),Lda, &
     &                  Tau(i),Work(iwt),LDT)
            IF ( left ) THEN
!
...
!           Apply H or H**H
!
            CALL ZLARFB(Side,transt,'Backward','Rowwise',mi,ni,ib,A(i,1)&
