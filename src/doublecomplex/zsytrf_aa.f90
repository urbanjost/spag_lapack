!*==zsytrf_aa.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b ZSYTRF_AA
!
!  =========== DOCUMENTATION ===========
!
...
!     .. External Subroutines ..
      EXTERNAL ZLASYF_AA , ZGEMM , ZGEMV , ZSCAL , ZCOPY , ZSWAP ,      &
     &         XERBLA
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX
...
!        Panel factorization
!
            CALL ZLASYF_AA(Uplo,2-k1,N-j,jb,A(MAX(1,j),j+1),Lda,        &
...
!
                     j3 = j2
                     DO mj = nj - 1 , 1 , -1
                        CALL ZGEMV('No transpose',mj,jb+1,-ONE,         &
...
!
                     CALL ZGEMM('Transpose','Transpose',nj,N-j3+1,jb+1, &
...
!        Panel factorization
!
            CALL ZLASYF_AA(Uplo,2-k1,N-j,jb,A(j+1,MAX(1,j)),Lda,        &
     &                     Ipiv(j+1),Work,N,Work(N*nb+1))
!
!        Adjust IPIV and apply it back (J-th step picks (J+1)-th pivot)
!
...
!
                     CALL ZGEMM('No transpose','Transpose',N-j3+1,nj,   &
