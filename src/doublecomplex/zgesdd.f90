!*==zgesdd.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b ZGESDD
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
     ...
     &        mnthr2 , nrwork , nwork , wrkbl
      INTEGER lwork_zgebrd_mn , lwork_zgebrd_mm , lwork_zgebrd_nn ,     &
     &        lwork_zgelqf_mn , lwork_zgeqrf_mn , lwork_zungbr_p_mn ,   &
     &        lwork_zungbr_p_nn , lwork_zungbr_q_mn ,                   &
     &        lwork_zungbr_q_mm , lwork_zunglq_mn , lwork_zunglq_nn ,   &
     &        lwork_zungqr_mm , lwork_zungqr_mn , lwork_zunmbr_prc_mm , &
     &        lwork_zunmbr_qln_mm , lwork_zunmbr_prc_mn ,               &
     &        lwork_zunmbr_qln_mn , lwork_zunmbr_prc_nn ,               &
     &        lwork_zunmbr_qln_nn
