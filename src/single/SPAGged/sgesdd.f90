!*==sgesdd.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SGESDD
!
!  =========== DOCUMENTATION ===========
!
...
!
     ...
     &           ldwrkr , ldwrku , lwork_sgebrd_mm , lwork_sgebrd_mn ,  &
     &           lwork_sgebrd_nn , lwork_sgelqf_mn , lwork_sgeqrf_mn ,  &
     &           lwork_sorgbr_p_mm , lwork_sorgbr_q_nn ,                &
     &           lwork_sorglq_mn , lwork_sorglq_nn , lwork_sorgqr_mm ,  &
     &           lwork_sorgqr_mn , lwork_sormbr_prt_mm ,                &
     &           lwork_sormbr_prt_mn , lwork_sormbr_prt_nn ,            &
     &           lwork_sormbr_qln_mm , lwork_sormbr_qln_mn ,            &
     &           lwork_sormbr_qln_nn , maxwrk , minmn , minwrk , mnthr ,&
     &           nwork , wrkbl
