!*==sorgtsqr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SORGTSQR
!
!  =========== DOCUMENTATION ===========
!
...
!
      INTEGER :: iinfo , j , lc , ldc , lw , lworkopt , nblocal
      LOGICAL :: lquery
!
...
!
      CALL SLAMTSQR('L','N',M,N,N,Mb,nblocal,A,Lda,T,Ldt,Work,ldc,      &
     &              Work(lc+1),lw,iinfo)
!
