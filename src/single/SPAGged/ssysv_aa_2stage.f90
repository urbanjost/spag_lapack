!*==ssysv_aa_2stage.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      USE S_LSAME
      USE S_SSYTRF_AA_2STAGE
      USE S_SSYTRS_AA_2STAGE
      USE S_XERBLA
      IMPLICIT NONE
!*--SSYSV_AA_2STAGE200
!
...
!
      IF ( Info==0 ) THEN
         CALL SSYTRF_AA_2STAGE(Uplo,N,A,Lda,Tb,-1,Ipiv,Ipiv2,Work,-1,   &
     &                         Info)
         lwkopt = INT(Work(1))
      ENDIF
!
...
!
      CALL SSYTRF_AA_2STAGE(Uplo,N,A,Lda,Tb,Ltb,Ipiv,Ipiv2,Work,Lwork,  &
     &                      Info)
!
!        Solve the system A*X = B, overwriting B with X.
!
!
      IF ( Info==0 ) CALL SSYTRS_AA_2STAGE(Uplo,N,Nrhs,A,Lda,Tb,Ltb,    &
