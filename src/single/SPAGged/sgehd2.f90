!*==sgehd2.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
         CALL SLARF('Right',Ihi,Ihi-i,A(i+1,i),1,Tau(i),A(1,i+1),Lda,   &
     &              Work)
!
!        Apply H(i) to A(i+1:ihi,i+1:n) from the left
!
         CALL SLARF('Left',Ihi-i,N-i,A(i+1,i),1,Tau(i),A(i+1,i+1),Lda,  &
     &              Work)
!
         A(i+1,i) = aii
      ENDDO
