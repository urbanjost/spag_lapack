!*==strcon.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b STRCON
!
!  =========== DOCUMENTATION ===========
!
...
!              Multiply by inv(A).
!
                  CALL SLATRS(Uplo,'No transpose',Diag,normin,N,A,Lda,  &
     &                        Work,scale,Work(2*N+1),Info)
               ELSE
!
!              Multiply by inv(A**T).
!
                  CALL SLATRS(Uplo,'Transpose',Diag,normin,N,A,Lda,Work,&
