!*==slasd4.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      REAL :: a , b , c , delsq , delsq2 , dphi , dpsi , dtiim , dtiip ,&
     &        dtipsq , dtisq , dtnsq , dtnsq1 , dw , eps , erretm ,     &
     &        eta , phi , prew , psi , rhoinv , sglb , sgub , sq2 ,     &
     &        tau , tau2 , temp , temp1 , temp2 , w
      REAL , DIMENSION(3) :: dd , zz
