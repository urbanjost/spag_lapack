!*==sla_syrfsx_extended.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
     ...
     &         BLAS_SSYMV2_X , SLA_SYAMV , SLA_WWADDW , SLA_LIN_BERR
      REAL SLAMCH
!     ..
!     .. Intrinsic Functions ..
...
!
            ...
            ELSEIF ( y_prec_state==EXTRA_RESIDUAL ) THEN
               CALL BLAS_SSYMV_X(uplo2,N,-1.0,A,Lda,Y(1,j),1,1.0,Res,1, &
     &                           Prec_type)
            ELSE
               CALL BLAS_SSYMV2_X(uplo2,N,-1.0,A,Lda,Y(1,j),Y_tail,1,   &
     &                            1.0,Res,1,Prec_type)
            ENDIF
