!*==stpmlqt.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DTPMLQT
!
!  =========== DOCUMENTATION ===========
!
...
!
         DO i = 1 , K , Mb
            ...
            ELSE
               lb = 0
            ENDIF
            CALL STPRFB('L','T','F','R',nb,N,ib,lb,V(i,1),Ldv,T(1,i),   &
...
!
         DO i = 1 , K , Mb
            ...
            ELSE
               lb = nb - N + L - i + 1
            ENDIF
            CALL STPRFB('R','N','F','R',M,nb,ib,lb,V(i,1),Ldv,T(1,i),   &
...
!
         ...
         DO i = kf , 1 , -Mb
            ...
            ELSE
               lb = 0
            ENDIF
            CALL STPRFB('L','N','F','R',nb,N,ib,lb,V(i,1),Ldv,T(1,i),   &
     &                  Ldt,A(i,1),Lda,B,Ldb,Work,ib)
         ENDDO
!
...
!
         ...
         DO i = kf , 1 , -Mb
            ...
            ELSE
               lb = nb - N + L - i + 1
            ENDIF
            CALL STPRFB('R','T','F','R',M,nb,ib,lb,V(i,1),Ldv,T(1,i),   &
     &                  Ldt,A(1,i),Lda,B,Ldb,Work,M)
         ENDDO
!
      ENDIF
