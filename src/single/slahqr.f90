!*==slahqr.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     ..
!     .. Local Scalars ..
      REAL aa , ab , ba , bb , cs , det , h11 , h12 , h21 , h21s , h22 ,&
     &     rt1i , rt1r , rt2i , rt2r , rtdisc , s , safmax , safmin ,   &
     &     smlnum , sn , sum , t1 , t2 , t3 , tr , tst , ulp , v2 , v3
...
!
         CALL SLANV2(H(i-1,i-1),H(i-1,i),H(i,i-1),H(i,i),Wr(i-1),Wi(i-1)&
     &               ,Wr(i),Wi(i),cs,sn)
!
         IF ( Wantt ) THEN
!
...
!
         IF ( Wantz ) CALL SROT(nz,Z(Iloz,i-1),1,Z(Iloz,i),1,cs,sn)
      ENDIF
