!*==stgex2.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Arrays ..
      INTEGER iwork(LDST)
      REAL ai(2) , ar(2) , be(2) , ir(LDST,LDST) , ircop(LDST,LDST) ,   &
     &     li(LDST,LDST) , licop(LDST,LDST) , s(LDST,LDST) ,            &
     &     scpy(LDST,LDST) , t(LDST,LDST) , taul(LDST) , taur(LDST) ,   &
     &     tcpy(LDST,LDST)
!     ..
!     .. External Functions ..
      REAL SLAMCH
