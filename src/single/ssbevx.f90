!*==ssbevx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Scalars ..
     ...
     &        indiwo , indwrk , iscale , itmp1 , j , jj , nsplit
...
!
      ...
      inde = indd + N
      indwrk = inde + N
      CALL SSBTRD(Jobz,Uplo,N,Kd,Ab,Ldab,Work(indd),Work(inde),Q,Ldq,   &
     &            Work(indwrk),iinfo)
!
