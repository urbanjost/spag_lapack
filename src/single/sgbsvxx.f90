!*==sgbsvxx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
      EXTERNAL SGBEQUB , SGBTRF , SGBTRS , SLACPY , SLAQGB , XERBLA ,   &
     &         SLASCL2 , SGBRFSX
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
      CALL SGBRFSX(Trans,Equed,N,Kl,Ku,Nrhs,Ab,Ldab,Afb,Ldafb,Ipiv,R,C, &
