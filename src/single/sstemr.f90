!*==sstemr.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SSTEMR
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
     ...
     &        offset , wbegin , wend
      REAL bignum , cs , eps , pivmin , r1 , r2 , rmax , rmin , rtol1 , &
     &     rtol2 , safmin , scale , smlnum , sn , thresh , tmp , tnrm , &
     &     wl , wu
!     ..
!     ..
!     .. External Functions ..
...
!           Copy original diagonal, needed to guarantee relative accuracy
         IF ( Tryrac ) CALL SCOPY(N,D,1,Work(indd),1)
...
!           Note: these settings do only affect the subset case and SLARRE
         ...
         ENDIF
         CALL SLARRE(Range,N,wl,wu,iil,iiu,D,E,Work(inde2),rtol1,rtol2, &
...
!           eigenvalues
!
            CALL SLARRV(N,wl,wu,D,E,pivmin,Iwork(iinspl),M,1,M,MINRGP,  &
...
!              check if any eigenvalues have to be refined in this block
                  ...
                  rtol2 = FOUR*eps
                  CALL SLARRJ(in,Work(indd+ibegin-1),                   &
...
!
         IF ( scale/=ONE ) CALL SSCAL(M,ONE/scale,W,1)
      ENDIF
!
