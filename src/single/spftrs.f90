!*==spftrs.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SPFTRS
!
!  =========== DOCUMENTATION ===========
!
...
!
      IF ( lower ) THEN
         CALL STFSM(Transr,'L',Uplo,'N','N',N,Nrhs,ONE,A,B,Ldb)
         CALL STFSM(Transr,'L',Uplo,'T','N',N,Nrhs,ONE,A,B,Ldb)
      ELSE
         CALL STFSM(Transr,'L',Uplo,'T','N',N,Nrhs,ONE,A,B,Ldb)
         CALL STFSM(Transr,'L',Uplo,'N','N',N,Nrhs,ONE,A,B,Ldb)
      ENDIF
