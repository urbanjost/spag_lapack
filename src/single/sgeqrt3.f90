!*==sgeqrt3.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
         CALL SGEMM('T','N',n1,n2,M-n1,ONE,A(j1,1),Lda,A(j1,j1),Lda,ONE,&
     &              T(1,j1),Ldt)
!
         CALL STRMM('L','U','T','N',n1,n2,ONE,T,Ldt,T(1,j1),Ldt)
!
         CALL SGEMM('N','N',M-n1,n2,n1,-ONE,A(j1,1),Lda,T(1,j1),Ldt,ONE,&
     &              A(j1,j1),Lda)
!
...
!
         CALL SGEMM('T','N',n1,n2,M-N,ONE,A(i1,1),Lda,A(i1,j1),Lda,ONE, &
     &              T(1,j1),Ldt)
!
