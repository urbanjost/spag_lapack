!*==ssytrs_aa.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SSYTRS_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL STRSM('L','U','T','U',N-1,Nrhs,ONE,A(1,2),Lda,B(2,1),  &
     &                 Ldb)
         ENDIF
!
...
!
            CALL STRSM('L','U','N','U',N-1,Nrhs,ONE,A(1,2),Lda,B(2,1),  &
     &                 Ldb)
!
...
!
            CALL STRSM('L','L','N','U',N-1,Nrhs,ONE,A(2,1),Lda,B(2,1),  &
     &                 Ldb)
         ENDIF
!
!        2) Solve with triangular matrix T
...
!
            CALL STRSM('L','L','T','U',N-1,Nrhs,ONE,A(2,1),Lda,B(2,1),  &
     &                 Ldb)
!
