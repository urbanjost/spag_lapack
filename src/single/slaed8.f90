!*==slaed8.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
      ...
      REAL D(*) , Dlamda(*) , Givnum(2,*) , Q(Ldq,*) , Q2(Ldq2,*) ,     &
     &     W(*) , Z(*)
!     ..
!
!  =====================================================================
...
!
               ...
               Givnum(1,Givptr) = c
               Givnum(2,Givptr) = s
               IF ( Icompq==1 ) CALL SROT(Qsiz,Q(1,Indxq(Indx(jlam))),1,&
