!*==sgbsvx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
      INTEGER Ipiv(*) , Iwork(*)
      REAL Ab(Ldab,*) , Afb(Ldafb,*) , B(Ldb,*) , Berr(*) , C(*) ,      &
     &     Ferr(*) , R(*) , Work(*) , X(Ldx,*)
!     ..
!
!  =====================================================================
...
!
      CALL SGBCON(norm,N,Kl,Ku,Afb,Ldafb,Ipiv,anorm,Rcond,Work,Iwork,   &
     &            Info)
!
...
!
      CALL SGBRFS(Trans,N,Kl,Ku,Nrhs,Ab,Ldab,Afb,Ldafb,Ipiv,B,Ldb,X,Ldx,&
