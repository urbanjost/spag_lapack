!*==sgbrfsx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SGBRFSX
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Array Arguments ..
      INTEGER Ipiv(*) , Iwork(*)
      REAL Ab(Ldab,*) , Afb(Ldafb,*) , B(Ldb,*) , X(Ldx,*) , Work(*)
...
!
         IF ( colequ .AND. notran ) THEN
            rcond_tmp = SLA_GBRCOND(Trans,N,Kl,Ku,Ab,Ldab,Afb,Ldafb,    &
