!*==slasd4.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Parameters ..
     ...
     &           FOUR=4.0E+0,EIGHT=8.0E+0,TEN=10.0E+0)
!     ..
!     .. Local Scalars ..
      LOGICAL orgati , swtch , swtch3 , geomavg
      INTEGER ii , iim1 , iip1 , ip1 , iter , j , niter
      REAL a , b , c , delsq , delsq2 , sq2 , dphi , dpsi , dtiim ,     &
     &     dtiip , dtipsq , dtisq , dtnsq , dtnsq1 , dw , eps , erretm ,&
     &     eta , phi , prew , psi , rhoinv , sglb , sgub , tau , tau2 , &
     &     temp , temp1 , temp2 , w
!     ..
!     .. Local Arrays ..
      REAL dd(3) , zz(3)
