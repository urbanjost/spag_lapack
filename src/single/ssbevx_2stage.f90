!*==ssbevx_2stage.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
      EXTERNAL SCOPY , SGEMV , SLACPY , SLASCL , SSCAL , SSTEBZ ,       &
     &         SSTEIN , SSTEQR , SSTERF , SSWAP , XERBLA , SSYTRD_SB2ST
!     ..
!     .. Intrinsic Functions ..
...
!
      CALL SSYTRD_SB2ST("N",Jobz,Uplo,N,Kd,Ab,Ldab,Work(indd),Work(inde)&
