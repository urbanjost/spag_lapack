!*==strsna.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b STRSNA
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Local Scalars ..
      ...
      REAL bignum , cond , cs , delta , dumm , eps , est , lnrm , mu ,  &
     &     prod , prod1 , prod2 , rnrm , scale , smlnum , sn
!     ..
!     .. Local Arrays ..
      INTEGER isave(3)
      REAL dummy(1)
...
!
               ...
               kase = 0
               DO
                  CALL SLACN2(nn,Work(1,N+2),Work(1,N+4),Iwork,est,kase,&
     &                        isave)
                  IF ( kase/=0 ) THEN
                     IF ( kase==1 ) THEN
                        IF ( n2==1 ) THEN
...
!
                        CALL SLAQTR(.FALSE.,.TRUE.,N-1,Work(2,2),Ldwork,&
...
!
                        CALL SLAQTR(.FALSE.,.FALSE.,N-1,Work(2,2),      &
     &                              Ldwork,Work(1,N+1),mu,scale,        &
     &                              Work(1,N+4),Work(1,N+6),ierr)
!
                     ENDIF
