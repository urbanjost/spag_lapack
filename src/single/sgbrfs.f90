!*==sgbrfs.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SGBRFS
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Array Arguments ..
      INTEGER Ipiv(*) , Iwork(*)
      REAL Ab(Ldab,*) , Afb(Ldafb,*) , B(Ldb,*) , Berr(*) , Ferr(*) ,   &
     &     Work(*) , X(Ldx,*)
!     ..
!
!  =====================================================================
...
!
            ...
            CALL SGBMV(Trans,N,N,Kl,Ku,-ONE,Ab,Ldab,X(1,j),1,ONE,       &
     &                 Work(N+1),1)
!
...
!
               CALL SGBTRS(Trans,N,Kl,Ku,1,Afb,Ldafb,Ipiv,Work(N+1),N,  &
     &                     Info)
...
!
                  CALL SGBTRS(transt,N,Kl,Ku,1,Afb,Ldafb,Ipiv,Work(N+1),&
     &                        N,Info)
                  DO i = 1 , N
...
!
                  DO i = 1 , N
                     Work(N+i) = Work(N+i)*Work(i)
                  ENDDO
                  CALL SGBTRS(Trans,N,Kl,Ku,1,Afb,Ldafb,Ipiv,Work(N+1), &
     &                        N,Info)
               ENDIF
               CYCLE
            ENDIF
