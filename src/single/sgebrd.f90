!*==sgebrd.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SGEBRD
!
!  =========== DOCUMENTATION ===========
!
...
!        part of the matrix
!
         CALL SLABRD(M-i+1,N-i+1,nb,A(i,i),Lda,D(i),E(i),Tauq(i),Taup(i)&
...
!
     ...
     &              A(i+nb,i+nb),Lda)
         CALL SGEMM('No transpose','No transpose',M-i-nb+1,N-i-nb+1,nb, &
...
!
      CALL SGEBD2(M-i+1,N-i+1,A(i,i),Lda,D(i),E(i),Tauq(i),Taup(i),Work,&
     &            iinfo)
      Work(1) = ws
!
!     End of SGEBRD
