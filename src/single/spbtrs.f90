!*==spbtrs.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SPBTRS
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL STBSV('Upper','No transpose','Non-unit',N,Kd,Ab,Ldab,  &
     &                 B(1,j),1)
         ENDDO
      ELSE
!
...
!
            CALL STBSV('Lower','No transpose','Non-unit',N,Kd,Ab,Ldab,  &
     &                 B(1,j),1)
!
