!*==shgeqz.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b SHGEQZ
!
!  =========== DOCUMENTATION ===========
!
...
!     ..
!     .. Array Arguments ..
      REAL Alphai(*) , Alphar(*) , Beta(*) , H(Ldh,*) , Q(Ldq,*) ,      &
     &     T(Ldt,*) , Work(*) , Z(Ldz,*)
!     ..
!
!  =====================================================================
...
!     .. Local Scalars ..
     ...
     &     ad11l , ad12 , ad12l , ad21 , ad21l , ad22 , ad22l , ad32l , &
     &     an , anorm , ascale , atol , b11 , b1a , b1i , b1r , b22 ,   &
     &     b2a , b2i , b2r , bn , bnorm , bscale , btol , c , c11i ,    &
     &     c11r , c12 , c21 , c22i , c22r , cl , cq , cr , cz , eshift ,&
     &     s , s1 , s1inv , s2 , safmax , safmin , scale , sl , sqi ,   &
     &     sqr , sr , szi , szr , t1 , tau , temp , temp2 , tempi ,     &
     &     tempr , u1 , u12 , u12l , u2 , ulp , vs , w11 , w12 , w21 ,  &
     &     w22 , wabs , wi , wr , wr2
!     ..
!     .. Local Arrays ..
      REAL v(3)
...
!
 20         temp = H(ilast,ilast)
            ...
            H(ilast,ilast-1) = ZERO
            CALL SROT(ilast-ifrstm,H(ifrstm,ilast),1,H(ifrstm,ilast-1), &
     &                1,c,s)
            CALL SROT(ilast-ifrstm,T(ifrstm,ilast),1,T(ifrstm,ilast-1), &
     &                1,c,s)
...
!           (Single shift only.)
!
               IF ( (REAL(maxit)*safmin)*ABS(H(ilast,ilast-1))          &
     &              <ABS(T(ilast-1,ilast-1)) ) THEN
...
!
               CALL SLAG2(H(ilast-1,ilast-1),Ldh,T(ilast-1,ilast-1),Ldt,&
...
!
                     IF ( ilq ) CALL SROT(N,Q(1,ilast-1),1,Q(1,ilast),1,&
     &                    cl,sl)
                     IF ( ilz ) CALL SROT(N,Z(1,ilast-1),1,Z(1,ilast),1,&
     &                    cr,sr)
!
