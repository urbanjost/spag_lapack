!*==clatzm.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CLATZM
!
!  =========== DOCUMENTATION ===========
!
...
!
         ...
         CALL CGEMV('Conjugate transpose',M-1,N,ONE,C2,Ldc,V,Incv,ONE,  &
     &              Work,1)
!
!        [ C1 ] := [ C1 ] - tau* [ 1 ] * w**H
!        [ C2 ]    [ C2 ]        [ v ]
...
!
         ...
         CALL CGEMV('No transpose',M,N-1,ONE,C2,Ldc,V,Incv,ONE,Work,1)
!
