!*==sgelsx.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
         CALL SORM2R('Left','Transpose',M,Nrhs,mn,A,Lda,Work(1),B,Ldb,  &
     &               Work(2*mn+1),Info)
!
!     workspace NRHS
!
