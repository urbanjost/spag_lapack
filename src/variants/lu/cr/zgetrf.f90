...
!> \brief \b ZGETRF VARIANT: Crout Level 3 BLAS version of the algorithm.
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL ZGEMM('No transpose','No transpose',M-j+1,jb,j-1,-ONE, &
...
!
               CALL ZGEMM('No transpose','No transpose',jb,N-j-jb+1,j-1,&
