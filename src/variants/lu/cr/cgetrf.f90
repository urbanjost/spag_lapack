!*==cgetrf.f90  processed by SPAG 7.51RB at 20:37 on  3 Mar 2022
!> \brief \b CGETRF VARIANT: Crout Level 3 BLAS version of the algorithm.
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CGEMM('No transpose','No transpose',M-j+1,jb,j-1,-ONE, &
...
!
               CALL CGEMM('No transpose','No transpose',jb,N-j-jb+1,j-1,&
