!*==spotrf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b SPOTRF VARIANT: top-looking block version of the algorithm, calling Level 3 BLAS.
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL STRSM('Left','Upper','Transpose','Non-unit',j-1,jb,ONE,&
     &                 A(1,1),Lda,A(1,j),Lda)
...
!              Compute the current block.
!
            CALL STRSM('Right','Lower','Transpose','Non-unit',jb,j-1,   &
