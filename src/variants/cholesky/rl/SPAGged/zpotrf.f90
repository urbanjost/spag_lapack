!*==zpotrf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b ZPOTRF VARIANT: right looking block version of the algorithm, calling Level 3 BLAS.
!
!  =========== DOCUMENTATION ===========
!
...
!
     ...
     &                    A(j,j+jb),Lda)
               CALL ZHERK('Upper','Conjugate transpose',N-j-jb+1,jb,    &
...
!
     ...
     &                    A(j+jb,j),Lda)
               ...
               CALL ZHERK('Lower','No Transpose',N-j-jb+1,jb,-ONE,      &
