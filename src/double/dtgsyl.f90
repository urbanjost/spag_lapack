!*==dtgsyl.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DTGSYL
!
!  =========== DOCUMENTATION ===========
!
...
!
            ...
            dsum = ONE
            pq = 0
            CALL DTGSY2(Trans,ifunc,M,N,A,Lda,B,Ldb,C,Ldc,D,Ldd,E,Lde,F,&
...
!
            ...
            DO j = p + 2 , q
               ...
               DO i = p , 1 , -1
                  ...
                  mb = ie - is + 1
                  ppqq = 0
                  CALL DTGSY2(Trans,ifunc,mb,nb,A(is,is),Lda,B(js,js),  &
...
!
     ...
     &                          C(is,js),Ldc,ONE,F(1,js),Ldf)
                  ENDIF
                  IF ( j<q ) THEN
                     CALL DGEMM('N','N',mb,N-je,nb,ONE,F(is,js),Ldf,    &
...
!
         ...
         DO i = 1 , p
            ...
            DO j = q , p + 2 , -1
               ...
               je = Iwork(j+1) - 1
               nb = je - js + 1
               CALL DTGSY2(Trans,ifunc,mb,nb,A(is,is),Lda,B(js,js),Ldb, &
...
!
               IF ( j>p+2 ) THEN
                  CALL DGEMM('N','T',mb,js-1,nb,ONE,C(is,js),Ldc,B(1,js)&
     &                       ,Ldb,ONE,F(is,1),Ldf)
                  CALL DGEMM('N','T',mb,js-1,nb,ONE,F(is,js),Ldf,E(1,js)&
     &                       ,Lde,ONE,F(is,1),Ldf)
               ENDIF
               IF ( i<p ) THEN
