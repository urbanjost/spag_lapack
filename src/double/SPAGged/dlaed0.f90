!*==dlaed0.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &                     Info)
               IF ( Info/=0 ) GOTO 100
               IF ( Icompq==1 ) CALL DGEMM('N','N',Qsiz,matsiz,matsiz,  &
...
!
               IF ( Icompq==2 ) THEN
                  CALL DLAED1(matsiz,D(submat),Q(submat,submat),Ldq,    &
