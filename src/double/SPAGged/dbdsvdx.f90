!*==dbdsvdx.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DBDSVDX
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL(R8KIND) :: abstol , emin , eps , mu , nrmu , nrmv , ortol ,  &
     &                smax , smin , sqrt2 , thresh , tol , ulp , vltgk ,&
     &                vutgk , zjtji
      LOGICAL :: allsv , indsv , lower , split , sveq0 , valsv , wantz
      INTEGER :: i , icolz , idbeg , idend , idptr , idtgk , ieptr ,    &
     &           ietgk , iifail , iiwork , iltgk , irowu , irowv ,      &
     &           irowz , isbeg , isplt , itemp , iutgk , j , k , nru ,  &
     &           nrv , nsl , ntgk
      CHARACTER :: rngvx
!
