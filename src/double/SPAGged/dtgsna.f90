!*==dtgsna.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DTGSNA
!
!  =========== DOCUMENTATION ===========
!
...
!
      REAL(R8KIND) :: alphai , alphar , alprqt , beta , c1 , c2 , cond ,&
     &                eps , lnrm , rnrm , root1 , root2 , scale ,       &
     &                smlnum , tmpii , tmpir , tmpri , tmprr , uhav ,   &
     &                uhavi , uhbv , uhbvi
      REAL(R8KIND) , DIMENSION(1) :: dummy , dummy1
...
!
               ...
               Work(7) = B(k,k+1)
               Work(8) = B(k+1,k+1)
               CALL DLAG2(Work,2,Work(5),2,smlnum*eps,beta,dummy1(1),   &
...
!
            ...
            ilst = 1
!
            CALL DTGEXC(.FALSE.,.FALSE.,N,Work,N,Work(N*N+1),N,dummy,1, &
...
!
               ...
               ELSE
                  i = N*N + 1
                  iz = 2*N*N + 1
                  CALL DTGSYL('N',DIFDRI,n2,n1,Work(N*n1+n1+1),N,Work,N,&
