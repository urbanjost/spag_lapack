!*==dspevd.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      ...
      ELSE
         ...
         CALL DSTEDC('I',N,W,Work(inde),Z,Ldz,Work(indwrk),llwork,Iwork,&
     &               Liwork,Info)
         CALL DOPMTR('L',Uplo,'N',N,N,Ap,Work(indtau),Z,Ldz,Work(indwrk)&
     &               ,iinfo)
      ENDIF
!
