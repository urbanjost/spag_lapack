!*==dpbtrf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DPBTRF
!
!  =========== DOCUMENTATION ===========
!
...
!
      ...
      REAL(R8KIND) , DIMENSION(LDWORK,NBMAX) :: work
!
...
!                    Update A33
!
                  CALL DSYRK('Upper','Transpose',i3,ib,-ONE,work,LDWORK,&
...
!                    Update A21
!
                  CALL DTRSM('Right','Lower','Transpose','Non-unit',i2, &
...
!
                  CALL DTRSM('Right','Lower','Transpose','Non-unit',i3, &
