!*==dsytrs_aa.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DSYTRS_AA
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL DTRSM('L','U','T','U',N-1,Nrhs,ONE,A(1,2),Lda,B(2,1),  &
     &                 Ldb)
         ENDIF
!
...
!
            CALL DTRSM('L','U','N','U',N-1,Nrhs,ONE,A(1,2),Lda,B(2,1),  &
     &                 Ldb)
!
...
!
            CALL DTRSM('L','L','N','U',N-1,Nrhs,ONE,A(2,1),Lda,B(2,1),  &
     &                 Ldb)
         ENDIF
!
!        2) Solve with triangular matrix T
...
!
            CALL DTRSM('L','L','T','U',N-1,Nrhs,ONE,A(2,1),Lda,B(2,1),  &
     &                 Ldb)
!
