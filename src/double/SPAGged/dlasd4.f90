!*==dlasd4.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      REAL(R8KIND) :: a , b , c , delsq , delsq2 , dphi , dpsi , dtiim ,&
     &                dtiip , dtipsq , dtisq , dtnsq , dtnsq1 , dw ,    &
     &                eps , erretm , eta , phi , prew , psi , rhoinv ,  &
     &                sglb , sgub , sq2 , tau , tau2 , temp , temp1 ,   &
     &                temp2 , w
      REAL(R8KIND) , DIMENSION(3) :: dd , zz
      LOGICAL :: geomavg , orgati , swtch , swtch3
