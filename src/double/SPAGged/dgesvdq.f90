!*==dgesvdq.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
     ...
     &           rtrans , wntua , wntuf , wntur , wntus , wntva , wntvr
      ...
      INTEGER :: ierr , iminwrk , iwoff , lwcon , lwlqf , lworlq ,      &
     &           lworq , lworq2 , lwqp3 , lwqrf , lwrk_dgelqf ,         &
     &           lwrk_dgeqp3 , lwrk_dgeqrf , lwrk_dgesvd ,              &
     &           lwrk_dgesvd2 , lwrk_dormlq , lwrk_dormqr ,             &
     &           lwrk_dormqr2 , lwsvd , lwsvd2 , minwrk , minwrk2 , n1 ,&
     &           nr , optratio , optwrk , optwrk2 , p , q , rminwrk
