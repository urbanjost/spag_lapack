!*==dsysv_aa_2stage.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      USE F77KINDS                        
      USE S_DSYTRF_AA_2STAGE
      USE S_DSYTRS_AA_2STAGE
      USE S_LSAME
      USE S_XERBLA
      IMPLICIT NONE
!*--DSYSV_AA_2STAGE202
...
!
      IF ( Info==0 ) THEN
         CALL DSYTRF_AA_2STAGE(Uplo,N,A,Lda,Tb,-1,Ipiv,Ipiv2,Work,-1,   &
     &                         Info)
         lwkopt = INT(Work(1))
      ENDIF
!
...
!
      CALL DSYTRF_AA_2STAGE(Uplo,N,A,Lda,Tb,Ltb,Ipiv,Ipiv2,Work,Lwork,  &
     &                      Info)
!
!        Solve the system A*X = B, overwriting B with X.
!
!
      IF ( Info==0 ) CALL DSYTRS_AA_2STAGE(Uplo,N,Nrhs,A,Lda,Tb,Ltb,    &
