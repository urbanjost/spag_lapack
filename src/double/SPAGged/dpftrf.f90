!*==dpftrf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DPFTRF
!
!  =========== DOCUMENTATION ===========
!
...
!
               ...
               IF ( Info>0 ) RETURN
               CALL DTRSM('R','L','T','N',n2,n1,ONE,A(0),N,A(n1),N)
               CALL DSYRK('U','N',n2,n1,-ONE,A(n1),N,ONE,A(N),N)
...
!
               ...
               IF ( Info>0 ) RETURN
               CALL DTRSM('L','L','N','N',n1,n2,ONE,A(n2),N,A(0),N)
               CALL DSYRK('U','T',n2,n1,-ONE,A(0),N,ONE,A(n1),N)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL DTRSM('L','U','T','N',n1,n2,ONE,A(0),n1,A(n1*n1),n1)
            CALL DSYRK('L','T',n2,n1,-ONE,A(n1*n1),n1,ONE,A(1),n1)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL DTRSM('R','U','N','N',n2,n1,ONE,A(n2*n2),n2,A(0),n2)
            CALL DSYRK('L','N',n2,n1,-ONE,A(0),n2,ONE,A(n1*n2),n2)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL DTRSM('R','L','T','N',k,k,ONE,A(1),N+1,A(k+1),N+1)
            CALL DSYRK('U','N',k,k,-ONE,A(k+1),N+1,ONE,A(0),N+1)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL DTRSM('L','L','N','N',k,k,ONE,A(k+1),N+1,A(0),N+1)
            CALL DSYRK('U','T',k,k,-ONE,A(0),N+1,ONE,A(k),N+1)
...
!
         ...
         IF ( Info>0 ) RETURN
         CALL DTRSM('L','U','T','N',k,k,ONE,A(k),n1,A(k*(k+1)),k)
         CALL DSYRK('L','T',k,k,-ONE,A(k*(k+1)),k,ONE,A(0),k)
...
!
         ...
         IF ( Info>0 ) RETURN
         CALL DTRSM('R','U','N','N',k,k,ONE,A(k*(k+1)),k,A(0),k)
         CALL DSYRK('L','N',k,k,-ONE,A(0),k,ONE,A(k*k),k)
