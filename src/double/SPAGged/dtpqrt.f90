!*==dtpqrt.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b DTPQRT
!
!  =========== DOCUMENTATION ===========
!
...
!
         ...
         ENDIF
!
         CALL DTPQRT2(mb,ib,lb,A(i,i),Lda,B(1,i),Ldb,T(1,i),Ldt,iinfo)
!
!     Update by applying H**T to B(:,I+IB:N) from the left
!
         IF ( i+ib<=N ) CALL DTPRFB('L','T','F','C',mb,N-i-ib+1,ib,lb,  &
