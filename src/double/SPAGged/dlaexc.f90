!*==dlaexc.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
...
!
      REAL(R8KIND) :: cs , dnorm , eps , scale , smlnum , sn , t11 ,    &
     &                t22 , t33 , tau , tau1 , tau2 , temp , thresh ,   &
     &                wi1 , wi2 , wr1 , wr2 , xnorm
      REAL(R8KIND) , DIMENSION(LDD,4) :: d
      INTEGER :: ierr , j2 , j3 , j4 , k , nd
      REAL(R8KIND) , DIMENSION(3) :: u , u1 , u2
      REAL(R8KIND) , DIMENSION(LDX,2) :: x
!
