!*==dlarre.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
      ...
      DOUBLE PRECISION D(*) , E(*) , E2(*) , Gers(*) , W(*) , Werr(*) , &
     &                 Wgap(*) , Work(*)
!     ..
!
!  =====================================================================
...
!     .. Parameters ..
     ...
     &           HNDRD=100.0D0,PERT=8.0D0,HALF=ONE/TWO,FOURTH=ONE/FOUR, &
     &           FAC=HALF,MAXGROWTH=64.0D0,FUDGE=2.0D0)
