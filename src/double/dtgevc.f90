!*==dtgevc.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DTGEVC
!
!  =========== DOCUMENTATION ===========
!
...
!     .. Array Arguments ..
      LOGICAL Select(*)
      DOUBLE PRECISION P(Ldp,*) , S(Lds,*) , Vl(Ldvl,*) , Vr(Ldvr,*) ,  &
     &                 Work(*)
!     ..
!
!
...
!     .. Local Scalars ..
     ...
     &        ja , jc , je , jr , jw , na , nw
      DOUBLE PRECISION acoef , acoefa , anorm , ascale , bcoefa ,       &
     &                 bcoefi , bcoefr , big , bignum , bnorm , bscale ,&
     &                 cim2a , cim2b , cimaga , cimagb , cre2a , cre2b ,&
     &                 creala , crealb , dmin , safmin , salfar ,       &
