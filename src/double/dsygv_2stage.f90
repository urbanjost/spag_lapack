!*==dsygv_2stage.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
            ...
            ENDIF
!
            CALL DTRSM('Left',Uplo,trans,'Non-unit',N,neig,ONE,B,Ldb,A, &
     &                 Lda)
!
         ELSEIF ( Itype==3 ) THEN
!
...
!
            ...
            ENDIF
!
            CALL DTRMM('Left',Uplo,trans,'Non-unit',N,neig,ONE,B,Ldb,A, &
     &                 Lda)
         ENDIF
      ENDIF
!
