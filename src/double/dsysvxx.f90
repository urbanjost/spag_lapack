!*==dsysvxx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DSYSVXX
!
!  =========== DOCUMENTATION ===========
!
...
!     .. External Subroutines ..
      EXTERNAL DSYEQUB , DSYTRF , DSYTRS , DLACPY , DLAQSY , XERBLA ,   &
     &         DLASCL2 , DSYRFSX
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
            IF ( N>0 ) Rpvgrw = DLA_SYRPVGRW(Uplo,N,Info,A,Lda,Af,Ldaf, &
     &                          Ipiv,Work)
            RETURN
         ENDIF
      ENDIF
...
!
      IF ( N>0 ) Rpvgrw = DLA_SYRPVGRW(Uplo,N,Info,A,Lda,Af,Ldaf,Ipiv,  &
     &                    Work)
!
...
!
      CALL DSYRFSX(Uplo,Equed,N,Nrhs,A,Lda,Af,Ldaf,Ipiv,S,B,Ldb,X,Ldx,  &
     &             Rcond,Berr,N_err_bnds,Err_bnds_norm,Err_bnds_comp,   &
     &             Nparams,Params,Work,Iwork,Info)
!
!     Scale solutions.
!
      IF ( rcequ ) CALL DLASCL2(N,Nrhs,S,X,Ldx)
!
!
!     End of DSYSVXX
!
