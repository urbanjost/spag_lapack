!*==dtgex2.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Scalars ..
      ...
      DOUBLE PRECISION bqra21 , brqa21 , ddum , dnorma , dnormb ,       &
...
!     .. Local Arrays ..
     ...
     &                 licop(LDST,LDST) , s(LDST,LDST) , scpy(LDST,LDST)&
     &                 , t(LDST,LDST) , taul(LDST) , taur(LDST) ,       &
     &                 tcpy(LDST,LDST)
!     ..
!     .. External Functions ..
