!*==dorbdb6.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Parameters ..
      ...
      PARAMETER (ALPHASQ=0.01D0,REALONE=1.0D0,REALZERO=0.0D0)
...
!
      CALL DGEMV('N',M1,N,NEGONE,Q1,Ldq1,Work,1,ONE,X1,Incx1)
      CALL DGEMV('N',M2,N,NEGONE,Q2,Ldq2,Work,1,ONE,X2,Incx2)
!
      scl1 = REALZERO
      ssq1 = REALONE
      CALL DLASSQ(M1,X1,Incx1,scl1,ssq1)
