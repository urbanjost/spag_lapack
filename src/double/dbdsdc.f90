!*==dbdsdc.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
      INTEGER Iq(*) , Iwork(*)
      DOUBLE PRECISION D(*) , E(*) , Q(*) , U(Ldu,*) , Vt(Ldvt,*) ,     &
     &                 Work(*)
!     ..
!
!  =====================================================================
...
!     ..
!     .. Local Scalars ..
      INTEGER difl , difr , givcol , givnum , givptr , i , ic , icompq ,&
     &        ierr , ii , is , iu , iuplo , ivt , j , k , kk , mlvl ,   &
     &        nm1 , nsize , perm , poles , qstart , smlsiz , smlszp ,   &
     &        sqre , start , wstart , z
