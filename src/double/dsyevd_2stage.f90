!*==dsyevd_2stage.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
     ...
     &        liwmin , llwork , llwrk2 , lwmin , lhtrd , lwtrd , kd ,   &
     &        ib , indhous
...
!
      CALL DSYTRD_2STAGE(Jobz,Uplo,N,A,Lda,W,Work(inde),Work(indtau),   &
...
!        let it getting here
     ...
     &               llwrk2,Iwork,Liwork,Info)
         CALL DORMTR('L',Uplo,'N',N,N,A,Lda,Work(indtau),Work(indwrk),N,&
