!*==dpftri.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DPFTRI
!
!  =========== DOCUMENTATION ===========
!
...
!
               ...
               CALL DSYRK('L','T',n1,n2,ONE,A(n1),N,ONE,A(0),N)
               CALL DTRMM('L','U','N','N',n2,n1,ONE,A(N),N,A(n1),N)
...
!
               ...
               CALL DSYRK('L','N',n1,n2,ONE,A(0),N,ONE,A(n2),N)
               CALL DTRMM('R','U','T','N',n1,n2,ONE,A(n1),N,A(0),N)
...
!
            ...
            CALL DSYRK('U','N',n1,n2,ONE,A(n1*n1),n1,ONE,A(0),n1)
            CALL DTRMM('R','L','N','N',n1,n2,ONE,A(1),n1,A(n1*n1),n1)
...
!
            ...
            CALL DSYRK('U','T',n1,n2,ONE,A(0),n2,ONE,A(n2*n2),n2)
            CALL DTRMM('L','L','T','N',n2,n1,ONE,A(n1*n2),n2,A(0),n2)
...
!
            ...
            CALL DSYRK('L','T',k,k,ONE,A(k+1),N+1,ONE,A(1),N+1)
            CALL DTRMM('L','U','N','N',k,k,ONE,A(0),N+1,A(k+1),N+1)
...
!
            ...
            CALL DSYRK('L','N',k,k,ONE,A(0),N+1,ONE,A(k+1),N+1)
            CALL DTRMM('R','U','T','N',k,k,ONE,A(k),N+1,A(0),N+1)
...
!
         ...
         CALL DSYRK('U','N',k,k,ONE,A(k*(k+1)),k,ONE,A(k),k)
         CALL DTRMM('R','L','N','N',k,k,ONE,A(0),k,A(k*(k+1)),k)
...
!
         ...
         CALL DSYRK('U','T',k,k,ONE,A(0),k,ONE,A(k*(k+1)),k)
         CALL DTRMM('L','L','T','N',k,k,ONE,A(k*k),k,A(0),k)
