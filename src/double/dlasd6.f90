!*==dlasd6.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
      ...
      DOUBLE PRECISION D(*) , Difl(*) , Difr(*) , Givnum(Ldgnum,*) ,    &
...
!
      CALL DLASD7(Icompq,Nl,Nr,Sqre,K,D,Z,Work(iw),Vf,Work(ivfw),Vl,    &
...
!
      CALL DLASD8(Icompq,K,D,Z,Vf,Vl,Difl,Difr,Ldgnum,Work(isigma),     &
     &            Work(iw),Info)
!
