!*==dtpmqrt.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DTPMQRT
!
!  =========== DOCUMENTATION ===========
!
...
!     ..
!     .. Array Arguments ..
      DOUBLE PRECISION V(Ldv,*) , A(Lda,*) , B(Ldb,*) , T(Ldt,*) ,      &
     &                 Work(*)
!     ..
!
!  =====================================================================
...
!
         DO i = 1 , K , Nb
            ...
            ELSE
               lb = mb - M + L - i + 1
            ENDIF
            CALL DTPRFB('L','T','F','C',mb,N,ib,lb,V(1,i),Ldv,T(1,i),   &
...
!
         DO i = 1 , K , Nb
            ...
            ELSE
               lb = mb - N + L - i + 1
            ENDIF
            CALL DTPRFB('R','N','F','C',M,mb,ib,lb,V(1,i),Ldv,T(1,i),   &
...
!
         ...
         DO i = kf , 1 , -Nb
            ...
            ELSE
               lb = mb - M + L - i + 1
            ENDIF
            CALL DTPRFB('L','N','F','C',mb,N,ib,lb,V(1,i),Ldv,T(1,i),   &
     &                  Ldt,A(i,1),Lda,B,Ldb,Work,ib)
         ENDDO
!
...
!
         ...
         DO i = kf , 1 , -Nb
            ...
            ELSE
               lb = mb - N + L - i + 1
            ENDIF
            CALL DTPRFB('R','T','F','C',M,mb,ib,lb,V(1,i),Ldv,T(1,i),   &
     &                  Ldt,A(1,i),Lda,B,Ldb,Work,M)
         ENDDO
!
      ENDIF
