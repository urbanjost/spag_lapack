!*==dspevx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Scalars ..
     ...
     &        indiwo , indtau , indwrk , iscale , itmp1 , j , jj ,      &
     &        nsplit
...
!
         CALL DOPMTR('L',Uplo,'N',N,M,Ap,Work(indtau),Z,Ldz,Work(indwrk)&
     &               ,iinfo)
      ENDIF
!
