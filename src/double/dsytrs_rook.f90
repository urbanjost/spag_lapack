!*==dsytrs_rook.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DSYTRS_ROOK
!
!  =========== DOCUMENTATION ===========
!
...
!
               IF ( k>2 ) THEN
                  CALL DGER(k-2,Nrhs,-ONE,A(1,k),1,B(k,1),Ldb,B(1,1),   &
     &                      Ldb)
...
!           stored in column K of A.
!
               IF ( k>1 ) CALL DGEMV('Transpose',k-1,Nrhs,-ONE,B,Ldb,   &
