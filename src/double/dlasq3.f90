!*==dlasq3.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Parameters ..
      ...
      PARAMETER (ZERO=0.0D0,QURTR=0.250D0,HALF=0.5D0,ONE=1.0D0,         &
...
!
!
               CALL DLASQ5(I0,N0,Z,Pp,Tau,Sigma,Dmin,Dmin1,Dmin2,Dn,Dn1,&
     &                     Dn2,Ieee,eps)
!
               Ndiv = Ndiv + (N0-I0+2)
               Iter = Iter + 1
...
!     Risk of underflow.
!
 300  CALL DLASQ6(I0,N0,Z,Pp,Dmin,Dmin1,Dmin2,Dn,Dn1,Dn2)
      Ndiv = Ndiv + (N0-I0+2)
      Iter = Iter + 1
      Tau = ZERO
!
