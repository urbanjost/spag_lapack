!*==dlaswlq.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b DLASWLQ
!
!  Definition:
!  ===========
...
!
         CALL DTPLQT(M,Nb-M,0,Mb,A(1,1),Lda,A(1,i),Lda,T(1,ctr*M+1),Ldt,&
     &               Work,Info)
         ctr = ctr + 1
      ENDDO
!
...
!
      IF ( ii<=N ) CALL DTPLQT(M,kk,0,Mb,A(1,1),Lda,A(1,ii),Lda,        &
