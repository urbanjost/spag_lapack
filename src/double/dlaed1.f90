!*==dlaed1.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     Deflate eigenvalues.
!
      CALL DLAED2(k,N,Cutpnt,D,Q,Ldq,Indxq,Rho,Work(iz),Work(idlmda),   &
...
!
     ...
     &           + iq2
            CALL DLAED3(k,N,Cutpnt,D,Q,Ldq,Rho,Work(idlmda),Work(iq2),  &
