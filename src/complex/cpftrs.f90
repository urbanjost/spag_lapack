!*==cpftrs.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CPFTRS
!
!  =========== DOCUMENTATION ===========
!
...
!
      IF ( lower ) THEN
         CALL CTFSM(Transr,'L',Uplo,'N','N',N,Nrhs,CONE,A,B,Ldb)
         CALL CTFSM(Transr,'L',Uplo,'C','N',N,Nrhs,CONE,A,B,Ldb)
      ELSE
         CALL CTFSM(Transr,'L',Uplo,'C','N',N,Nrhs,CONE,A,B,Ldb)
         CALL CTFSM(Transr,'L',Uplo,'N','N',N,Nrhs,CONE,A,B,Ldb)
      ENDIF
