!*==chbevx_2stage.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Local Scalars ..
     ...
     &        indiwk , indrwk , indwrk , iscale , itmp1 , llwork ,      &
     &        lwmin , lhtrd , lwtrd , ib , indhous , j , jj , nsplit
...
!     .. External Subroutines ..
     ...
     &         CGEMV , CLACPY , CLASCL , CSTEIN , CSTEQR , CSWAP ,      &
     &         CHETRD_HB2ST
!     ..
!     .. Intrinsic Functions ..
...
!
      CALL CHETRD_HB2ST('N',Jobz,Uplo,N,Kd,Ab,Ldab,Rwork(indd),         &
     &                  Rwork(inde),Work(indhous),lhtrd,Work(indwrk),   &
     &                  llwork,iinfo)
!
