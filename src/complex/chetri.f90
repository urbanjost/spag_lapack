!*==chetri.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CHETRI
!
!  =========== DOCUMENTATION ===========
!
...
!
               IF ( k>1 ) THEN
                  ...
                  CALL CHEMV(Uplo,k-1,-CONE,A,Lda,Work,1,ZERO,A(1,k),1)
...
!
               IF ( k<N ) THEN
                  ...
                  CALL CHEMV(Uplo,N-k,-CONE,A(k+1,k+1),Lda,Work,1,ZERO, &
     &                       A(k+1,k),1)
