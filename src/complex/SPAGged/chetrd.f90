!*==chetrd.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CHETRD
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CHER2K(Uplo,'No transpose',i-1,nb,-CONE,A(1,i),Lda,    &
...
!           the matrix
!
            CALL CLATRD(Uplo,N-i+1,nb,A(i,i),Lda,E(i),Tau(i),Work,      &
     &                  ldwork)
!
!           Update the unreduced submatrix A(i+nb:n,i+nb:n), using
!           an update of the form:  A := A - V*W**H - W*V**H
!
            CALL CHER2K(Uplo,'No transpose',N-i-nb+1,nb,-CONE,A(i+nb,i),&
