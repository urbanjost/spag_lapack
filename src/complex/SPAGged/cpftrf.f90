!*==cpftrf.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CPFTRF
!
!  =========== DOCUMENTATION ===========
!
...
!
               ...
               IF ( Info>0 ) RETURN
               CALL CTRSM('R','L','C','N',n2,n1,CONE,A(0),N,A(n1),N)
               CALL CHERK('U','N',n2,n1,-ONE,A(n1),N,ONE,A(N),N)
...
!
               ...
               IF ( Info>0 ) RETURN
               CALL CTRSM('L','L','N','N',n1,n2,CONE,A(n2),N,A(0),N)
               CALL CHERK('U','C',n2,n1,-ONE,A(0),N,ONE,A(n1),N)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL CTRSM('L','U','C','N',n1,n2,CONE,A(0),n1,A(n1*n1),n1)
            CALL CHERK('L','C',n2,n1,-ONE,A(n1*n1),n1,ONE,A(1),n1)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL CTRSM('R','U','N','N',n2,n1,CONE,A(n2*n2),n2,A(0),n2)
            CALL CHERK('L','N',n2,n1,-ONE,A(0),n2,ONE,A(n1*n2),n2)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL CTRSM('R','L','C','N',k,k,CONE,A(1),N+1,A(k+1),N+1)
            CALL CHERK('U','N',k,k,-ONE,A(k+1),N+1,ONE,A(0),N+1)
...
!
            ...
            IF ( Info>0 ) RETURN
            CALL CTRSM('L','L','N','N',k,k,CONE,A(k+1),N+1,A(0),N+1)
            CALL CHERK('U','C',k,k,-ONE,A(0),N+1,ONE,A(k),N+1)
...
!
         ...
         IF ( Info>0 ) RETURN
         CALL CTRSM('L','U','C','N',k,k,CONE,A(k),n1,A(k*(k+1)),k)
         CALL CHERK('L','C',k,k,-ONE,A(k*(k+1)),k,ONE,A(0),k)
...
!
         ...
         IF ( Info>0 ) RETURN
         CALL CTRSM('R','U','N','N',k,k,CONE,A(k*(k+1)),k,A(0),k)
         CALL CHERK('L','N',k,k,-ONE,A(0),k,ONE,A(k*k),k)
