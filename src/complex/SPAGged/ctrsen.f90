!*==ctrsen.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CTRSEN
!
!  =========== DOCUMENTATION ===========
!
...
!
         ...
         CALL CTRSYL('N','N',-1,n1,n2,T,Ldt,T(n1+1,n1+1),Ldt,Work,n1,   &
     &               scale,ierr)
!
...
!
                  CALL CTRSYL('N','N',-1,n1,n2,T,Ldt,T(n1+1,n1+1),Ldt,  &
     &                        Work,n1,scale,ierr)
               ELSE
!
!              Solve T11**H*R - R*T22**H = scale*X.
!
                  CALL CTRSYL('C','C',-1,n1,n2,T,Ldt,T(n1+1,n1+1),Ldt,  &
     &                        Work,n1,scale,ierr)
               ENDIF
               CYCLE
            ENDIF
