!*==ctgsna.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CTGSNA
!
!  =========== DOCUMENTATION ===========
!
...
!
      ...
      COMPLEX , DIMENSION(1) :: dummy , dummy1
...
!
            ...
            CALL CGEMV('N',N,N,CMPLX(ONE,ZERO),A,Lda,Vr(1,ks),1,        &
     &                 CMPLX(ZERO,ZERO),Work,1)
            yhax = CDOTC(N,Work,1,Vl(1,ks),1)
            CALL CGEMV('N',N,N,CMPLX(ONE,ZERO),B,Ldb,Vr(1,ks),1,        &
     &                 CMPLX(ZERO,ZERO),Work,1)
...
!
               ...
               ilst = 1
!
               CALL CTGEXC(.FALSE.,.FALSE.,N,Work,N,Work(N*N+1),N,dummy,&
...
!
                  ...
                  n2 = N - n1
                  i = N*N + 1
                  CALL CTGSYL('N',IDIFJB,n2,n1,Work(N*n1+n1+1),N,Work,N,&
