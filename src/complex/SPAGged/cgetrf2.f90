!*==cgetrf2.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CGETRF2
!
!  =========== DOCUMENTATION ===========
!
...
!        Solve A12
!
         CALL CTRSM('L','L','N','U',n1,n2,ONE,A,Lda,A(1,n1+1),Lda)
!
!        Update A22
!
         CALL CGEMM('N','N',M-n1,n2,n1,-ONE,A(n1+1,1),Lda,A(1,n1+1),Lda,&
     &              ONE,A(n1+1,n1+1),Lda)
!
!        Factor A22
!
         CALL CGETRF2(M-n1,n2,A(n1+1,n1+1),Lda,Ipiv(n1+1),iinfo)
!
