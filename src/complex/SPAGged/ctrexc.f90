!*==ctrexc.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CTREXC
!
!  =========== DOCUMENTATION ===========
!
...
!
         IF ( k+2<=N ) CALL CROT(N-k-1,T(k,k+2),Ldt,T(k+1,k+2),Ldt,cs,  &
     &                           sn)
...
!
         IF ( wantq ) CALL CROT(N,Q(1,k),1,Q(1,k+1),1,cs,CONJG(sn))
!
      ENDDO
!
!
