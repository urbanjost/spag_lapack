!*==cunmqr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CUNMQR
!
!  =========== DOCUMENTATION ===========
!
...
!        Use unblocked code
!
         CALL CUNM2R(Side,Trans,M,N,K,A,Lda,Tau,C,Ldc,Work,iinfo)
      ELSE
!
!        Use blocked code
!
...
!
            CALL CLARFT('Forward','Columnwise',nq-i+1,ib,A(i,i),Lda,    &
     &                  Tau(i),Work(iwt),LDT)
            IF ( left ) THEN
!
...
!           Apply H or H**H
!
            CALL CLARFB(Side,Trans,'Forward','Columnwise',mi,ni,ib,     &
