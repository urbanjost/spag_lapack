!*==cungbr.f90  processed by SPAG 7.51RB at 21:36 on  3 Mar 2022
!> \brief \b CUNGBR
!
!  =========== DOCUMENTATION ===========
!
...
!              Form Q(2:m,2:m)
!
            IF ( M>1 ) CALL CUNGQR(M-1,M-1,M-1,A(2,2),Lda,Tau,Work,     &
     &                             Lwork,iinfo)
         ENDIF
!
...
!              Form P**H(2:n,2:n)
!
         IF ( N>1 ) CALL CUNGLQ(N-1,N-1,N-1,A(2,2),Lda,Tau,Work,Lwork,  &
     &                          iinfo)
      ENDIF
      Work(1) = lwkopt
!
