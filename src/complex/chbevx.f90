!*==chbevx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
     ...
     &         CSTEQR , CSWAP , SCOPY , SSCAL , SSTEBZ , SSTERF , XERBLA
!     ..
!     .. Intrinsic Functions ..
...
!
      ...
      indrwk = inde + N
      indwrk = 1
      CALL CHBTRD(Jobz,Uplo,N,Kd,Ab,Ldab,Rwork(indd),Rwork(inde),Q,Ldq, &
     &            Work(indwrk),iinfo)
!
