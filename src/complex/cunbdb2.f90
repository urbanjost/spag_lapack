!*==cunbdb2.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
      DO i = 1 , P
!
         IF ( i>1 ) CALL CSROT(Q-i+1,X11(i,i),Ldx11,X21(i-1,i),Ldx21,c, &
     &                         s)
     ...
     &              Ldx11,Work(ilarf))
         CALL CLARF('R',M-P-i+1,Q-i+1,X11(i,i),Ldx11,Tauq1(i),X21(i,i), &
     &              Ldx21,Work(ilarf))
         CALL CLACGV(Q-i+1,X11(i,i),Ldx11)
         s = SQRT(SCNRM2(P-i,X11(i+1,i),1)**2+SCNRM2(M-P-i+1,X21(i,i),1)&
     &       **2)
         Theta(i) = ATAN2(s,c)
!
