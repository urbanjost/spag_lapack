!*==clalsa.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. Array Arguments ..
     ...
     &     Poles(Ldu,*) , Rwork(*) , S(*) , U(Ldu,*) , Vt(Ldu,*) ,      &
     &     Z(Ldu,*)
      COMPLEX B(Ldb,*) , Bx(Ldbx,*)
!     ..
!
...
!
            ...
            DO i = ll , lf , -1
               ...
               ENDIF
               j = j + 1
               CALL CLALS0(Icompq,nl,nr,sqre,Nrhs,B(nlf,1),Ldb,Bx(nlf,1)&
...
!
         ...
         DO i = lf , ll
            ...
            nrf = ic + 1
            j = j - 1
            CALL CLALS0(Icompq,nl,nr,sqre,Nrhs,Bx(nlf,1),Ldbx,B(nlf,1), &
