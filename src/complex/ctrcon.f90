!*==ctrcon.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CTRCON
!
!  =========== DOCUMENTATION ===========
!
...
!              Multiply by inv(A).
!
                  CALL CLATRS(Uplo,'No transpose',Diag,normin,N,A,Lda,  &
     &                        Work,scale,Rwork,Info)
               ELSE
!
!              Multiply by inv(A**H).
!
                  CALL CLATRS(Uplo,'Conjugate transpose',Diag,normin,N, &
