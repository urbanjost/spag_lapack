!*==cunmrq.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CUNMRQ
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CLARFT('Backward','Rowwise',nq-K+i+ib-1,ib,A(i,1),Lda, &
     &                  Tau(i),Work(iwt),LDT)
            IF ( left ) THEN
!
...
!           Apply H or H**H
!
            CALL CLARFB(Side,transt,'Backward','Rowwise',mi,ni,ib,A(i,1)&
