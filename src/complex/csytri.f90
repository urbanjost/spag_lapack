!*==csytri.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
               IF ( k>1 ) THEN
                  ...
                  CALL CSYMV(Uplo,k-1,-ONE,A,Lda,Work,1,ZERO,A(1,k),1)
...
!
               IF ( k>1 ) THEN
                  ...
                  CALL CSYMV(Uplo,k-1,-ONE,A,Lda,Work,1,ZERO,A(1,k+1),1)
...
!
               IF ( k<N ) THEN
                  ...
                  CALL CSYMV(Uplo,N-k,-ONE,A(k+1,k+1),Lda,Work,1,ZERO,  &
     &                       A(k+1,k),1)
