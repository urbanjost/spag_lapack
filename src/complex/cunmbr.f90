!*==cunmbr.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CUNMBR
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CUNMLQ(Side,transt,M,N,K,A,Lda,Tau,C,Ldc,Work,Lwork,   &
     &                  iinfo)
         ELSEIF ( nq>1 ) THEN
!
!           P was determined by a call to CGEBRD with nq <= k
!
            ...
            ELSE
               ...
               i2 = 2
            ENDIF
            CALL CUNMLQ(Side,transt,mi,ni,nq-1,A(1,2),Lda,Tau,C(i1,i2), &
...
!
         ...
         ELSE
            ...
            i2 = 2
         ENDIF
         CALL CUNMQR(Side,Trans,mi,ni,nq-1,A(2,1),Lda,Tau,C(i1,i2),Ldc, &
     &               Work,Lwork,iinfo)
      ENDIF
      Work(1) = lwkopt
!
