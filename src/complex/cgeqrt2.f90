!*==cgeqrt2.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
            CALL CGEMV('C',M-i+1,N-i,ONE,A(i,i+1),Lda,A(i,i),1,ZERO,    &
     &                 T(1,N),1)
!
...
!
         alpha = -T(i,1)
         CALL CGEMV('C',M-i+1,i-1,alpha,A(i,1),Lda,A(i,i),1,ZERO,T(1,i),&
     &              1)
         A(i,i) = aii
!
