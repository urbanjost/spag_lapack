!*==cgesvdx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
      EXTERNAL CGEBRD , CGELQF , CGEQRF , CLASCL , CLASET , CUNMBR ,    &
     &         CUNMQR , CUNMLQ , CLACPY , SBDSVDX , SLASCL , XERBLA
!     ..
!     .. External Functions ..
      LOGICAL LSAME
      INTEGER ILAENV
