!*==chetrs_aa_2stage.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
            CALL CTRSM('L','U','C','U',N-nb,Nrhs,ONE,A(1,nb+1),Lda,     &
     &                 B(nb+1,1),Ldb)
!
         ENDIF
!
...
!
            CALL CTRSM('L','L','C','U',N-nb,Nrhs,ONE,A(nb+1,1),Lda,     &
     &                 B(nb+1,1),Ldb)
!
