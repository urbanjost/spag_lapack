!*==clasyf_rook.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!
                     A(kp,k) = A(kk,k)
                     CALL CCOPY(k-1-kp,A(kp+1,kk),1,A(kp,kp+1),Lda)
...
!
            ...
            IF ( k>1 ) CALL CGEMV('No transpose',N-k+1,k-1,-CONE,A(k,1),&
...
!
                     ...
                     IF ( k>1 ) CALL CGEMV('No transpose',N-k+1,k-1,    &
...
!     End of CLASYF_ROOK
!
99999 END SUBROUTINE CLASYF_ROOK
