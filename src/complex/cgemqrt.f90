!*==cgemqrt.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CGEMQRT
!
!  =========== DOCUMENTATION ===========
!
...
!
         DO i = 1 , K , Nb
            ib = MIN(Nb,K-i+1)
            CALL CLARFB('L','C','F','C',M-i+1,N,ib,V(i,i),Ldv,T(1,i),   &
...
!
         DO i = 1 , K , Nb
            ib = MIN(Nb,K-i+1)
            CALL CLARFB('R','N','F','C',M,N-i+1,ib,V(i,i),Ldv,T(1,i),   &
...
!
         ...
         DO i = kf , 1 , -Nb
            ib = MIN(Nb,K-i+1)
            CALL CLARFB('L','N','F','C',M-i+1,N,ib,V(i,i),Ldv,T(1,i),   &
     &                  Ldt,C(i,1),Ldc,Work,ldwork)
         ENDDO
!
...
!
         ...
         DO i = kf , 1 , -Nb
            ib = MIN(Nb,K-i+1)
            CALL CLARFB('R','C','F','C',M,N-i+1,ib,V(i,i),Ldv,T(1,i),   &
     &                  Ldt,C(1,i),Ldc,Work,ldwork)
         ENDDO
!
      ENDIF
