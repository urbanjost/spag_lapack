!*==cgbsvxx.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
...
!     .. External Subroutines ..
      EXTERNAL CGBEQUB , CGBTRF , CGBTRS , CLACPY , CLAQGB , XERBLA ,   &
     &         CLASCL2 , CGBRFSX
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC MAX , MIN
...
!
      CALL CGBRFSX(Trans,Equed,N,Kl,Ku,Nrhs,Ab,Ldab,Afb,Ldafb,Ipiv,R,C, &
