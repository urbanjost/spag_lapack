!*==cunmql.f90  processed by SPAG 7.51RB at 20:08 on  3 Mar 2022
!> \brief \b CUNMQL
!
!  =========== DOCUMENTATION ===========
!
...
!
            CALL CLARFT('Backward','Columnwise',nq-K+i+ib-1,ib,A(1,i),  &
...
!           Apply H or H**H
!
            CALL CLARFB(Side,Trans,'Backward','Columnwise',mi,ni,ib,    &
